...
pub fn surface_scalar_dim<D: crate::dimensions::UnitDimension>(
    name: &'static str,
) -> FluxRef {
...
pub fn surface_vector_dim<D: crate::dimensions::UnitDimension>(
    name: &'static str,
) -> FluxRef {
...
pub fn surface_vector3_dim<D: crate::dimensions::UnitDimension>(
    name: &'static str,
) -> FluxRef {
