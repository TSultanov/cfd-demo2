...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var face_offset = start; face_offset < end; face_offset++) {
        ...
        if (!is_boundary) {
            ...
            matrix_values[start_row_0 + 4u * neighbor_rank + 0u] = jac_r_00 * area;
            matrix_values[start_row_0 + 4u * neighbor_rank + 1u] = jac_r_01 * area;
            matrix_values[start_row_0 + 4u * neighbor_rank + 2u] = jac_r_02 * area;
            matrix_values[start_row_0 + 4u * neighbor_rank + 3u] = jac_r_03 * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 0u] = jac_r_10 * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 1u] = jac_r_11 * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 2u] = jac_r_12 * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 3u] = jac_r_13 * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 0u] = jac_r_20 * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 1u] = jac_r_21 * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 2u] = jac_r_22 * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 3u] = jac_r_23 * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 0u] = jac_r_30 * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 1u] = jac_r_31 * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 2u] = jac_r_32 * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 3u] = jac_r_33 * area;
            ...
            if (boundary_type == 1u) {
                diag_00 += (jac_l_00 + jac_r_00 + jac_r_01 * constants.inlet_velocity) * area;
                diag_01 += jac_l_01 * area;
                diag_02 += jac_l_02 * area;
                diag_03 += (jac_l_03 + jac_r_03) * area;
                diag_10 += (jac_l_10 + jac_r_10 + jac_r_11 * constants.inlet_velocity) * area;
                diag_11 += jac_l_11 * area;
                diag_12 += jac_l_12 * area;
                diag_13 += (jac_l_13 + jac_r_13) * area;
                diag_20 += (jac_l_20 + jac_r_20 + jac_r_21 * constants.inlet_velocity) * area;
                diag_21 += jac_l_21 * area;
                diag_22 += jac_l_22 * area;
                diag_23 += (jac_l_23 + jac_r_23) * area;
                diag_30 += (jac_l_30 + jac_r_30 + jac_r_31 * constants.inlet_velocity) * area;
                diag_31 += jac_l_31 * area;
                diag_32 += jac_l_32 * area;
                diag_33 += (jac_l_33 + jac_r_33) * area;
            } else {
                if (boundary_type == 3u) {
                    ...
                    diag_00 += (jac_l_00 + jac_r_00) * area;
                    diag_01 += (jac_l_01 + jac_r_01 * r11 + jac_r_02 * r21) * area;
                    diag_02 += (jac_l_02 + jac_r_01 * r12 + jac_r_02 * r22) * area;
                    diag_03 += (jac_l_03 + jac_r_03) * area;
                    diag_10 += (jac_l_10 + jac_r_10) * area;
                    diag_11 += (jac_l_11 + jac_r_11 * r11 + jac_r_12 * r21) * area;
                    diag_12 += (jac_l_12 + jac_r_11 * r12 + jac_r_12 * r22) * area;
                    diag_13 += (jac_l_13 + jac_r_13) * area;
                    diag_20 += (jac_l_20 + jac_r_20) * area;
                    diag_21 += (jac_l_21 + jac_r_21 * r11 + jac_r_22 * r21) * area;
                    diag_22 += (jac_l_22 + jac_r_21 * r12 + jac_r_22 * r22) * area;
                    diag_23 += (jac_l_23 + jac_r_23) * area;
                    diag_30 += (jac_l_30 + jac_r_30) * area;
                    diag_31 += (jac_l_31 + jac_r_31 * r11 + jac_r_32 * r21) * area;
                    diag_32 += (jac_l_32 + jac_r_31 * r12 + jac_r_32 * r22) * area;
                    diag_33 += (jac_l_33 + jac_r_33) * area;
                } else {
                    diag_00 += (jac_l_00 + jac_r_00) * area;
                    diag_01 += (jac_l_01 + jac_r_01) * area;
                    diag_02 += (jac_l_02 + jac_r_02) * area;
                    diag_03 += (jac_l_03 + jac_r_03) * area;
                    diag_10 += (jac_l_10 + jac_r_10) * area;
                    diag_11 += (jac_l_11 + jac_r_11) * area;
                    diag_12 += (jac_l_12 + jac_r_12) * area;
                    diag_13 += (jac_l_13 + jac_r_13) * area;
                    diag_20 += (jac_l_20 + jac_r_20) * area;
                    diag_21 += (jac_l_21 + jac_r_21) * area;
                    diag_22 += (jac_l_22 + jac_r_22) * area;
                    diag_23 += (jac_l_23 + jac_r_23) * area;
                    diag_30 += (jac_l_30 + jac_r_30) * area;
                    diag_31 += (jac_l_31 + jac_r_31) * area;
                    diag_32 += (jac_l_32 + jac_r_32) * area;
                    diag_33 += (jac_l_33 + jac_r_33) * area;
                }
            }
        }
