...
// SourceHash: 311b4abbb8b38ecafff2c1bb9469fbb62ea436365df82b42ca4f14180228c7db
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    loop {
        ...
        }
        {
            ...
            if !(_e1515) {
                ...
                let base_0_ = (start_row_0_ + (4u * _e1528));
                let _e1532 = neighbor_rank;
                let base_1_ = (start_row_1_ + (4u * _e1532));
                let _e1536 = neighbor_rank;
                let base_2_ = (start_row_2_ + (4u * _e1536));
                let _e1540 = neighbor_rank;
                let base_3_ = (start_row_3_ + (4u * _e1540));
                let _e1547 = jac_r_00_;
                matrix_values[(base_0_ + 0u)] = (_e1547 * area);
                let _e1553 = jac_r_01_;
                matrix_values[(base_0_ + 1u)] = (_e1553 * area);
                let _e1559 = jac_r_02_;
                matrix_values[(base_0_ + 2u)] = (_e1559 * area);
                let _e1565 = jac_r_03_;
                matrix_values[(base_0_ + 3u)] = (_e1565 * area);
                let _e1571 = jac_r_10_;
                matrix_values[(base_1_ + 0u)] = (_e1571 * area);
                let _e1577 = jac_r_11_;
                matrix_values[(base_1_ + 1u)] = (_e1577 * area);
                let _e1583 = jac_r_12_;
                matrix_values[(base_1_ + 2u)] = (_e1583 * area);
                let _e1589 = jac_r_13_;
                matrix_values[(base_1_ + 3u)] = (_e1589 * area);
                let _e1595 = jac_r_20_;
                matrix_values[(base_2_ + 0u)] = (_e1595 * area);
                let _e1601 = jac_r_21_;
                matrix_values[(base_2_ + 1u)] = (_e1601 * area);
                let _e1607 = jac_r_22_;
                matrix_values[(base_2_ + 2u)] = (_e1607 * area);
                let _e1613 = jac_r_23_;
                matrix_values[(base_2_ + 3u)] = (_e1613 * area);
                let _e1619 = jac_r_30_;
                matrix_values[(base_3_ + 0u)] = (_e1619 * area);
                let _e1625 = jac_r_31_;
                matrix_values[(base_3_ + 1u)] = (_e1625 * area);
                let _e1631 = jac_r_32_;
                matrix_values[(base_3_ + 2u)] = (_e1631 * area);
                let _e1637 = jac_r_33_;
                matrix_values[(base_3_ + 3u)] = (_e1637 * area);
                let _e1640 = jac_l_00_;
                let _e1642 = diag_00_;
                diag_00_ = (_e1642 + (_e1640 * area));
                let _e1645 = jac_l_01_;
                let _e1647 = diag_01_;
                diag_01_ = (_e1647 + (_e1645 * area));
                let _e1650 = jac_l_02_;
                let _e1652 = diag_02_;
                diag_02_ = (_e1652 + (_e1650 * area));
                let _e1655 = jac_l_03_;
                let _e1657 = diag_03_;
                diag_03_ = (_e1657 + (_e1655 * area));
                let _e1660 = jac_l_10_;
                let _e1662 = diag_10_;
                diag_10_ = (_e1662 + (_e1660 * area));
                let _e1665 = jac_l_11_;
                let _e1667 = diag_11_;
                diag_11_ = (_e1667 + (_e1665 * area));
                let _e1670 = jac_l_12_;
                let _e1672 = diag_12_;
                diag_12_ = (_e1672 + (_e1670 * area));
                let _e1675 = jac_l_13_;
                let _e1677 = diag_13_;
                diag_13_ = (_e1677 + (_e1675 * area));
                let _e1680 = jac_l_20_;
                let _e1682 = diag_20_;
                diag_20_ = (_e1682 + (_e1680 * area));
                let _e1685 = jac_l_21_;
                let _e1687 = diag_21_;
                diag_21_ = (_e1687 + (_e1685 * area));
                let _e1690 = jac_l_22_;
                let _e1692 = diag_22_;
                diag_22_ = (_e1692 + (_e1690 * area));
                let _e1695 = jac_l_23_;
                let _e1697 = diag_23_;
                diag_23_ = (_e1697 + (_e1695 * area));
                let _e1700 = jac_l_30_;
                let _e1702 = diag_30_;
                diag_30_ = (_e1702 + (_e1700 * area));
                let _e1705 = jac_l_31_;
                let _e1707 = diag_31_;
                diag_31_ = (_e1707 + (_e1705 * area));
                let _e1710 = jac_l_32_;
                let _e1712 = diag_32_;
                diag_32_ = (_e1712 + (_e1710 * area));
                let _e1715 = jac_l_33_;
                let _e1717 = diag_33_;
                diag_33_ = (_e1717 + (_e1715 * area));
            } else {
                let _e1719 = jac_l_00_;
                let _e1720 = jac_r_00_;
                eff_00_ = (_e1719 + _e1720);
                let _e1723 = jac_l_01_;
                let _e1724 = jac_r_01_;
                eff_01_ = (_e1723 + _e1724);
                let _e1727 = jac_l_02_;
                let _e1728 = jac_r_02_;
                eff_02_ = (_e1727 + _e1728);
                let _e1731 = jac_l_03_;
                let _e1732 = jac_r_03_;
                eff_03_ = (_e1731 + _e1732);
                let _e1735 = jac_l_10_;
                let _e1736 = jac_r_10_;
                eff_10_ = (_e1735 + _e1736);
                let _e1739 = jac_l_11_;
                let _e1740 = jac_r_11_;
                eff_11_ = (_e1739 + _e1740);
                let _e1743 = jac_l_12_;
                let _e1744 = jac_r_12_;
                eff_12_ = (_e1743 + _e1744);
                let _e1747 = jac_l_13_;
                let _e1748 = jac_r_13_;
                eff_13_ = (_e1747 + _e1748);
                let _e1751 = jac_l_20_;
                let _e1752 = jac_r_20_;
                eff_20_ = (_e1751 + _e1752);
                let _e1755 = jac_l_21_;
                let _e1756 = jac_r_21_;
                eff_21_ = (_e1755 + _e1756);
                let _e1759 = jac_l_22_;
                let _e1760 = jac_r_22_;
                eff_22_ = (_e1759 + _e1760);
                let _e1763 = jac_l_23_;
                let _e1764 = jac_r_23_;
                eff_23_ = (_e1763 + _e1764);
                let _e1767 = jac_l_30_;
                let _e1768 = jac_r_30_;
                eff_30_ = (_e1767 + _e1768);
                let _e1771 = jac_l_31_;
                let _e1772 = jac_r_31_;
                eff_31_ = (_e1771 + _e1772);
                let _e1775 = jac_l_32_;
                let _e1776 = jac_r_32_;
                eff_32_ = (_e1775 + _e1776);
                let _e1779 = jac_l_33_;
                let _e1780 = jac_r_33_;
                eff_33_ = (_e1779 + _e1780);
                if (boundary_type == 1u) {
                    let _e1785 = jac_l_00_;
                    let _e1786 = jac_r_00_;
                    let _e1788 = jac_r_01_;
                    let _e1791 = constants.inlet_velocity;
                    eff_00_ = ((_e1785 + _e1786) + (_e1788 * _e1791));
                    let _e1794 = jac_l_01_;
                    eff_01_ = _e1794;
                    let _e1795 = jac_l_02_;
                    eff_02_ = _e1795;
                    let _e1796 = jac_l_03_;
                    let _e1797 = jac_r_03_;
                    eff_03_ = (_e1796 + _e1797);
                    let _e1799 = jac_l_10_;
                    let _e1800 = jac_r_10_;
                    let _e1802 = jac_r_11_;
                    let _e1805 = constants.inlet_velocity;
                    eff_10_ = ((_e1799 + _e1800) + (_e1802 * _e1805));
                    let _e1808 = jac_l_11_;
                    eff_11_ = _e1808;
                    let _e1809 = jac_l_12_;
                    eff_12_ = _e1809;
                    let _e1810 = jac_l_13_;
                    let _e1811 = jac_r_13_;
                    eff_13_ = (_e1810 + _e1811);
                    let _e1813 = jac_l_20_;
                    let _e1814 = jac_r_20_;
                    let _e1816 = jac_r_21_;
                    let _e1819 = constants.inlet_velocity;
                    eff_20_ = ((_e1813 + _e1814) + (_e1816 * _e1819));
                    let _e1822 = jac_l_21_;
                    eff_21_ = _e1822;
                    let _e1823 = jac_l_22_;
                    eff_22_ = _e1823;
                    let _e1824 = jac_l_23_;
                    let _e1825 = jac_r_23_;
                    eff_23_ = (_e1824 + _e1825);
                    let _e1827 = jac_l_30_;
                    let _e1828 = jac_r_30_;
                    let _e1830 = jac_r_31_;
                    let _e1833 = constants.inlet_velocity;
                    eff_30_ = ((_e1827 + _e1828) + (_e1830 * _e1833));
                    let _e1836 = jac_l_31_;
                    eff_31_ = _e1836;
                    let _e1837 = jac_l_32_;
                    eff_32_ = _e1837;
                    let _e1838 = jac_l_33_;
                    let _e1839 = jac_r_33_;
                    eff_33_ = (_e1838 + _e1839);
                } else {
                    if (boundary_type == 3u) {
                        let _e1844 = normal.x;
                        let _e1848 = normal.x;
                        let r11_ = (1f - ((2f * _e1844) * _e1848));
                        let _e1853 = normal.x;
                        let _e1857 = normal.y;
                        let r12_ = ((-2f * _e1853) * _e1857);
                        let _e1860 = normal.y;
                        let _e1864 = normal.x;
                        let r21_ = ((-2f * _e1860) * _e1864);
                        let _e1867 = normal.y;
                        let _e1871 = normal.y;
                        let r22_ = (1f - ((2f * _e1867) * _e1871));
                        let _e1875 = jac_l_00_;
                        let _e1876 = jac_r_00_;
                        eff_00_ = (_e1875 + _e1876);
                        let _e1878 = jac_l_01_;
                        let _e1879 = jac_r_01_;
                        let _e1882 = jac_r_02_;
                        eff_01_ = ((_e1878 + (_e1879 * r11_)) + (_e1882 * r21_));
                        let _e1885 = jac_l_02_;
                        let _e1886 = jac_r_01_;
                        let _e1889 = jac_r_02_;
                        eff_02_ = ((_e1885 + (_e1886 * r12_)) + (_e1889 * r22_));
                        let _e1892 = jac_l_03_;
                        let _e1893 = jac_r_03_;
                        eff_03_ = (_e1892 + _e1893);
                        let _e1895 = jac_l_10_;
                        let _e1896 = jac_r_10_;
                        eff_10_ = (_e1895 + _e1896);
                        let _e1898 = jac_l_11_;
                        let _e1899 = jac_r_11_;
                        let _e1902 = jac_r_12_;
                        eff_11_ = ((_e1898 + (_e1899 * r11_)) + (_e1902 * r21_));
                        let _e1905 = jac_l_12_;
                        let _e1906 = jac_r_11_;
                        let _e1909 = jac_r_12_;
                        eff_12_ = ((_e1905 + (_e1906 * r12_)) + (_e1909 * r22_));
                        let _e1912 = jac_l_13_;
                        let _e1913 = jac_r_13_;
                        eff_13_ = (_e1912 + _e1913);
                        let _e1915 = jac_l_20_;
                        let _e1916 = jac_r_20_;
                        eff_20_ = (_e1915 + _e1916);
                        let _e1918 = jac_l_21_;
                        let _e1919 = jac_r_21_;
                        let _e1922 = jac_r_22_;
                        eff_21_ = ((_e1918 + (_e1919 * r11_)) + (_e1922 * r21_));
                        let _e1925 = jac_l_22_;
                        let _e1926 = jac_r_21_;
                        let _e1929 = jac_r_22_;
                        eff_22_ = ((_e1925 + (_e1926 * r12_)) + (_e1929 * r22_));
                        let _e1932 = jac_l_23_;
                        let _e1933 = jac_r_23_;
                        eff_23_ = (_e1932 + _e1933);
                        let _e1935 = jac_l_30_;
                        let _e1936 = jac_r_30_;
                        eff_30_ = (_e1935 + _e1936);
                        let _e1938 = jac_l_31_;
                        let _e1939 = jac_r_31_;
                        let _e1942 = jac_r_32_;
                        eff_31_ = ((_e1938 + (_e1939 * r11_)) + (_e1942 * r21_));
                        let _e1945 = jac_l_32_;
                        let _e1946 = jac_r_31_;
                        let _e1949 = jac_r_32_;
                        eff_32_ = ((_e1945 + (_e1946 * r12_)) + (_e1949 * r22_));
                        let _e1952 = jac_l_33_;
                        let _e1953 = jac_r_33_;
                        eff_33_ = (_e1952 + _e1953);
                    }
                }
                let _e1955 = eff_00_;
                let _e1957 = diag_00_;
                diag_00_ = (_e1957 + (_e1955 * area));
                let _e1959 = eff_01_;
                let _e1961 = diag_01_;
                diag_01_ = (_e1961 + (_e1959 * area));
                let _e1963 = eff_02_;
                let _e1965 = diag_02_;
                diag_02_ = (_e1965 + (_e1963 * area));
                let _e1967 = eff_03_;
                let _e1969 = diag_03_;
                diag_03_ = (_e1969 + (_e1967 * area));
                let _e1971 = eff_10_;
                let _e1973 = diag_10_;
                diag_10_ = (_e1973 + (_e1971 * area));
                let _e1975 = eff_11_;
                let _e1977 = diag_11_;
                diag_11_ = (_e1977 + (_e1975 * area));
                let _e1979 = eff_12_;
                let _e1981 = diag_12_;
                diag_12_ = (_e1981 + (_e1979 * area));
                let _e1983 = eff_13_;
                let _e1985 = diag_13_;
                diag_13_ = (_e1985 + (_e1983 * area));
                let _e1987 = eff_20_;
                let _e1989 = diag_20_;
                diag_20_ = (_e1989 + (_e1987 * area));
                let _e1991 = eff_21_;
                let _e1993 = diag_21_;
                diag_21_ = (_e1993 + (_e1991 * area));
                let _e1995 = eff_22_;
                let _e1997 = diag_22_;
                diag_22_ = (_e1997 + (_e1995 * area));
                let _e1999 = eff_23_;
                let _e2001 = diag_23_;
                diag_23_ = (_e2001 + (_e1999 * area));
                let _e2003 = eff_30_;
                let _e2005 = diag_30_;
                diag_30_ = (_e2005 + (_e2003 * area));
                let _e2007 = eff_31_;
                let _e2009 = diag_31_;
                diag_31_ = (_e2009 + (_e2007 * area));
                let _e2011 = eff_32_;
                let _e2013 = diag_32_;
                diag_32_ = (_e2013 + (_e2011 * area));
                let _e2015 = eff_33_;
                let _e2017 = diag_33_;
                diag_33_ = (_e2017 + (_e2015 * area));
            }
        }
        continuing {
            let _e2020 = face_offset;
            face_offset = (_e2020 + 1u);
        }
    }
    let _e2022 = rhs_time_rho;
    let _e2023 = rhs_pseudo_rho;
    let _e2025 = coeff_time;
    let _e2026 = coeff_pseudo;
    let _e2030 = sum_rho;
    rhs_rho = (((_e2022 + _e2023) - ((_e2025 + _e2026) * rho)) - _e2030);
    let _e2033 = rhs_time_rho_u_x;
    let _e2034 = rhs_pseudo_rho_u_x;
    let _e2036 = coeff_time;
    let _e2037 = coeff_pseudo;
    let _e2042 = sum_rho_u_x;
    rhs_rho_u_x = (((_e2033 + _e2034) - ((_e2036 + _e2037) * rho_u.x)) - _e2042);
    let _e2045 = rhs_time_rho_u_y;
    let _e2046 = rhs_pseudo_rho_u_y;
    let _e2048 = coeff_time;
    let _e2049 = coeff_pseudo;
    let _e2054 = sum_rho_u_y;
    rhs_rho_u_y = (((_e2045 + _e2046) - ((_e2048 + _e2049) * rho_u.y)) - _e2054);
    let _e2057 = rhs_time_rho_e;
    let _e2058 = rhs_pseudo_rho_e;
    let _e2060 = coeff_time;
    let _e2061 = coeff_pseudo;
    let _e2065 = sum_rho_e;
    rhs_rho_e = (((_e2057 + _e2058) - ((_e2060 + _e2061) * rho_e)) - _e2065);
    let _e2068 = coeff_time;
    let _e2069 = diag_00_;
    diag_00_ = (_e2069 + _e2068);
    let _e2071 = coeff_time;
    let _e2072 = diag_11_;
    diag_11_ = (_e2072 + _e2071);
    let _e2074 = coeff_time;
    let _e2075 = diag_22_;
    diag_22_ = (_e2075 + _e2074);
    let _e2077 = coeff_time;
    let _e2078 = diag_33_;
    diag_33_ = (_e2078 + _e2077);
    let _e2080 = coeff_pseudo;
    let _e2081 = diag_00_;
    diag_00_ = (_e2081 + _e2080);
    let _e2083 = coeff_pseudo;
    let _e2084 = diag_11_;
    diag_11_ = (_e2084 + _e2083);
    let _e2086 = coeff_pseudo;
    let _e2087 = diag_22_;
    diag_22_ = (_e2087 + _e2086);
    let _e2089 = coeff_pseudo;
    let _e2090 = diag_33_;
    diag_33_ = (_e2090 + _e2089);
    ...
    let _e2112 = diag_00_;
    matrix_values[(diag_base_0_ + 0u)] = _e2112;
    let _e2117 = diag_01_;
    matrix_values[(diag_base_0_ + 1u)] = _e2117;
    let _e2122 = diag_02_;
    matrix_values[(diag_base_0_ + 2u)] = _e2122;
    let _e2127 = diag_03_;
    matrix_values[(diag_base_0_ + 3u)] = _e2127;
    let _e2132 = diag_10_;
    matrix_values[(diag_base_1_ + 0u)] = _e2132;
    let _e2137 = diag_11_;
    matrix_values[(diag_base_1_ + 1u)] = _e2137;
    let _e2142 = diag_12_;
    matrix_values[(diag_base_1_ + 2u)] = _e2142;
    let _e2147 = diag_13_;
    matrix_values[(diag_base_1_ + 3u)] = _e2147;
    let _e2152 = diag_20_;
    matrix_values[(diag_base_2_ + 0u)] = _e2152;
    let _e2157 = diag_21_;
    matrix_values[(diag_base_2_ + 1u)] = _e2157;
    let _e2162 = diag_22_;
    matrix_values[(diag_base_2_ + 2u)] = _e2162;
    let _e2167 = diag_23_;
    matrix_values[(diag_base_2_ + 3u)] = _e2167;
    let _e2172 = diag_30_;
    matrix_values[(diag_base_3_ + 0u)] = _e2172;
    let _e2177 = diag_31_;
    matrix_values[(diag_base_3_ + 1u)] = _e2177;
    let _e2182 = diag_32_;
    matrix_values[(diag_base_3_ + 2u)] = _e2182;
    let _e2187 = diag_33_;
    matrix_values[(diag_base_3_ + 3u)] = _e2187;
    let _e2194 = rhs_rho;
    rhs[((4u * idx) + 0u)] = _e2194;
    let _e2201 = rhs_rho_u_x;
    rhs[((4u * idx) + 1u)] = _e2201;
    let _e2208 = rhs_rho_u_y;
    rhs[((4u * idx) + 2u)] = _e2208;
    let _e2215 = rhs_rho_e;
    rhs[((4u * idx) + 3u)] = _e2215;
    return;
}
"#;
    }
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let _e916 = diag_u;
    matrix_values[d_0_0_] = _e916;
    matrix_values[d_0_1_] = 0f;
    let _e922 = sum_diag_up;
    matrix_values[d_0_2_] = _e922;
    matrix_values[d_1_0_] = 0f;
    let _e928 = diag_v;
    matrix_values[d_1_1_] = _e928;
    let _e931 = sum_diag_vp;
    matrix_values[d_1_2_] = _e931;
    let _e934 = sum_diag_pu;
    matrix_values[d_2_0_] = _e934;
    let _e937 = sum_diag_pv;
    matrix_values[d_2_1_] = _e937;
    let _e941 = diag_p;
    let _e942 = sum_diag_pp;
    matrix_values[d_2_2_] = (_e941 + _e942);
    let _e950 = rhs_u;
    rhs[((idx * 3u) + 0u)] = _e950;
    let _e957 = rhs_v;
    rhs[((idx * 3u) + 1u)] = _e957;
