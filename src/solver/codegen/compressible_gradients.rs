...
pub fn generate_ei_gradients_wgsl(layout: &StateLayout, fields: &CompressibleFields) -> String {
    let mut module = Module::new();
    module.push(Item::Comment(
        "GENERATED BY CFD2 CODEGEN (ei_gradients)".to_string(),
    ));
...
pub fn generate_compressible_gradients_wgsl(
    ...
    generate_ei_gradients_wgsl(layout, fields)
}
