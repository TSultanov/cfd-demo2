...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    k1_rhs_0 += state[idx * 14u + 11u] * k1_vol;
    k1_rhs_1 += state[idx * 14u + 12u] * k1_vol;
    k1_rhs_2 += state[idx * 14u + 13u] * k1_vol;
        ...
        if (!k1_is_boundary) {
            ...
            if (bc_kind[k1_face_idx * 3u + 2u] == 1u) {
                ...
                if (bc_kind[k1_face_idx * 3u + 2u] == 2u) {
                    k1_rhs_2 += select(state[idx * 14u + 10u] * state[idx * 14u + 3u], state[idx * 14u + 10u] * state[idx * 14u + 3u] * k1_lambda_f + state[k1_other_idx * 14u + 10u] * state[k1_other_idx * 14u + 3u] * (1.0 - k1_lambda_f), !k1_is_boundary) * k1_area * bc_value[k1_face_idx * 3u + 2u];
                }
            }
        }
