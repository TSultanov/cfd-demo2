// GENERATED BY CFD2 DSL FUSION (rhie_chow/dp_update_store_grad_p_grad_p_update_fused)
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k2_k = k2_start; k2_k < k2_end; k2_k++) {
        ...
        let k2_ls_rhs_interior = (state[k2_other_idx * 25u + 2u] - state[base + 2u]) / k2_ls_dist;
