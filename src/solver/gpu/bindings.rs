...
// SourceHash: 5e23a4e2ee9fc645cf42c640021ee638b86df98ec916458ea6b572298a3a8ff8
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    loop {
        ...
        }
        {
            ...
            let _e1152 = normal.x;
            let A_l_10_ = ((-(u_l_x) * u_n_l) + (dp_drho_l * _e1152));
            let _e1156 = normal.x;
            let _e1160 = normal.x;
            let A_l_11_ = ((u_n_l + (u_l_x * _e1156)) + (dp_dru_l * _e1160));
            let _e1164 = normal.y;
            let _e1167 = normal.x;
            let A_l_12_ = ((u_l_x * _e1164) + (dp_drv_l * _e1167));
            let _e1172 = normal.x;
            let A_l_13_ = (0.4f * _e1172);
            let _e1177 = normal.y;
            let A_l_20_ = ((-(u_l_y) * u_n_l) + (dp_drho_l * _e1177));
            let _e1181 = normal.x;
            let _e1184 = normal.y;
            let A_l_21_ = ((u_l_y * _e1181) + (dp_dru_l * _e1184));
            let _e1188 = normal.y;
            let _e1192 = normal.y;
            let A_l_22_ = ((u_n_l + (u_l_y * _e1188)) + (dp_drv_l * _e1192));
            let _e1196 = normal.y;
            let A_l_23_ = (0.4f * _e1196);
            let A_l_30_ = ((-(H_l) * u_n_l) + (dp_drho_l * u_n_l));
            let _e1203 = normal.x;
            let A_l_31_ = ((H_l * _e1203) + (dp_dru_l * u_n_l));
            let _e1208 = normal.y;
            let A_l_32_ = ((H_l * _e1208) + (dp_drv_l * u_n_l));
            let A_l_33_ = (1.4f * u_n_l);
            let _e1217 = normal.x;
            let A_r_10_ = ((-(u_r_x) * u_n_r) + (dp_drho_r * _e1217));
            let _e1221 = normal.x;
            let _e1225 = normal.x;
            let A_r_11_ = ((u_n_r + (u_r_x * _e1221)) + (dp_dru_r * _e1225));
            let _e1229 = normal.y;
            let _e1232 = normal.x;
            let A_r_12_ = ((u_r_x * _e1229) + (dp_drv_r * _e1232));
            let _e1237 = normal.x;
            let A_r_13_ = (0.4f * _e1237);
            let _e1242 = normal.y;
            let A_r_20_ = ((-(u_r_y) * u_n_r) + (dp_drho_r * _e1242));
            let _e1246 = normal.x;
            let _e1249 = normal.y;
            let A_r_21_ = ((u_r_y * _e1246) + (dp_dru_r * _e1249));
            let _e1253 = normal.y;
            let _e1257 = normal.y;
            let A_r_22_ = ((u_n_r + (u_r_y * _e1253)) + (dp_drv_r * _e1257));
            let _e1261 = normal.y;
            let A_r_23_ = (0.4f * _e1261);
            let A_r_30_ = ((-(H_r) * u_n_r) + (dp_drho_r * u_n_r));
            let _e1268 = normal.x;
            let A_r_31_ = ((H_r * _e1268) + (dp_dru_r * u_n_r));
            let _e1273 = normal.y;
            let A_r_32_ = ((H_r * _e1273) + (dp_drv_r * u_n_r));
            ...
            let _e1388 = is_boundary;
            if !(_e1388) {
                let _e1391 = face_offset;
                let scalar_mat_idx = cell_face_matrix_indices[_e1391];
                neighbor_rank = 0u;
                ...
                matrix_values[((start_row_0_ + (4u * _e1401)) + 0u)] = (a_prod_scaled * area);
                let _e1410 = neighbor_rank;
                let _e1418 = normal.x;
                matrix_values[((start_row_0_ + (4u * _e1410)) + 1u)] = ((a_r * _e1418) * area);
                let _e1422 = neighbor_rank;
                let _e1430 = normal.y;
                matrix_values[((start_row_0_ + (4u * _e1422)) + 2u)] = ((a_r * _e1430) * area);
                let _e1434 = neighbor_rank;
                matrix_values[((start_row_0_ + (4u * _e1434)) + 3u)] = (0f * area);
                let _e1444 = neighbor_rank;
                matrix_values[((start_row_1_ + (4u * _e1444)) + 0u)] = (((a_r * A_r_10_) + d_diff_x_r_rho) * area);
                let _e1455 = neighbor_rank;
                matrix_values[((start_row_1_ + (4u * _e1455)) + 1u)] = ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * area);
                let _e1467 = neighbor_rank;
                matrix_values[((start_row_1_ + (4u * _e1467)) + 2u)] = (((a_r * A_r_12_) + 0f) * area);
                let _e1478 = neighbor_rank;
                matrix_values[((start_row_1_ + (4u * _e1478)) + 3u)] = (((a_r * A_r_13_) + 0f) * area);
                let _e1489 = neighbor_rank;
                matrix_values[((start_row_2_ + (4u * _e1489)) + 0u)] = (((a_r * A_r_20_) + d_diff_y_r_rho) * area);
                let _e1500 = neighbor_rank;
                matrix_values[((start_row_2_ + (4u * _e1500)) + 1u)] = (((a_r * A_r_21_) + 0f) * area);
                let _e1511 = neighbor_rank;
                matrix_values[((start_row_2_ + (4u * _e1511)) + 2u)] = ((((a_r * A_r_22_) + a_prod_scaled) + d_diff_y_r_rv) * area);
                let _e1523 = neighbor_rank;
                matrix_values[((start_row_2_ + (4u * _e1523)) + 3u)] = (((a_r * A_r_23_) + 0f) * area);
                let _e1534 = neighbor_rank;
                matrix_values[((start_row_3_ + (4u * _e1534)) + 0u)] = (((a_r * A_r_30_) + d_e_visc_r_rho) * area);
                let _e1545 = neighbor_rank;
                matrix_values[((start_row_3_ + (4u * _e1545)) + 1u)] = (((a_r * A_r_31_) + d_e_visc_r_ru) * area);
                let _e1556 = neighbor_rank;
                matrix_values[((start_row_3_ + (4u * _e1556)) + 2u)] = (((a_r * A_r_32_) + d_e_visc_r_rv) * area);
                let _e1567 = neighbor_rank;
                matrix_values[((start_row_3_ + (4u * _e1567)) + 3u)] = ((((a_r * A_r_33_) + a_prod_scaled) + d_e_visc_r_re) * area);
                let _e1582 = diag_00_;
                diag_00_ = (_e1582 + ((0f - a_prod_scaled) * area));
                let _e1586 = normal.x;
                let _e1589 = diag_01_;
                diag_01_ = (_e1589 + ((a_l * _e1586) * area));
                let _e1593 = normal.y;
                let _e1596 = diag_02_;
                diag_02_ = (_e1596 + ((a_l * _e1593) * area));
                let _e1601 = diag_03_;
                diag_03_ = (_e1601 + (0f * area));
                let _e1607 = diag_10_;
                diag_10_ = (_e1607 + (((a_l * A_l_10_) + d_diff_x_l_rho) * area));
                let _e1614 = diag_11_;
                diag_11_ = (_e1614 + ((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) * area));
                let _e1620 = diag_12_;
                diag_12_ = (_e1620 + (((a_l * A_l_12_) + 0f) * area));
                let _e1626 = diag_13_;
                diag_13_ = (_e1626 + (((a_l * A_l_13_) + 0f) * area));
                let _e1632 = diag_20_;
                diag_20_ = (_e1632 + (((a_l * A_l_20_) + d_diff_y_l_rho) * area));
                let _e1638 = diag_21_;
                diag_21_ = (_e1638 + (((a_l * A_l_21_) + 0f) * area));
                let _e1645 = diag_22_;
                diag_22_ = (_e1645 + ((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) * area));
                let _e1651 = diag_23_;
                diag_23_ = (_e1651 + (((a_l * A_l_23_) + 0f) * area));
                let _e1657 = diag_30_;
                diag_30_ = (_e1657 + (((a_l * A_l_30_) + d_e_visc_l_rho) * area));
                let _e1663 = diag_31_;
                diag_31_ = (_e1663 + (((a_l * A_l_31_) + d_e_visc_l_ru) * area));
                let _e1669 = diag_32_;
                diag_32_ = (_e1669 + (((a_l * A_l_32_) + d_e_visc_l_rv) * area));
                let _e1676 = diag_33_;
                diag_33_ = (_e1676 + ((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) * area));
            } else {
                if (boundary_type == 1u) {
                    let _e1684 = normal.x;
                    let _e1688 = constants.inlet_velocity;
                    let _e1692 = diag_00_;
                    diag_00_ = (_e1692 + ((((0f - a_prod_scaled) + a_prod_scaled) + ((a_r * _e1684) * _e1688)) * area));
                    let _e1695 = normal.x;
                    let _e1700 = diag_01_;
                    diag_01_ = (_e1700 + (((a_l * _e1695) + 0f) * area));
                    let _e1703 = normal.y;
                    let _e1708 = diag_02_;
                    diag_02_ = (_e1708 + (((a_l * _e1703) + 0f) * area));
                    let _e1712 = diag_03_;
                    diag_03_ = (_e1712 + (0f * area));
                    let _e1724 = constants.inlet_velocity;
                    let _e1728 = diag_10_;
                    diag_10_ = (_e1728 + ((((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * _e1724)) * area));
                    let _e1736 = diag_11_;
                    diag_11_ = (_e1736 + (((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) + 0f) * area));
                    let _e1743 = diag_12_;
                    diag_12_ = (_e1743 + ((((a_l * A_l_12_) + 0f) + 0f) * area));
                    let _e1751 = diag_13_;
                    diag_13_ = (_e1751 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                    let _e1762 = constants.inlet_velocity;
                    let _e1766 = diag_20_;
                    diag_20_ = (_e1766 + ((((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) + (((a_r * A_r_21_) + 0f) * _e1762)) * area));
                    let _e1773 = diag_21_;
                    diag_21_ = (_e1773 + ((((a_l * A_l_21_) + 0f) + 0f) * area));
                    let _e1781 = diag_22_;
                    diag_22_ = (_e1781 + (((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) + 0f) * area));
                    let _e1789 = diag_23_;
                    diag_23_ = (_e1789 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                    let _e1800 = constants.inlet_velocity;
                    let _e1804 = diag_30_;
                    diag_30_ = (_e1804 + ((((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) + (((a_r * A_r_31_) + d_e_visc_r_ru) * _e1800)) * area));
                    let _e1811 = diag_31_;
                    diag_31_ = (_e1811 + ((((a_l * A_l_31_) + d_e_visc_l_ru) + 0f) * area));
                    let _e1818 = diag_32_;
                    diag_32_ = (_e1818 + ((((a_l * A_l_32_) + d_e_visc_l_rv) + 0f) * area));
                    let _e1828 = diag_33_;
                    diag_33_ = (_e1828 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                } else {
                    if (boundary_type == 3u) {
                        let _e1833 = normal.x;
                        let _e1837 = normal.x;
                        let r11_ = (1f - ((2f * _e1833) * _e1837));
                        let _e1842 = normal.x;
                        let _e1846 = normal.y;
                        let r12_ = ((-2f * _e1842) * _e1846);
                        let _e1849 = normal.y;
                        let _e1853 = normal.x;
                        let r21_ = ((-2f * _e1849) * _e1853);
                        let _e1856 = normal.y;
                        let _e1860 = normal.y;
                        let r22_ = (1f - ((2f * _e1856) * _e1860));
                        let _e1868 = diag_00_;
                        diag_00_ = (_e1868 + (((0f - a_prod_scaled) + a_prod_scaled) * area));
                        let _e1871 = normal.x;
                        let _e1874 = normal.x;
                        let _e1879 = normal.y;
                        let _e1884 = diag_01_;
                        diag_01_ = (_e1884 + ((((a_l * _e1871) + ((a_r * _e1874) * r11_)) + ((a_r * _e1879) * r21_)) * area));
                        let _e1887 = normal.y;
                        let _e1890 = normal.x;
                        let _e1895 = normal.y;
                        let _e1900 = diag_02_;
                        diag_02_ = (_e1900 + ((((a_l * _e1887) + ((a_r * _e1890) * r12_)) + ((a_r * _e1895) * r22_)) * area));
                        let _e1904 = diag_03_;
                        diag_03_ = (_e1904 + (0f * area));
                        let _e1912 = diag_10_;
                        diag_10_ = (_e1912 + (((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) * area));
                        let _e1927 = diag_11_;
                        diag_11_ = (_e1927 + ((((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * r11_)) + (((a_r * A_r_12_) + 0f) * r21_)) * area));
                        let _e1941 = diag_12_;
                        diag_12_ = (_e1941 + (((((a_l * A_l_12_) + 0f) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * r12_)) + (((a_r * A_r_12_) + 0f) * r22_)) * area));
                        let _e1949 = diag_13_;
                        diag_13_ = (_e1949 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                        let _e1957 = diag_20_;
                        diag_20_ = (_e1957 + (((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) * area));
                        let _e1971 = diag_21_;
                        diag_21_ = (_e1971 + (((((a_l * A_l_21_) + 0f) + (((a_r * A_r_21_) + 0f) * r11_)) + ((((a_r * A_r_22_) + a_prod_scaled) + d_diff_y_r_rv) * r21_)) * area));
                        let _e1986 = diag_22_;
                        diag_22_ = (_e1986 + ((((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) + (((a_r * A_r_21_) + 0f) * r12_)) + ((((a_r * A_r_22_) + a_prod_scaled) + d_diff_y_r_rv) * r22_)) * area));
                        let _e1994 = diag_23_;
                        diag_23_ = (_e1994 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                        let _e2002 = diag_30_;
                        diag_30_ = (_e2002 + (((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) * area));
                        let _e2015 = diag_31_;
                        diag_31_ = (_e2015 + (((((a_l * A_l_31_) + d_e_visc_l_ru) + (((a_r * A_r_31_) + d_e_visc_r_ru) * r11_)) + (((a_r * A_r_32_) + d_e_visc_r_rv) * r21_)) * area));
                        let _e2028 = diag_32_;
                        diag_32_ = (_e2028 + (((((a_l * A_l_32_) + d_e_visc_l_rv) + (((a_r * A_r_31_) + d_e_visc_r_ru) * r12_)) + (((a_r * A_r_32_) + d_e_visc_r_rv) * r22_)) * area));
                        let _e2038 = diag_33_;
                        diag_33_ = (_e2038 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                    } else {
                        let _e2044 = diag_00_;
                        diag_00_ = (_e2044 + (((0f - a_prod_scaled) + a_prod_scaled) * area));
                        let _e2047 = normal.x;
                        let _e2050 = normal.x;
                        let _e2054 = diag_01_;
                        diag_01_ = (_e2054 + (((a_l * _e2047) + (a_r * _e2050)) * area));
                        let _e2057 = normal.y;
                        let _e2060 = normal.y;
                        let _e2064 = diag_02_;
                        diag_02_ = (_e2064 + (((a_l * _e2057) + (a_r * _e2060)) * area));
                        let _e2068 = diag_03_;
                        diag_03_ = (_e2068 + (0f * area));
                        let _e2076 = diag_10_;
                        diag_10_ = (_e2076 + (((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) * area));
                        let _e2086 = diag_11_;
                        diag_11_ = (_e2086 + (((((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) + (a_r * A_r_11_)) + a_prod_scaled) + d_diff_x_r_ru) * area));
                        let _e2094 = diag_12_;
                        diag_12_ = (_e2094 + (((((a_l * A_l_12_) + 0f) + (a_r * A_r_12_)) + 0f) * area));
                        let _e2102 = diag_13_;
                        diag_13_ = (_e2102 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                        let _e2110 = diag_20_;
                        diag_20_ = (_e2110 + (((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) * area));
                        let _e2118 = diag_21_;
                        diag_21_ = (_e2118 + (((((a_l * A_l_21_) + 0f) + (a_r * A_r_21_)) + 0f) * area));
                        let _e2128 = diag_22_;
                        diag_22_ = (_e2128 + (((((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) + (a_r * A_r_22_)) + a_prod_scaled) + d_diff_y_r_rv) * area));
                        let _e2136 = diag_23_;
                        diag_23_ = (_e2136 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                        let _e2144 = diag_30_;
                        diag_30_ = (_e2144 + (((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) * area));
                        let _e2152 = diag_31_;
                        diag_31_ = (_e2152 + (((((a_l * A_l_31_) + d_e_visc_l_ru) + (a_r * A_r_31_)) + d_e_visc_r_ru) * area));
                        let _e2160 = diag_32_;
                        diag_32_ = (_e2160 + (((((a_l * A_l_32_) + d_e_visc_l_rv) + (a_r * A_r_32_)) + d_e_visc_r_rv) * area));
                        let _e2170 = diag_33_;
                        diag_33_ = (_e2170 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                    }
                }
            }
        }
        continuing {
            let _e2173 = face_offset;
            face_offset = (_e2173 + 1u);
        }
    }
    let _e2175 = rhs_time_rho;
    let _e2176 = rhs_pseudo_rho;
    let _e2178 = coeff_time;
    let _e2179 = coeff_pseudo;
    let _e2183 = sum_rho;
    rhs_rho = (((_e2175 + _e2176) - ((_e2178 + _e2179) * rho)) - _e2183);
    let _e2186 = rhs_time_rho_u_x;
    let _e2187 = rhs_pseudo_rho_u_x;
    let _e2189 = coeff_time;
    let _e2190 = coeff_pseudo;
    let _e2195 = sum_rho_u_x;
    rhs_rho_u_x = (((_e2186 + _e2187) - ((_e2189 + _e2190) * rho_u.x)) - _e2195);
    let _e2198 = rhs_time_rho_u_y;
    let _e2199 = rhs_pseudo_rho_u_y;
    let _e2201 = coeff_time;
    let _e2202 = coeff_pseudo;
    let _e2207 = sum_rho_u_y;
    rhs_rho_u_y = (((_e2198 + _e2199) - ((_e2201 + _e2202) * rho_u.y)) - _e2207);
    let _e2210 = rhs_time_rho_e;
    let _e2211 = rhs_pseudo_rho_e;
    let _e2213 = coeff_time;
    let _e2214 = coeff_pseudo;
    let _e2218 = sum_rho_e;
    rhs_rho_e = (((_e2210 + _e2211) - ((_e2213 + _e2214) * rho_e)) - _e2218);
    let _e2221 = coeff_time;
    let _e2222 = diag_00_;
    diag_00_ = (_e2222 + _e2221);
    let _e2224 = coeff_time;
    let _e2225 = diag_11_;
    diag_11_ = (_e2225 + _e2224);
    let _e2227 = coeff_time;
    let _e2228 = diag_22_;
    diag_22_ = (_e2228 + _e2227);
    let _e2230 = coeff_time;
    let _e2231 = diag_33_;
    diag_33_ = (_e2231 + _e2230);
    let _e2233 = coeff_pseudo;
    let _e2234 = diag_00_;
    diag_00_ = (_e2234 + _e2233);
    let _e2236 = coeff_pseudo;
    let _e2237 = diag_11_;
    diag_11_ = (_e2237 + _e2236);
    let _e2239 = coeff_pseudo;
    let _e2240 = diag_22_;
    diag_22_ = (_e2240 + _e2239);
    let _e2242 = coeff_pseudo;
    let _e2243 = diag_33_;
    diag_33_ = (_e2243 + _e2242);
    let scalar_diag_idx = diagonal_indices[idx];
    let diag_rank = (scalar_diag_idx - scalar_offset);
    let _e2256 = diag_00_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 0u)] = _e2256;
    let _e2264 = diag_01_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 1u)] = _e2264;
    let _e2272 = diag_02_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 2u)] = _e2272;
    let _e2280 = diag_03_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 3u)] = _e2280;
    let _e2288 = diag_10_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 0u)] = _e2288;
    let _e2296 = diag_11_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 1u)] = _e2296;
    let _e2304 = diag_12_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 2u)] = _e2304;
    let _e2312 = diag_13_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 3u)] = _e2312;
    let _e2320 = diag_20_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 0u)] = _e2320;
    let _e2328 = diag_21_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 1u)] = _e2328;
    let _e2336 = diag_22_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 2u)] = _e2336;
    let _e2344 = diag_23_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 3u)] = _e2344;
    let _e2352 = diag_30_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 0u)] = _e2352;
    let _e2360 = diag_31_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 1u)] = _e2360;
    let _e2368 = diag_32_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 2u)] = _e2368;
    let _e2376 = diag_33_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 3u)] = _e2376;
    let _e2383 = rhs_rho;
    rhs[((idx * 4u) + 0u)] = _e2383;
    let _e2390 = rhs_rho_u_x;
    rhs[((idx * 4u) + 1u)] = _e2390;
    let _e2397 = rhs_rho_u_y;
    rhs[((idx * 4u) + 2u)] = _e2397;
    let _e2404 = rhs_rho_e;
    rhs[((idx * 4u) + 3u)] = _e2404;
    return;
}
"#;
    }
