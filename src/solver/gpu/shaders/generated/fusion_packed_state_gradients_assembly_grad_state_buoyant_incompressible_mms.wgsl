...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        if (!k1_is_boundary) {
            ...
            k1_rhs_0 -= 0.5 * k1_area * k1_normal.x * (select(select(state[idx * 12u + 2u], bc_value[k1_face_idx * 4u + 2u], bc_kind[k1_face_idx * 4u + 2u] == 1u), state[idx * 12u + 2u] + bc_value[k1_face_idx * 4u + 2u] * k1_dist, bc_kind[k1_face_idx * 4u + 2u] == 2u) * 2.0);
        }
        if (!k1_is_boundary) {
            k1_rhs_1 -= 0.5 * k1_area * k1_normal.y * (state[idx * 12u + 2u] + state[k1_other_idx * 12u + 2u]);
        } else {
            k1_rhs_1 -= 0.5 * k1_area * k1_normal.y * (select(select(state[idx * 12u + 2u], bc_value[k1_face_idx * 4u + 2u], bc_kind[k1_face_idx * 4u + 2u] == 1u), state[idx * 12u + 2u] + bc_value[k1_face_idx * 4u + 2u] * k1_dist, bc_kind[k1_face_idx * 4u + 2u] == 2u) * 2.0);
        }
        ...
        if (!k1_is_boundary) {
            ...
            k1_rhs_3 -= k1_phi_3 * (k1_rec_3_phi_ho - select(state[idx * 12u + 8u], state[k1_other_idx * 12u + 8u], k1_phi_3 < 0.0));
        } else {
            if (bc_kind[k1_face_idx * 4u + 3u] == 1u) {
                k1_diag_3 += max(k1_phi_3, 0.0);
