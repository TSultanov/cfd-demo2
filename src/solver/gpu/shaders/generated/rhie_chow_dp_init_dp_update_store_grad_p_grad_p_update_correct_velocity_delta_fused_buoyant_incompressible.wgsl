...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k3_k = k3_start; k3_k < k3_end; k3_k++) {
        ...
        k3_grad_acc_p += k3_normal_vec * (state[base + 2u] * k3_lambda + select(state[k3_other_idx * 9u + 2u], select(select(state[base + 2u], bc_value[k3_face_idx * 4u + 2u], bc_kind[k3_face_idx * 4u + 2u] == 1u), state[base + 2u] + bc_value[k3_face_idx * 4u + 2u] * k3_d_own, bc_kind[k3_face_idx * 4u + 2u] == 2u), k3_is_boundary) * k3_lambda_other) * k3_area;
    }
