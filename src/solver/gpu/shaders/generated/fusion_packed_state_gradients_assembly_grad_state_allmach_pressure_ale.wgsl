...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    k1_rhs_0 += k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * k1_ale_vol_ratio_n * state_old[idx * 12u + 0u];
    if (constants.time_scheme == 1u) {
        ...
        k1_rhs_0 = k1_rhs_0 - k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * k1_ale_vol_ratio_n * state_old[idx * 12u + 0u] + k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * (k1_factor_n * k1_ale_vol_ratio_n * state_old[idx * 12u + 0u] - k1_factor_nm1 * k1_ale_vol_ratio_nm1 * state_old_old[idx * 12u + 0u]);
    }
    ...
    k1_rhs_1 += k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * k1_ale_vol_ratio_n * state_old[idx * 12u + 1u];
    if (constants.time_scheme == 1u) {
        let k1_r = constants.dt / constants.dt_old;
        let k1_diag_bdf2 = k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * (k1_r * 2.0 + 1.0) / (k1_r + 1.0);
        let k1_factor_n = k1_r + 1.0;
        ...
        k1_rhs_1 = k1_rhs_1 - k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * k1_ale_vol_ratio_n * state_old[idx * 12u + 1u] + k1_vol * state[idx * 12u + 11u] / select(constants.dt, state[idx * 12u + 10u], state[idx * 12u + 10u] > 0.0) * (k1_factor_n * k1_ale_vol_ratio_n * state_old[idx * 12u + 1u] - k1_factor_nm1 * k1_ale_vol_ratio_nm1 * state_old_old[idx * 12u + 1u]);
    }
    if (constants.dtau > 0.0) {
    ...
    k1_bounded_sum_phi_0 += state[idx * 12u + 11u] * k1_ale_dvdt_ddt;
