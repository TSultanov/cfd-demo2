...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    k1_rhs_0 += k1_vol * constants.density / constants.dt * state_old[idx * 12u + 0u];
    if (constants.time_scheme == 1u) {
        ...
        k1_rhs_0 = k1_rhs_0 - k1_vol * constants.density / constants.dt * state_old[idx * 12u + 0u] + k1_vol * constants.density / constants.dt * (k1_factor_n * state_old[idx * 12u + 0u] - k1_factor_nm1 * state_old_old[idx * 12u + 0u]);
    }
    if (constants.dtau > 0.0) {
        k1_diag_0 += constants.density * k1_dual_time_scale;
        k1_rhs_0 += constants.density * k1_dual_time_scale * state_iter[idx * 12u + 0u];
    }
    k1_diag_1 += k1_vol * constants.density / constants.dt;
    k1_rhs_1 += k1_vol * constants.density / constants.dt * state_old[idx * 12u + 1u];
    if (constants.time_scheme == 1u) {
        let k1_r = constants.dt / constants.dt_old;
        let k1_diag_bdf2 = k1_vol * constants.density / constants.dt * (k1_r * 2.0 + 1.0) / (k1_r + 1.0);
        let k1_factor_n = k1_r + 1.0;
        ...
        k1_rhs_1 = k1_rhs_1 - k1_vol * constants.density / constants.dt * state_old[idx * 12u + 1u] + k1_vol * constants.density / constants.dt * (k1_factor_n * state_old[idx * 12u + 1u] - k1_factor_nm1 * state_old_old[idx * 12u + 1u]);
    }
    if (constants.dtau > 0.0) {
        k1_diag_1 += constants.density * k1_dual_time_scale;
        k1_rhs_1 += constants.density * k1_dual_time_scale * state_iter[idx * 12u + 1u];
    }
    k1_diag_3 += k1_vol * constants.density / constants.dt;
    k1_rhs_3 += k1_vol * constants.density / constants.dt * state_old[idx * 12u + 8u];
    if (constants.time_scheme == 1u) {
        let k1_r = constants.dt / constants.dt_old;
        let k1_diag_bdf2 = k1_vol * constants.density / constants.dt * (k1_r * 2.0 + 1.0) / (k1_r + 1.0);
        let k1_factor_n = k1_r + 1.0;
        ...
        k1_rhs_3 = k1_rhs_3 - k1_vol * constants.density / constants.dt * state_old[idx * 12u + 8u] + k1_vol * constants.density / constants.dt * (k1_factor_n * state_old[idx * 12u + 8u] - k1_factor_nm1 * state_old_old[idx * 12u + 8u]);
    }
    if (constants.dtau > 0.0) {
        k1_diag_3 += constants.density * k1_dual_time_scale;
        k1_rhs_3 += constants.density * k1_dual_time_scale * state_iter[idx * 12u + 8u];
    }
    k1_rhs_1 += -(-constants.buoyant_beta_g * constants.density * state[idx * 12u + 8u]) * k1_vol;
    k1_rhs_1 += -(constants.buoyant_beta_g * constants.buoyant_t0 * constants.density) * k1_vol;
    k1_rhs_0 += state[idx * 12u + 9u] * k1_vol;
    k1_rhs_1 += state[idx * 12u + 10u] * k1_vol;
    k1_rhs_3 += state[idx * 12u + 11u] * k1_vol;
    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        let k1_diff_coeff_p = select(constants.density * state[idx * 12u + 3u], constants.density * state[idx * 12u + 3u] * k1_lambda_f + constants.density * state[k1_other_idx * 12u + 3u] * (1.0 - k1_lambda_f), !k1_is_boundary) * k1_area / k1_dist;
        if (!k1_is_boundary) {
            ...
            if (bc_kind[k1_face_idx * 4u + 2u] == 1u) {
                ...
                if (bc_kind[k1_face_idx * 4u + 2u] == 2u) {
                    k1_rhs_2 += select(constants.density * state[idx * 12u + 3u], constants.density * state[idx * 12u + 3u] * k1_lambda_f + constants.density * state[k1_other_idx * 12u + 3u] * (1.0 - k1_lambda_f), !k1_is_boundary) * k1_area * bc_value[k1_face_idx * 4u + 2u];
                }
            }
        }
        ...
        if (!k1_is_boundary) {
            ...
            k1_rhs_3 -= k1_phi_3 * (select(select(select(select(select(select(select(state[idx * 12u + 8u], state[k1_other_idx * 12u + 8u], k1_phi_3 < 0.0), select(state[k1_other_idx * 12u + 8u] + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)), state[idx * 12u + 8u] + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y)), k1_phi_3 > 0.0), constants.scheme == 1u), select(state[k1_other_idx * 12u + 8u] + state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u], state[idx * 12u + 8u] + state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u], k1_phi_3 > 0.0), constants.scheme == 2u), select(state[k1_other_idx * 12u + 8u] + min(max(dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)), min(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u], 0.0)), max(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u], 0.0)), state[idx * 12u + 8u] + min(max(dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y)), min(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u], 0.0)), max(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u], 0.0)), k1_phi_3 > 0.0), constants.scheme == 3u), select(state[k1_other_idx * 12u + 8u] + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * abs(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) / max(abs(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]), abs(dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y))) + 0.00000001) * max((state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) * dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)), 0.0) / max(abs((state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) * dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y))), 0.00000001), state[idx * 12u + 8u] + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * abs(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) / max(abs(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]), abs(dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y))) + 0.00000001) * max((state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) * dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y)), 0.0) / max(abs((state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) * dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_f_center.x, k1_f_center.y) - vec2<f32>(k1_center.x, k1_center.y))), 0.00000001), k1_phi_3 > 0.0), constants.scheme == 4u), select(state[k1_other_idx * 12u + 8u] + min(max(state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u], min(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u], 0.0)), max(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u], 0.0)), state[idx * 12u + 8u] + min(max(state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u], min(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u], 0.0)), max(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u], 0.0)), k1_phi_3 > 0.0), constants.scheme == 5u), select(state[k1_other_idx * 12u + 8u] + (state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u]) * abs(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) / max(abs(state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]), abs(state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u]) + 0.00000001) * max((state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) * (state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u]), 0.0) / max(abs((state[idx * 12u + 8u] - state[k1_other_idx * 12u + 8u]) * (state[k1_other_idx * 12u + 8u] * 0.625 + state[idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[k1_other_idx * 12u + 8u].x, grad_state[k1_other_idx * 12u + 8u].y), vec2<f32>(k1_center.x, k1_center.y) - vec2<f32>(k1_other_center.x, k1_other_center.y)) * 0.125 - state[k1_other_idx * 12u + 8u])), 0.00000001), state[idx * 12u + 8u] + (state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u]) * abs(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) / max(abs(state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]), abs(state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u]) + 0.00000001) * max((state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) * (state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u]), 0.0) / max(abs((state[k1_other_idx * 12u + 8u] - state[idx * 12u + 8u]) * (state[idx * 12u + 8u] * 0.625 + state[k1_other_idx * 12u + 8u] * 0.375 + dot(vec2<f32>(grad_state[idx * 12u + 8u].x, grad_state[idx * 12u + 8u].y), vec2<f32>(k1_other_center.x, k1_other_center.y) - vec2<f32>(k1_center.x, k1_center.y)) * 0.125 - state[idx * 12u + 8u])), 0.00000001), k1_phi_3 > 0.0), constants.scheme == 6u) - select(state[idx * 12u + 8u], state[k1_other_idx * 12u + 8u], k1_phi_3 < 0.0));
        } else {
            if (bc_kind[k1_face_idx * 4u + 3u] == 1u) {
                k1_diag_3 += max(k1_phi_3, 0.0);
