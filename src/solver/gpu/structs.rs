...
pub struct GpuSolver {
    ...
    pub bg_dot_r0_r: wgpu::BindGroup,
    pub bg_dot_r0_v: wgpu::BindGroup,
    pub bg_dot_t_s: wgpu::BindGroup,
    pub bg_dot_t_t: wgpu::BindGroup,
    ...
    pub pipeline_update_beta: wgpu::ComputePipeline,
    pub pipeline_update_alpha: wgpu::ComputePipeline,
    pub pipeline_reduce_r0_v: wgpu::ComputePipeline,
    pub pipeline_reduce_t_s_t_t: wgpu::ComputePipeline,
    pub pipeline_update_omega: wgpu::ComputePipeline,
