...
|---|---:|---:|---:|---:|---:|---:|---:|
| `compressible` | 4 | 3 | 1 | 0 | 1 | 0 | 0 |
| `generic_diffusion_demo` | 4 | 1 | 1 | 0 | 1 | 0 | 0 |
| `generic_diffusion_demo_neumann` | 4 | 1 | 1 | 0 | 1 | 0 | 0 |
| `incompressible_momentum` | 9 | 3 | 8 | 0 | 3 | 3 | 0 |
...
| `fusion/packed_state_gradients_assembly_grad_state` | Gradients | Cells | RequiresGradState | - | Synthesized | no | replacement kernel synthesized from fusion DSL inputs |
| `packed_state_gradients` | Gradients | Cells | RequiresGradState | PerModel | DSL | no | - |
...
|---|---|---|---|---|---|---|
| `generic_coupled:gradients_assembly_grad_state_v1` | Safe | `packed_state_gradients` -> `generic_coupled_assembly_grad_state` | `fusion/packed_state_gradients_assembly_grad_state` | yes | yes | - |
...
| `fusion/packed_state_gradients_assembly_grad_state` | Gradients | Cells | RequiresGradState | - | Synthesized | no | replacement kernel synthesized from fusion DSL inputs |
| `packed_state_gradients` | Gradients | Cells | RequiresGradState | PerModel | DSL | no | - |
| `dp_init` | Update | Cells | Always | PerModel | DSL | no | - |
| `dp_update_from_diag` | Update | Cells | Always | PerModel | DSL | no | - |
| `generic_coupled/update_dp_init_fused` | Update | Cells | Always | - | Synthesized | no | replacement kernel synthesized from fusion DSL inputs |
| `generic_coupled_update` | Update | Cells | Always | PerModel | DSL | no | - |
| `rhie_chow/correct_velocity_delta` | Update | Cells | Always | PerModel | DSL | no | - |
| `rhie_chow/dp_init_dp_update_store_grad_p_grad_p_update_correct_velocity_delta_fused` | Update | Cells | Always | - | Synthesized | no | replacement kernel synthesized from fusion DSL inputs |
...
|---|---|---|---|---|---|---|---|
| `generic_coupled_assembly -> generic_coupled_assembly_grad_state` | Assembly | Cells | DSL + DSL | - | yes | yes | - |
| `generic_coupled_update -> dp_init` | Update | Cells | DSL + DSL | generic_coupled:update_dp_init_v1 | yes | yes | - |
| `dp_init -> dp_update_from_diag` | Update | Cells | DSL + DSL | - | no (fusion rejected: WAW hazard at kernel 'dp_update_from_diag') | yes | aggressive-only opportunity |
...
|---|---|---|---|---|---|---|
| `generic_coupled:gradients_assembly_grad_state_v1` | Safe | `packed_state_gradients` -> `generic_coupled_assembly_grad_state` | `fusion/packed_state_gradients_assembly_grad_state` | yes | yes | - |
| `generic_coupled:update_dp_init_v1` | Safe | `generic_coupled_update` -> `dp_init` | `generic_coupled/update_dp_init_fused` | yes | yes | - |
| `rhie_chow:dp_init_dp_update_store_grad_p_grad_p_update_correct_velocity_delta_v1` | Aggressive | `dp_init` -> `dp_update_from_diag` -> `rhie_chow/store_grad_p` -> `rhie_chow/grad_p_update` -> `rhie_chow/correct_velocity_delta` | `rhie_chow/dp_init_dp_update_store_grad_p_grad_p_update_correct_velocity_delta_fused` | no (fusion rejected: WAW hazard at kernel 'dp_update_from_diag') | yes | aggressive-only synthesis path |
