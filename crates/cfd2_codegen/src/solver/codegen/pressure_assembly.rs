...
pub fn generate_pressure_assembly_wgsl(
    ...
    let plan = pressure_plan(system, pressure_field);
...
fn main_fn(
    ...
    Function::new(
        ...
        main_body(layout, plan, d_p_field, grad_p_field),
    )
}
...
mod tests {
    ...
    use crate::solver::ir::{fvm, surface_scalar, vol_scalar, vol_vector, Coefficient, SchemeRegistry};
    ...
    fn pressure_assembly_codegen_emits_state_arrays() {
        ...
        let eqn_u = crate::solver::ir::Equation::new(u.clone())
        ...
        let wgsl = generate_pressure_assembly_wgsl(&discrete, &layout, "p", "d_p", "grad_p");
