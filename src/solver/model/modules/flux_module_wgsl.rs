...
pub fn generate_flux_module_wgsl(
    ...
    module.extend(base_items(flux_spec_uses_low_mach(spec), eos_params, structured));
...
fn base_items(include_low_mach_params: bool, eos_params: &[ParamSpec], structured: bool) -> Vec<Item> {
