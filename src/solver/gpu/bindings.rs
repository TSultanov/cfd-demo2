...
impl ShaderEntry {
    pub fn create_pipeline_layout(&self, device: &wgpu::Device) -> wgpu::PipelineLayout {
        match self {
            ...
            Self::MomentumAssemblyV2 => momentum_assembly_v2::create_pipeline_layout(device),
    ...
    pub fn create_shader_module_embed_source(&self, device: &wgpu::Device) -> wgpu::ShaderModule {
        match self {
            ...
            Self::MomentumAssemblyV2 => {
                momentum_assembly_v2::create_shader_module_embed_source(device)
            }
...
pub mod layout_asserts {
    ...
    const MOMENTUM_ASSEMBLY_V2_VECTOR2_ASSERTS: () = {
        assert!(std::mem::offset_of!(momentum_assembly_v2::Vector2, x) == 0);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Vector2, y) == 4);
        assert!(std::mem::size_of::<momentum_assembly_v2::Vector2>() == 8);
    };
    const MOMENTUM_ASSEMBLY_V2_CONSTANTS_ASSERTS: () = {
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, dt) == 0);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, dt_old) == 4);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, time) == 8);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, viscosity) == 12);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, density) == 16);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, component) == 20);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, alpha_p) == 24);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, scheme) == 28);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, alpha_u) == 32);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, stride_x) == 36);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, time_scheme) == 40);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, inlet_velocity) == 44);
        assert!(std::mem::offset_of!(momentum_assembly_v2::Constants, ramp_time) == 48);
        assert!(std::mem::size_of::<momentum_assembly_v2::Constants>() == 52);
    };
...
pub mod bytemuck_impls {
    ...
    unsafe impl bytemuck::Zeroable for momentum_assembly_v2::Vector2 {}
    unsafe impl bytemuck::Pod for momentum_assembly_v2::Vector2 {}
    unsafe impl bytemuck::Zeroable for momentum_assembly_v2::Constants {}
    unsafe impl bytemuck::Pod for momentum_assembly_v2::Constants {}
...
pub mod momentum_assembly_v2 {
    ...
    impl WgpuBindGroup0 {
        pub const LAYOUT_DESCRIPTOR: wgpu::BindGroupLayoutDescriptor<'static> =
            wgpu::BindGroupLayoutDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup0::LayoutDescriptor"),
                entries: &[
                    #[doc = " @binding(0): \"face_owner\""]
                    wgpu::BindGroupLayoutEntry {
                        binding: 0,
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: WgpuBindGroup0Entries) -> Self {
            ...
            let entries = bindings.into_array();
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup0"),
                layout: &bind_group_layout,
                entries: &entries,
            });
            Self(bind_group)
    ...
    impl WgpuBindGroup1 {
        pub const LAYOUT_DESCRIPTOR: wgpu::BindGroupLayoutDescriptor<'static> =
            wgpu::BindGroupLayoutDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup1::LayoutDescriptor"),
                entries: &[
                    #[doc = " @binding(0): \"u\""]
                    wgpu::BindGroupLayoutEntry {
                        binding: 0,
                    ...
                    wgpu::BindGroupLayoutEntry {
                        ...
                        ty: wgpu::BindingType::Buffer {
                            ...
                            has_dynamic_offset: false,
                            min_binding_size: std::num::NonZeroU64::new(std::mem::size_of::<
                                _root::momentum_assembly_v2::Constants,
                            >(
                            )
                                as _),
                        },
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: WgpuBindGroup1Entries) -> Self {
            ...
            let entries = bindings.into_array();
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup1"),
                layout: &bind_group_layout,
                entries: &entries,
            });
            Self(bind_group)
    ...
    impl WgpuBindGroup2 {
        pub const LAYOUT_DESCRIPTOR: wgpu::BindGroupLayoutDescriptor<'static> =
            wgpu::BindGroupLayoutDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup2::LayoutDescriptor"),
                entries: &[
                    #[doc = " @binding(0): \"matrix_values\""]
                    wgpu::BindGroupLayoutEntry {
                        binding: 0,
        ...
        pub fn from_bindings(device: &wgpu::Device, bindings: WgpuBindGroup2Entries) -> Self {
            ...
            let entries = bindings.into_array();
            let bind_group = device.create_bind_group(&wgpu::BindGroupDescriptor {
                label: Some("MomentumAssemblyV2::BindGroup2"),
                layout: &bind_group_layout,
                entries: &entries,
            });
            Self(bind_group)
    ...
    pub fn create_pipeline_layout(device: &wgpu::Device) -> wgpu::PipelineLayout {
        device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor {
            label: Some("MomentumAssemblyV2::PipelineLayout"),
            bind_group_layouts: &[
                &WgpuBindGroup0::get_bind_group_layout(device),
                &WgpuBindGroup1::get_bind_group_layout(device),
                &WgpuBindGroup2::get_bind_group_layout(device),
    ...
    pub fn create_shader_module_embed_source(device: &wgpu::Device) -> wgpu::ShaderModule {
        let source = std::borrow::Cow::Borrowed(SHADER_STRING);
        device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: Some("momentum_assembly_v2.wgsl"),
            source: wgpu::ShaderSource::Wgsl(source),
        })
    }
    pub const SHADER_STRING: &str = r#"
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let end = cell_face_offsets[(idx + 1u)];
    let u_n = u_old[idx];
    let _e28 = constants.component;
    let val_old = select(u_n.x, u_n.y, (_e28 == 1u));
    let val_c_p = p[idx];
    k = start;
    loop {
        let _e36 = k;
        ...
        }
        {
            ...
            let neigh_idx = face_neighbor[face_idx];
            let boundary_type = face_boundary[face_idx];
            let _e53 = face_normals[face_idx];
            normal = _e53;
            let area = face_areas[face_idx];
            let f_center = face_centers[face_idx];
            normal_sign = 1f;
            ...
            let _e75 = fluxes[face_idx];
            let _e76 = normal_sign;
            let flux = (_e75 * _e76);
            is_boundary = false;
            other_idx = 0u;
            if (neigh_idx != -1i) {
                ...
                let _e87 = other_idx;
                let _e89 = cell_centers[_e87];
                other_center = _e89;
            } else {
                is_boundary = true;
                other_center = f_center;
            }
            let _e93 = other_center.x;
            let d_vec_x = (_e93 - center.x);
            let _e97 = other_center.y;
            let d_vec_y = (_e97 - center.y);
            ...
            let _e115 = is_boundary;
            if !(_e115) {
                let _e118 = conv_coeff_off;
                let coeff = (-(diff_coeff) + _e118);
                let _e121 = k;
                let mat_idx = cell_face_matrix_indices[_e121];
                if (mat_idx != 4294967295u) {
                    matrix_values[mat_idx] = coeff;
                }
                let _e129 = conv_coeff_diag;
                let _e131 = diag_coeff;
                diag_coeff = (_e131 + (diff_coeff + _e129));
                let _e134 = normal.x;
                let s_x = (_e134 * area);
                let _e137 = normal.y;
                let s_y = (_e137 * area);
                ...
                let _e155 = k_scale;
                let k_x = (k_x_raw * _e155);
                let _e157 = k_scale;
                let k_y = (k_y_raw * _e157);
                let grad_own = grad_component[idx];
                let _e163 = other_idx;
                let grad_neigh = grad_component[_e163];
                let d_own = distance(vec2<f32>(center.x, center.y), vec2<f32>(f_center.x, f_center.y));
                let _e174 = other_center.x;
                let _e176 = other_center.y;
                let d_neigh = distance(vec2<f32>(_e174, _e176), vec2<f32>(f_center.x, f_center.y));
                let total_d = (d_own + d_neigh);
                interp_f = 0.5f;
                if (total_d > 0.000001f) {
                    interp_f = (d_own / total_d);
                }
                let _e189 = interp_f;
                let grad_f_x = (grad_own.x + (_e189 * (grad_neigh.x - grad_own.x)));
                let _e196 = interp_f;
                let grad_f_y = (grad_own.y + (_e196 * (grad_neigh.y - grad_own.y)));
                let correction_flux = ((0.5f * mu) * ((grad_f_x * k_x) + (grad_f_y * k_y)));
                let _e209 = rhs_val;
                rhs_val = (_e209 - correction_flux);
            } else {
                if (boundary_type == 1u) {
                    let _e215 = constants.ramp_time;
                    let _e218 = constants.time;
                    let ramp = smoothstep(0f, _e215, _e218);
                    let _e223 = constants.inlet_velocity;
                    let u_bc_x = (_e223 * ramp);
                    let _e227 = constants.component;
                    let val_bc = select(u_bc_x, 0f, (_e227 == 1u));
                    let _e232 = diag_coeff;
                    diag_coeff = (_e232 + diff_coeff);
                    let _e235 = rhs_val;
                    rhs_val = (_e235 + (diff_coeff * val_bc));
                    if (flux > 0f) {
                        let _e239 = diag_coeff;
                        diag_coeff = (_e239 + flux);
                    } else {
                        let _e242 = rhs_val;
                        rhs_val = (_e242 - (flux * val_bc));
                    }
                } else {
                    if (boundary_type == 3u) {
                        let _e246 = diag_coeff;
                        diag_coeff = (_e246 + diff_coeff);
                        if (flux > 0f) {
                            let _e250 = diag_coeff;
                            diag_coeff = (_e250 + flux);
                        }
                    } else {
                        if (boundary_type == 2u) {
                            if (flux > 0f) {
                                let _e256 = diag_coeff;
                                diag_coeff = (_e256 + flux);
                            }
                        }
                    }
                }
            }
            let _e260 = constants.component;
            if (_e260 == 0u) {
                val_f_p = 0f;
                let _e265 = is_boundary;
                if !(_e265) {
                    let d_c = distance(vec2<f32>(center.x, center.y), vec2<f32>(f_center.x, f_center.y));
                    let _e275 = other_center.x;
                    let _e277 = other_center.y;
                    let d_o = distance(vec2<f32>(_e275, _e277), vec2<f32>(f_center.x, f_center.y));
                    ...
                    let _e290 = other_idx;
                    let val_other_p = p[_e290];
                    let _e293 = lambda_p;
                    let _e295 = lambda_p;
                    val_f_p = ((_e293 * val_c_p) + ((1f - _e295) * val_other_p));
                } else {
                    if (boundary_type == 2u) {
                        val_f_p = 0f;
                    } else {
                ...
                let _e305 = val_f_p;
                let _e307 = normal.x;
                let _e310 = grad_p_accum.x;
                grad_p_accum.x = (_e310 + ((_e305 * _e307) * area));
                let _e313 = val_f_p;
                let _e315 = normal.y;
                let _e318 = grad_p_accum.y;
                grad_p_accum.y = (_e318 + ((_e313 * _e315) * area));
            }
            let _e322 = constants.scheme;
            let _e325 = is_boundary;
            if ((_e322 != 0u) && !(_e325)) {
                let _e329 = other_idx;
                let u_other_old = u_old[_e329];
                let _e336 = constants.component;
                let val_other = select(u_other_old.x, u_other_old.y, (_e336 == 1u));
                phi_upwind = val_old;
                if (flux < 0f) {
                    phi_upwind = val_other;
                }
                let _e343 = phi_upwind;
                phi_ho = _e343;
                let d_c_1 = distance(vec2<f32>(center.x, center.y), vec2<f32>(f_center.x, f_center.y));
                let _e353 = other_center.x;
                let _e355 = other_center.y;
                let d_o_1 = distance(vec2<f32>(_e353, _e355), vec2<f32>(f_center.x, f_center.y));
                let _e363 = constants.scheme;
                if (_e363 == 1u) {
                    if (flux > 0f) {
                        ...
                        let _e384 = other_idx;
                        let grad_1 = grad_component[_e384];
                        let _e389 = other_center.x;
                        let r_x_1 = (f_center.x - _e389);
                        let _e393 = other_center.y;
                        let r_y_1 = (f_center.y - _e393);
                        phi_ho = (val_other + ((grad_1.x * r_x_1) + (grad_1.y * r_y_1)));
                    }
                } else {
                    let _e403 = constants.scheme;
                    if (_e403 == 2u) {
                        if (flux > 0f) {
                            let grad_2 = grad_component[idx];
                            let _e412 = other_center.x;
                            let d_cd_x = (_e412 - center.x);
                            let _e416 = other_center.y;
                            let d_cd_y = (_e416 - center.y);
                            let grad_term = ((grad_2.x * d_cd_x) + (grad_2.y * d_cd_y));
                            phi_ho = (((0.625f * val_old) + (0.375f * val_other)) + (0.125f * grad_term));
                        } else {
                            let _e433 = other_idx;
                            let grad_3 = grad_component[_e433];
                            let _e438 = other_center.x;
                            let d_cd_x_1 = (center.x - _e438);
                            let _e442 = other_center.y;
                            let d_cd_y_1 = (center.y - _e442);
                            let grad_term_1 = ((grad_3.x * d_cd_x_1) + (grad_3.y * d_cd_y_1));
                            phi_ho = (((0.625f * val_other) + (0.375f * val_old)) + (0.125f * grad_term_1));
                        }
                    }
                }
                let _e457 = phi_ho;
                let _e458 = phi_upwind;
                let correction = (flux * (_e457 - _e458));
                let _e461 = rhs_val;
                rhs_val = (_e461 - correction);
            }
        }
        continuing {
            let _e464 = k;
    ...
    let _e468 = constants.component;
    if (_e468 == 0u) {
        let _e472 = grad_p_accum.x;
        grad_p_accum.x = (_e472 / vol);
        let _e475 = grad_p_accum.y;
        grad_p_accum.y = (_e475 / vol);
        let _e479 = grad_p_accum;
        grad_p[idx] = _e479;
        let _e481 = grad_p_accum.x;
        let _e483 = rhs_val;
        rhs_val = (_e483 - (_e481 * vol));
    } else {
        let gp = grad_p[idx];
        let _e490 = rhs_val;
        rhs_val = (_e490 - (gp.y * vol));
    }
    let _e494 = constants.density;
    let _e498 = constants.dt;
    time_coeff = ((vol * _e494) / _e498);
    let _e501 = time_coeff;
    rhs_time = (_e501 * val_old);
    let _e506 = constants.time_scheme;
    if (_e506 == 1u) {
        let dt = constants.dt;
        let dt_old = constants.dt_old;
        let r = (dt / dt_old);
        let u_nm1_ = u_old_old[idx];
        let _e523 = constants.component;
        let val_nm1_ = select(u_nm1_.x, u_nm1_.y, (_e523 == 1u));
        let _e529 = constants.density;
        time_coeff = ((((vol * _e529) / dt) * (1f + (2f * r))) / (1f + r));
        let _e542 = constants.density;
        rhs_time = (((vol * _e542) / dt) * (((1f + r) * val_old) - (((r * r) / (1f + r)) * val_nm1_)));
    }
    let _e555 = time_coeff;
    let _e556 = diag_coeff;
    diag_coeff = (_e556 + _e555);
    let _e558 = rhs_time;
    let _e559 = rhs_val;
    rhs_val = (_e559 + _e558);
    let diag_idx = diagonal_indices[idx];
    let _e566 = diag_coeff;
    matrix_values[diag_idx] = _e566;
    let _e569 = constants.component;
    if (_e569 == 0u) {
        let _e572 = diag_coeff;
        if (abs(_e572) > 0.00000000000000000001f) {
            let _e578 = diag_coeff;
            d_p[idx] = (vol / _e578);
        } else {
            d_p[idx] = 0f;
        }
