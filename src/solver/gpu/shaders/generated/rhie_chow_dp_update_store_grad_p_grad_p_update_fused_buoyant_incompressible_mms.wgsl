...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k2_k = k2_start; k2_k < k2_end; k2_k++) {
        ...
        k2_grad_acc_p += k2_normal_vec * (state[base + 2u] * k2_lambda + select(state[k2_other_idx * 12u + 2u], select(select(state[base + 2u], bc_value[k2_face_idx * 4u + 2u], bc_kind[k2_face_idx * 4u + 2u] == 1u), state[base + 2u] + bc_value[k2_face_idx * 4u + 2u] * k2_d_own, bc_kind[k2_face_idx * 4u + 2u] == 2u), k2_is_boundary) * k2_lambda_other) * k2_area;
    }
