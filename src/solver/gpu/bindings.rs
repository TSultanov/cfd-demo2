...
// SourceHash: 9cc23578fb443c6e349f076fecab7aed5ee0a1c089e989e6b1c11f0e4b663c45
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let _e1365 = constants.viscosity;
    let _e1366 = neigh_idx;
    let _e1373 = state[((_e1366 * 7u) + 1u)];
    let _e1380 = state[((owner * 7u) + 1u)];
    let _e1387 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1394 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1404 = state[((owner * 7u) + 1u)];
    let _e1411 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1420 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1425 = neigh_idx;
    let _e1432 = state[((_e1425 * 7u) + 2u)];
    let _e1439 = state[((owner * 7u) + 2u)];
    let _e1446 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1453 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1463 = state[((owner * 7u) + 2u)];
    let _e1470 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1479 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1487 = neigh_idx;
    let _e1494 = state[((_e1487 * 7u) + 0u)];
    let _e1501 = state[((owner * 7u) + 0u)];
    let _e1508 = bc_value[((boundary_type * 4u) + 0u)];
    let _e1515 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e1525 = state[((owner * 7u) + 0u)];
    let _e1532 = bc_value[((boundary_type * 4u) + 0u)];
    let _e1541 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e1554 = state[((owner * 7u) + 1u)];
    let _e1561 = state[((owner * 7u) + 2u)];
    let _e1571 = state[((owner * 7u) + 0u)];
    let _e1586 = neigh_idx;
    let _e1593 = state[((_e1586 * 7u) + 1u)];
    let _e1600 = state[((owner * 7u) + 1u)];
    let _e1607 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1614 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1624 = state[((owner * 7u) + 1u)];
    let _e1631 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1640 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1645 = neigh_idx;
    let _e1652 = state[((_e1645 * 7u) + 2u)];
    let _e1659 = state[((owner * 7u) + 2u)];
    let _e1666 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1673 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1683 = state[((owner * 7u) + 2u)];
    let _e1690 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1699 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1709 = neigh_idx;
    let _e1716 = state[((_e1709 * 7u) + 1u)];
    let _e1723 = state[((owner * 7u) + 1u)];
    let _e1730 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1737 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1747 = state[((owner * 7u) + 1u)];
    let _e1754 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1763 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e1768 = neigh_idx;
    let _e1775 = state[((_e1768 * 7u) + 2u)];
    let _e1782 = state[((owner * 7u) + 2u)];
    let _e1789 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1796 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1806 = state[((owner * 7u) + 2u)];
    let _e1813 = bc_value[((boundary_type * 4u) + 2u)];
    let _e1822 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e1830 = neigh_idx;
    let _e1837 = state[((_e1830 * 7u) + 0u)];
    let _e1844 = state[((owner * 7u) + 0u)];
    let _e1851 = bc_value[((boundary_type * 4u) + 0u)];
    let _e1858 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e1868 = state[((owner * 7u) + 0u)];
    let _e1875 = bc_value[((boundary_type * 4u) + 0u)];
    let _e1884 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e1891 = normal_vec;
    let _e1894 = neigh_idx;
    let _e1902 = state[((select(_e1894, owner, is_boundary) * 7u) + 3u)];
    let _e1903 = neigh_idx;
    let _e1911 = state[((select(_e1903, owner, is_boundary) * 7u) + 1u)];
    let _e1912 = neigh_idx;
    let _e1920 = state[((select(_e1912, owner, is_boundary) * 7u) + 1u)];
    let _e1922 = neigh_idx;
    let _e1930 = state[((select(_e1922, owner, is_boundary) * 7u) + 2u)];
    let _e1931 = neigh_idx;
    let _e1939 = state[((select(_e1931, owner, is_boundary) * 7u) + 2u)];
    let _e1944 = neigh_idx;
    let _e1952 = state[((select(_e1944, owner, is_boundary) * 7u) + 0u)];
    let _e1957 = normal_vec;
    let _e1966 = constants.viscosity;
    let _e1967 = neigh_idx;
    let _e1974 = state[((_e1967 * 7u) + 1u)];
    let _e1981 = state[((owner * 7u) + 1u)];
    let _e1988 = bc_value[((boundary_type * 4u) + 1u)];
    let _e1995 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2005 = state[((owner * 7u) + 1u)];
    let _e2012 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2021 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2026 = neigh_idx;
    let _e2033 = state[((_e2026 * 7u) + 2u)];
    let _e2040 = state[((owner * 7u) + 2u)];
    let _e2047 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2054 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2064 = state[((owner * 7u) + 2u)];
    let _e2071 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2080 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2088 = neigh_idx;
    let _e2095 = state[((_e2088 * 7u) + 0u)];
    let _e2102 = state[((owner * 7u) + 0u)];
    let _e2109 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2116 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2126 = state[((owner * 7u) + 0u)];
    let _e2133 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2142 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2155 = state[((owner * 7u) + 1u)];
    let _e2162 = state[((owner * 7u) + 2u)];
    let _e2172 = state[((owner * 7u) + 0u)];
    let _e2189 = neigh_idx;
    let _e2196 = state[((_e2189 * 7u) + 1u)];
    let _e2203 = state[((owner * 7u) + 1u)];
    let _e2210 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2217 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2227 = state[((owner * 7u) + 1u)];
    let _e2234 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2243 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2248 = neigh_idx;
    let _e2255 = state[((_e2248 * 7u) + 2u)];
    let _e2262 = state[((owner * 7u) + 2u)];
    let _e2269 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2276 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2286 = state[((owner * 7u) + 2u)];
    let _e2293 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2302 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2318 = state[((owner * 7u) + 1u)];
    let _e2325 = state[((owner * 7u) + 2u)];
    fluxes[((idx * 4u) + 1u)] = (((((a_plus * (((dot(vec2<f32>(_e1263, _e1270), vec2<f32>(1f, 0f)) * dot(((vec2<f32>(_e1282, _e1289) * 1f) / vec2(_e1299)), _e1302)) + ((0.39999998f * (_e1311 - ((0.5f * ((_e1318 * _e1325) + (_e1333 * _e1340))) / _e1351))) * dot(_e1356, vec2<f32>(1f, 0f)))) + -((((_e1365 * dot((((vec2<f32>(select(_e1373, select(select(_e1380, _e1387, (_e1394 == 1u)), (_e1404 + (_e1411 * d_own)), (_e1420 == 2u)), is_boundary), select(_e1432, select(select(_e1439, _e1446, (_e1453 == 1u)), (_e1463 + (_e1470 * d_own)), (_e1479 == 2u)), is_boundary)) * 1f) / vec2(select(_e1494, select(select(_e1501, _e1508, (_e1515 == 1u)), (_e1525 + (_e1532 * d_own)), (_e1541 == 2u)), is_boundary))) - ((vec2<f32>(_e1554, _e1561) * 1f) / vec2(_e1571))), vec2<f32>(1f, 0f))) * 1f) / dist)))) - (a_minus * (((dot(vec2<f32>(select(_e1593, select(select(_e1600, _e1607, (_e1614 == 1u)), (_e1624 + (_e1631 * d_own)), (_e1640 == 2u)), is_boundary), select(_e1652, select(select(_e1659, _e1666, (_e1673 == 1u)), (_e1683 + (_e1690 * d_own)), (_e1699 == 2u)), is_boundary)), vec2<f32>(1f, 0f)) * dot(((vec2<f32>(select(_e1716, select(select(_e1723, _e1730, (_e1737 == 1u)), (_e1747 + (_e1754 * d_own)), (_e1763 == 2u)), is_boundary), select(_e1775, select(select(_e1782, _e1789, (_e1796 == 1u)), (_e1806 + (_e1813 * d_own)), (_e1822 == 2u)), is_boundary)) * 1f) / vec2(select(_e1837, select(select(_e1844, _e1851, (_e1858 == 1u)), (_e1868 + (_e1875 * d_own)), (_e1884 == 2u)), is_boundary))), _e1891)) + ((0.39999998f * (_e1902 - ((0.5f * ((_e1911 * _e1920) + (_e1930 * _e1939))) / _e1952))) * dot(_e1957, vec2<f32>(1f, 0f)))) + -((((_e1966 * dot((((vec2<f32>(select(_e1974, select(select(_e1981, _e1988, (_e1995 == 1u)), (_e2005 + (_e2012 * d_own)), (_e2021 == 2u)), is_boundary), select(_e2033, select(select(_e2040, _e2047, (_e2054 == 1u)), (_e2064 + (_e2071 * d_own)), (_e2080 == 2u)), is_boundary)) * 1f) / vec2(select(_e2095, select(select(_e2102, _e2109, (_e2116 == 1u)), (_e2126 + (_e2133 * d_own)), (_e2142 == 2u)), is_boundary))) - ((vec2<f32>(_e2155, _e2162) * 1f) / vec2(_e2172))), vec2<f32>(1f, 0f))) * 1f) / dist))))) + ((a_plus * a_minus) * (dot(vec2<f32>(select(_e2196, select(select(_e2203, _e2210, (_e2217 == 1u)), (_e2227 + (_e2234 * d_own)), (_e2243 == 2u)), is_boundary), select(_e2255, select(select(_e2262, _e2269, (_e2276 == 1u)), (_e2286 + (_e2293 * d_own)), (_e2302 == 2u)), is_boundary)), vec2<f32>(1f, 0f)) - dot(vec2<f32>(_e2318, _e2325), vec2<f32>(1f, 0f))))) / denom) * area);
    let _e2348 = state[((owner * 7u) + 1u)];
    let _e2355 = state[((owner * 7u) + 2u)];
    let _e2367 = state[((owner * 7u) + 1u)];
    let _e2374 = state[((owner * 7u) + 2u)];
    let _e2384 = state[((owner * 7u) + 0u)];
    let _e2387 = normal_vec;
    let _e2396 = state[((owner * 7u) + 3u)];
    let _e2403 = state[((owner * 7u) + 1u)];
    let _e2410 = state[((owner * 7u) + 1u)];
    let _e2418 = state[((owner * 7u) + 2u)];
    let _e2425 = state[((owner * 7u) + 2u)];
    let _e2436 = state[((owner * 7u) + 0u)];
    let _e2441 = normal_vec;
    let _e2450 = constants.viscosity;
    let _e2451 = neigh_idx;
    let _e2458 = state[((_e2451 * 7u) + 1u)];
    let _e2465 = state[((owner * 7u) + 1u)];
    let _e2472 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2479 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2489 = state[((owner * 7u) + 1u)];
    let _e2496 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2505 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2510 = neigh_idx;
    let _e2517 = state[((_e2510 * 7u) + 2u)];
    let _e2524 = state[((owner * 7u) + 2u)];
    let _e2531 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2538 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2548 = state[((owner * 7u) + 2u)];
    let _e2555 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2564 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2572 = neigh_idx;
    let _e2579 = state[((_e2572 * 7u) + 0u)];
    let _e2586 = state[((owner * 7u) + 0u)];
    let _e2593 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2600 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2610 = state[((owner * 7u) + 0u)];
    let _e2617 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2626 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2639 = state[((owner * 7u) + 1u)];
    let _e2646 = state[((owner * 7u) + 2u)];
    let _e2656 = state[((owner * 7u) + 0u)];
    let _e2671 = neigh_idx;
    let _e2678 = state[((_e2671 * 7u) + 1u)];
    let _e2685 = state[((owner * 7u) + 1u)];
    let _e2692 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2699 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2709 = state[((owner * 7u) + 1u)];
    let _e2716 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2725 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2730 = neigh_idx;
    let _e2737 = state[((_e2730 * 7u) + 2u)];
    let _e2744 = state[((owner * 7u) + 2u)];
    let _e2751 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2758 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2768 = state[((owner * 7u) + 2u)];
    let _e2775 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2784 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2794 = neigh_idx;
    let _e2801 = state[((_e2794 * 7u) + 1u)];
    let _e2808 = state[((owner * 7u) + 1u)];
    let _e2815 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2822 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2832 = state[((owner * 7u) + 1u)];
    let _e2839 = bc_value[((boundary_type * 4u) + 1u)];
    let _e2848 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e2853 = neigh_idx;
    let _e2860 = state[((_e2853 * 7u) + 2u)];
    let _e2867 = state[((owner * 7u) + 2u)];
    let _e2874 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2881 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2891 = state[((owner * 7u) + 2u)];
    let _e2898 = bc_value[((boundary_type * 4u) + 2u)];
    let _e2907 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e2915 = neigh_idx;
    let _e2922 = state[((_e2915 * 7u) + 0u)];
    let _e2929 = state[((owner * 7u) + 0u)];
    let _e2936 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2943 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2953 = state[((owner * 7u) + 0u)];
    let _e2960 = bc_value[((boundary_type * 4u) + 0u)];
    let _e2969 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e2976 = normal_vec;
    let _e2979 = neigh_idx;
    let _e2987 = state[((select(_e2979, owner, is_boundary) * 7u) + 3u)];
    let _e2988 = neigh_idx;
    let _e2996 = state[((select(_e2988, owner, is_boundary) * 7u) + 1u)];
    let _e2997 = neigh_idx;
    let _e3005 = state[((select(_e2997, owner, is_boundary) * 7u) + 1u)];
    let _e3007 = neigh_idx;
    let _e3015 = state[((select(_e3007, owner, is_boundary) * 7u) + 2u)];
    let _e3016 = neigh_idx;
    let _e3024 = state[((select(_e3016, owner, is_boundary) * 7u) + 2u)];
    let _e3029 = neigh_idx;
    let _e3037 = state[((select(_e3029, owner, is_boundary) * 7u) + 0u)];
    let _e3042 = normal_vec;
    let _e3051 = constants.viscosity;
    let _e3052 = neigh_idx;
    let _e3059 = state[((_e3052 * 7u) + 1u)];
    let _e3066 = state[((owner * 7u) + 1u)];
    let _e3073 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3080 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3090 = state[((owner * 7u) + 1u)];
    let _e3097 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3106 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3111 = neigh_idx;
    let _e3118 = state[((_e3111 * 7u) + 2u)];
    let _e3125 = state[((owner * 7u) + 2u)];
    let _e3132 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3139 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3149 = state[((owner * 7u) + 2u)];
    let _e3156 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3165 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3173 = neigh_idx;
    let _e3180 = state[((_e3173 * 7u) + 0u)];
    let _e3187 = state[((owner * 7u) + 0u)];
    let _e3194 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3201 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3211 = state[((owner * 7u) + 0u)];
    let _e3218 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3227 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3240 = state[((owner * 7u) + 1u)];
    let _e3247 = state[((owner * 7u) + 2u)];
    let _e3257 = state[((owner * 7u) + 0u)];
    let _e3274 = neigh_idx;
    let _e3281 = state[((_e3274 * 7u) + 1u)];
    let _e3288 = state[((owner * 7u) + 1u)];
    let _e3295 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3302 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3312 = state[((owner * 7u) + 1u)];
    let _e3319 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3328 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3333 = neigh_idx;
    let _e3340 = state[((_e3333 * 7u) + 2u)];
    let _e3347 = state[((owner * 7u) + 2u)];
    let _e3354 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3361 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3371 = state[((owner * 7u) + 2u)];
    let _e3378 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3387 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3403 = state[((owner * 7u) + 1u)];
    let _e3410 = state[((owner * 7u) + 2u)];
    fluxes[((idx * 4u) + 2u)] = (((((a_plus * (((dot(vec2<f32>(_e2348, _e2355), vec2<f32>(0f, 1f)) * dot(((vec2<f32>(_e2367, _e2374) * 1f) / vec2(_e2384)), _e2387)) + ((0.39999998f * (_e2396 - ((0.5f * ((_e2403 * _e2410) + (_e2418 * _e2425))) / _e2436))) * dot(_e2441, vec2<f32>(0f, 1f)))) + -((((_e2450 * dot((((vec2<f32>(select(_e2458, select(select(_e2465, _e2472, (_e2479 == 1u)), (_e2489 + (_e2496 * d_own)), (_e2505 == 2u)), is_boundary), select(_e2517, select(select(_e2524, _e2531, (_e2538 == 1u)), (_e2548 + (_e2555 * d_own)), (_e2564 == 2u)), is_boundary)) * 1f) / vec2(select(_e2579, select(select(_e2586, _e2593, (_e2600 == 1u)), (_e2610 + (_e2617 * d_own)), (_e2626 == 2u)), is_boundary))) - ((vec2<f32>(_e2639, _e2646) * 1f) / vec2(_e2656))), vec2<f32>(0f, 1f))) * 1f) / dist)))) - (a_minus * (((dot(vec2<f32>(select(_e2678, select(select(_e2685, _e2692, (_e2699 == 1u)), (_e2709 + (_e2716 * d_own)), (_e2725 == 2u)), is_boundary), select(_e2737, select(select(_e2744, _e2751, (_e2758 == 1u)), (_e2768 + (_e2775 * d_own)), (_e2784 == 2u)), is_boundary)), vec2<f32>(0f, 1f)) * dot(((vec2<f32>(select(_e2801, select(select(_e2808, _e2815, (_e2822 == 1u)), (_e2832 + (_e2839 * d_own)), (_e2848 == 2u)), is_boundary), select(_e2860, select(select(_e2867, _e2874, (_e2881 == 1u)), (_e2891 + (_e2898 * d_own)), (_e2907 == 2u)), is_boundary)) * 1f) / vec2(select(_e2922, select(select(_e2929, _e2936, (_e2943 == 1u)), (_e2953 + (_e2960 * d_own)), (_e2969 == 2u)), is_boundary))), _e2976)) + ((0.39999998f * (_e2987 - ((0.5f * ((_e2996 * _e3005) + (_e3015 * _e3024))) / _e3037))) * dot(_e3042, vec2<f32>(0f, 1f)))) + -((((_e3051 * dot((((vec2<f32>(select(_e3059, select(select(_e3066, _e3073, (_e3080 == 1u)), (_e3090 + (_e3097 * d_own)), (_e3106 == 2u)), is_boundary), select(_e3118, select(select(_e3125, _e3132, (_e3139 == 1u)), (_e3149 + (_e3156 * d_own)), (_e3165 == 2u)), is_boundary)) * 1f) / vec2(select(_e3180, select(select(_e3187, _e3194, (_e3201 == 1u)), (_e3211 + (_e3218 * d_own)), (_e3227 == 2u)), is_boundary))) - ((vec2<f32>(_e3240, _e3247) * 1f) / vec2(_e3257))), vec2<f32>(0f, 1f))) * 1f) / dist))))) + ((a_plus * a_minus) * (dot(vec2<f32>(select(_e3281, select(select(_e3288, _e3295, (_e3302 == 1u)), (_e3312 + (_e3319 * d_own)), (_e3328 == 2u)), is_boundary), select(_e3340, select(select(_e3347, _e3354, (_e3361 == 1u)), (_e3371 + (_e3378 * d_own)), (_e3387 == 2u)), is_boundary)), vec2<f32>(0f, 1f)) - dot(vec2<f32>(_e3403, _e3410), vec2<f32>(0f, 1f))))) / denom) * area);
    let _e3433 = state[((owner * 7u) + 3u)];
    let _e3440 = state[((owner * 7u) + 3u)];
    let _e3447 = state[((owner * 7u) + 1u)];
    let _e3454 = state[((owner * 7u) + 1u)];
    let _e3462 = state[((owner * 7u) + 2u)];
    let _e3469 = state[((owner * 7u) + 2u)];
    let _e3480 = state[((owner * 7u) + 0u)];
    let _e3492 = state[((owner * 7u) + 1u)];
    let _e3499 = state[((owner * 7u) + 2u)];
    let _e3509 = state[((owner * 7u) + 0u)];
    let _e3512 = normal_vec;
    let _e3517 = constants.viscosity;
    let _e3518 = neigh_idx;
    let _e3525 = state[((_e3518 * 7u) + 1u)];
    let _e3532 = state[((owner * 7u) + 1u)];
    let _e3539 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3546 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3556 = state[((owner * 7u) + 1u)];
    let _e3563 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3572 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3577 = neigh_idx;
    let _e3584 = state[((_e3577 * 7u) + 2u)];
    let _e3591 = state[((owner * 7u) + 2u)];
    let _e3598 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3605 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3615 = state[((owner * 7u) + 2u)];
    let _e3622 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3631 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3639 = neigh_idx;
    let _e3646 = state[((_e3639 * 7u) + 0u)];
    let _e3653 = state[((owner * 7u) + 0u)];
    let _e3660 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3667 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3677 = state[((owner * 7u) + 0u)];
    let _e3684 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3693 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3706 = state[((owner * 7u) + 1u)];
    let _e3713 = state[((owner * 7u) + 2u)];
    let _e3723 = state[((owner * 7u) + 0u)];
    let _e3737 = state[((owner * 7u) + 1u)];
    let _e3744 = state[((owner * 7u) + 2u)];
    let _e3754 = state[((owner * 7u) + 0u)];
    let _e3757 = neigh_idx;
    let _e3764 = state[((_e3757 * 7u) + 1u)];
    let _e3771 = state[((owner * 7u) + 1u)];
    let _e3778 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3785 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3795 = state[((owner * 7u) + 1u)];
    let _e3802 = bc_value[((boundary_type * 4u) + 1u)];
    let _e3811 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e3816 = neigh_idx;
    let _e3823 = state[((_e3816 * 7u) + 2u)];
    let _e3830 = state[((owner * 7u) + 2u)];
    let _e3837 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3844 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3854 = state[((owner * 7u) + 2u)];
    let _e3861 = bc_value[((boundary_type * 4u) + 2u)];
    let _e3870 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e3878 = neigh_idx;
    let _e3885 = state[((_e3878 * 7u) + 0u)];
    let _e3892 = state[((owner * 7u) + 0u)];
    let _e3899 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3906 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3916 = state[((owner * 7u) + 0u)];
    let _e3923 = bc_value[((boundary_type * 4u) + 0u)];
    let _e3932 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e3948 = constants.viscosity;
    let _e3951 = neigh_idx;
    let _e3959 = state[((select(_e3951, owner, is_boundary) * 7u) + 3u)];
    let _e3960 = neigh_idx;
    let _e3968 = state[((select(_e3960, owner, is_boundary) * 7u) + 1u)];
    let _e3969 = neigh_idx;
    let _e3977 = state[((select(_e3969, owner, is_boundary) * 7u) + 1u)];
    let _e3979 = neigh_idx;
    let _e3987 = state[((select(_e3979, owner, is_boundary) * 7u) + 2u)];
    let _e3988 = neigh_idx;
    let _e3996 = state[((select(_e3988, owner, is_boundary) * 7u) + 2u)];
    let _e4001 = neigh_idx;
    let _e4009 = state[((select(_e4001, owner, is_boundary) * 7u) + 0u)];
    let _e4014 = neigh_idx;
    let _e4021 = state[((_e4014 * 7u) + 0u)];
    let _e4028 = state[((owner * 7u) + 0u)];
    let _e4035 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4042 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4052 = state[((owner * 7u) + 0u)];
    let _e4059 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4068 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4080 = state[((owner * 7u) + 3u)];
    let _e4087 = state[((owner * 7u) + 1u)];
    let _e4094 = state[((owner * 7u) + 1u)];
    let _e4102 = state[((owner * 7u) + 2u)];
    let _e4109 = state[((owner * 7u) + 2u)];
    let _e4120 = state[((owner * 7u) + 0u)];
    let _e4131 = state[((owner * 7u) + 0u)];
    let _e4141 = neigh_idx;
    let _e4148 = state[((_e4141 * 7u) + 3u)];
    let _e4155 = state[((owner * 7u) + 3u)];
    let _e4162 = bc_value[((boundary_type * 4u) + 3u)];
    let _e4169 = bc_kind[((boundary_type * 4u) + 3u)];
    let _e4179 = state[((owner * 7u) + 3u)];
    let _e4186 = bc_value[((boundary_type * 4u) + 3u)];
    let _e4195 = bc_kind[((boundary_type * 4u) + 3u)];
    let _e4200 = neigh_idx;
    let _e4208 = state[((select(_e4200, owner, is_boundary) * 7u) + 3u)];
    let _e4209 = neigh_idx;
    let _e4217 = state[((select(_e4209, owner, is_boundary) * 7u) + 1u)];
    let _e4218 = neigh_idx;
    let _e4226 = state[((select(_e4218, owner, is_boundary) * 7u) + 1u)];
    let _e4228 = neigh_idx;
    let _e4236 = state[((select(_e4228, owner, is_boundary) * 7u) + 2u)];
    let _e4237 = neigh_idx;
    let _e4245 = state[((select(_e4237, owner, is_boundary) * 7u) + 2u)];
    let _e4250 = neigh_idx;
    let _e4258 = state[((select(_e4250, owner, is_boundary) * 7u) + 0u)];
    let _e4264 = neigh_idx;
    let _e4271 = state[((_e4264 * 7u) + 1u)];
    let _e4278 = state[((owner * 7u) + 1u)];
    let _e4285 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4292 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4302 = state[((owner * 7u) + 1u)];
    let _e4309 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4318 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4323 = neigh_idx;
    let _e4330 = state[((_e4323 * 7u) + 2u)];
    let _e4337 = state[((owner * 7u) + 2u)];
    let _e4344 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4351 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4361 = state[((owner * 7u) + 2u)];
    let _e4368 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4377 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4385 = neigh_idx;
    let _e4392 = state[((_e4385 * 7u) + 0u)];
    let _e4399 = state[((owner * 7u) + 0u)];
    let _e4406 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4413 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4423 = state[((owner * 7u) + 0u)];
    let _e4430 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4439 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4446 = normal_vec;
    let _e4451 = constants.viscosity;
    let _e4452 = neigh_idx;
    let _e4459 = state[((_e4452 * 7u) + 1u)];
    let _e4466 = state[((owner * 7u) + 1u)];
    let _e4473 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4480 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4490 = state[((owner * 7u) + 1u)];
    let _e4497 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4506 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4511 = neigh_idx;
    let _e4518 = state[((_e4511 * 7u) + 2u)];
    let _e4525 = state[((owner * 7u) + 2u)];
    let _e4532 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4539 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4549 = state[((owner * 7u) + 2u)];
    let _e4556 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4565 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4573 = neigh_idx;
    let _e4580 = state[((_e4573 * 7u) + 0u)];
    let _e4587 = state[((owner * 7u) + 0u)];
    let _e4594 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4601 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4611 = state[((owner * 7u) + 0u)];
    let _e4618 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4627 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4640 = state[((owner * 7u) + 1u)];
    let _e4647 = state[((owner * 7u) + 2u)];
    let _e4657 = state[((owner * 7u) + 0u)];
    let _e4671 = state[((owner * 7u) + 1u)];
    let _e4678 = state[((owner * 7u) + 2u)];
    let _e4688 = state[((owner * 7u) + 0u)];
    let _e4691 = neigh_idx;
    let _e4698 = state[((_e4691 * 7u) + 1u)];
    let _e4705 = state[((owner * 7u) + 1u)];
    let _e4712 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4719 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4729 = state[((owner * 7u) + 1u)];
    let _e4736 = bc_value[((boundary_type * 4u) + 1u)];
    let _e4745 = bc_kind[((boundary_type * 4u) + 1u)];
    let _e4750 = neigh_idx;
    let _e4757 = state[((_e4750 * 7u) + 2u)];
    let _e4764 = state[((owner * 7u) + 2u)];
    let _e4771 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4778 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4788 = state[((owner * 7u) + 2u)];
    let _e4795 = bc_value[((boundary_type * 4u) + 2u)];
    let _e4804 = bc_kind[((boundary_type * 4u) + 2u)];
    let _e4812 = neigh_idx;
    let _e4819 = state[((_e4812 * 7u) + 0u)];
    let _e4826 = state[((owner * 7u) + 0u)];
    let _e4833 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4840 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4850 = state[((owner * 7u) + 0u)];
    let _e4857 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4866 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4882 = constants.viscosity;
    let _e4885 = neigh_idx;
    let _e4893 = state[((select(_e4885, owner, is_boundary) * 7u) + 3u)];
    let _e4894 = neigh_idx;
    let _e4902 = state[((select(_e4894, owner, is_boundary) * 7u) + 1u)];
    let _e4903 = neigh_idx;
    let _e4911 = state[((select(_e4903, owner, is_boundary) * 7u) + 1u)];
    let _e4913 = neigh_idx;
    let _e4921 = state[((select(_e4913, owner, is_boundary) * 7u) + 2u)];
    let _e4922 = neigh_idx;
    let _e4930 = state[((select(_e4922, owner, is_boundary) * 7u) + 2u)];
    let _e4935 = neigh_idx;
    let _e4943 = state[((select(_e4935, owner, is_boundary) * 7u) + 0u)];
    let _e4948 = neigh_idx;
    let _e4955 = state[((_e4948 * 7u) + 0u)];
    let _e4962 = state[((owner * 7u) + 0u)];
    let _e4969 = bc_value[((boundary_type * 4u) + 0u)];
    let _e4976 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e4986 = state[((owner * 7u) + 0u)];
    let _e4993 = bc_value[((boundary_type * 4u) + 0u)];
    let _e5002 = bc_kind[((boundary_type * 4u) + 0u)];
    let _e5014 = state[((owner * 7u) + 3u)];
    let _e5021 = state[((owner * 7u) + 1u)];
    let _e5028 = state[((owner * 7u) + 1u)];
    let _e5036 = state[((owner * 7u) + 2u)];
    let _e5043 = state[((owner * 7u) + 2u)];
    let _e5054 = state[((owner * 7u) + 0u)];
    let _e5065 = state[((owner * 7u) + 0u)];
    let _e5077 = neigh_idx;
    let _e5084 = state[((_e5077 * 7u) + 3u)];
    let _e5091 = state[((owner * 7u) + 3u)];
    let _e5098 = bc_value[((boundary_type * 4u) + 3u)];
    let _e5105 = bc_kind[((boundary_type * 4u) + 3u)];
    let _e5115 = state[((owner * 7u) + 3u)];
    let _e5122 = bc_value[((boundary_type * 4u) + 3u)];
    let _e5131 = bc_kind[((boundary_type * 4u) + 3u)];
    let _e5142 = state[((owner * 7u) + 3u)];
    fluxes[((idx * 4u) + 3u)] = (((((a_plus * ((((_e3433 + (0.39999998f * (_e3440 - ((0.5f * ((_e3447 * _e3454) + (_e3462 * _e3469))) / _e3480)))) * dot(((vec2<f32>(_e3492, _e3499) * 1f) / vec2(_e3509)), _e3512)) + -((_e3517 * dot((((((vec2<f32>(select(_e3525, select(select(_e3532, _e3539, (_e3546 == 1u)), (_e3556 + (_e3563 * d_own)), (_e3572 == 2u)), is_boundary), select(_e3584, select(select(_e3591, _e3598, (_e3605 == 1u)), (_e3615 + (_e3622 * d_own)), (_e3631 == 2u)), is_boundary)) * 1f) / vec2(select(_e3646, select(select(_e3653, _e3660, (_e3667 == 1u)), (_e3677 + (_e3684 * d_own)), (_e3693 == 2u)), is_boundary))) - ((vec2<f32>(_e3706, _e3713) * 1f) / vec2(_e3723))) * 1f) / vec2(dist)), ((((vec2<f32>(_e3737, _e3744) * 1f) / vec2(_e3754)) + ((vec2<f32>(select(_e3764, select(select(_e3771, _e3778, (_e3785 == 1u)), (_e3795 + (_e3802 * d_own)), (_e3811 == 2u)), is_boundary), select(_e3823, select(select(_e3830, _e3837, (_e3844 == 1u)), (_e3854 + (_e3861 * d_own)), (_e3870 == 2u)), is_boundary)) * 1f) / vec2(select(_e3885, select(select(_e3892, _e3899, (_e3906 == 1u)), (_e3916 + (_e3923 * d_own)), (_e3932 == 2u)), is_boundary)))) * 0.5f))))) + -(((((_e3948 * 3.5000002f) * (((0.39999998f * (_e3959 - ((0.5f * ((_e3968 * _e3977) + (_e3987 * _e3996))) / _e4009))) / select(_e4021, select(select(_e4028, _e4035, (_e4042 == 1u)), (_e4052 + (_e4059 * d_own)), (_e4068 == 2u)), is_boundary)) - ((0.39999998f * (_e4080 - ((0.5f * ((_e4087 * _e4094) + (_e4102 * _e4109))) / _e4120))) / _e4131))) * 1f) / dist)))) - (a_minus * ((((select(_e4148, select(select(_e4155, _e4162, (_e4169 == 1u)), (_e4179 + (_e4186 * d_own)), (_e4195 == 2u)), is_boundary) + (0.39999998f * (_e4208 - ((0.5f * ((_e4217 * _e4226) + (_e4236 * _e4245))) / _e4258)))) * dot(((vec2<f32>(select(_e4271, select(select(_e4278, _e4285, (_e4292 == 1u)), (_e4302 + (_e4309 * d_own)), (_e4318 == 2u)), is_boundary), select(_e4330, select(select(_e4337, _e4344, (_e4351 == 1u)), (_e4361 + (_e4368 * d_own)), (_e4377 == 2u)), is_boundary)) * 1f) / vec2(select(_e4392, select(select(_e4399, _e4406, (_e4413 == 1u)), (_e4423 + (_e4430 * d_own)), (_e4439 == 2u)), is_boundary))), _e4446)) + -((_e4451 * dot((((((vec2<f32>(select(_e4459, select(select(_e4466, _e4473, (_e4480 == 1u)), (_e4490 + (_e4497 * d_own)), (_e4506 == 2u)), is_boundary), select(_e4518, select(select(_e4525, _e4532, (_e4539 == 1u)), (_e4549 + (_e4556 * d_own)), (_e4565 == 2u)), is_boundary)) * 1f) / vec2(select(_e4580, select(select(_e4587, _e4594, (_e4601 == 1u)), (_e4611 + (_e4618 * d_own)), (_e4627 == 2u)), is_boundary))) - ((vec2<f32>(_e4640, _e4647) * 1f) / vec2(_e4657))) * 1f) / vec2(dist)), ((((vec2<f32>(_e4671, _e4678) * 1f) / vec2(_e4688)) + ((vec2<f32>(select(_e4698, select(select(_e4705, _e4712, (_e4719 == 1u)), (_e4729 + (_e4736 * d_own)), (_e4745 == 2u)), is_boundary), select(_e4757, select(select(_e4764, _e4771, (_e4778 == 1u)), (_e4788 + (_e4795 * d_own)), (_e4804 == 2u)), is_boundary)) * 1f) / vec2(select(_e4819, select(select(_e4826, _e4833, (_e4840 == 1u)), (_e4850 + (_e4857 * d_own)), (_e4866 == 2u)), is_boundary)))) * 0.5f))))) + -(((((_e4882 * 3.5000002f) * (((0.39999998f * (_e4893 - ((0.5f * ((_e4902 * _e4911) + (_e4921 * _e4930))) / _e4943))) / select(_e4955, select(select(_e4962, _e4969, (_e4976 == 1u)), (_e4986 + (_e4993 * d_own)), (_e5002 == 2u)), is_boundary)) - ((0.39999998f * (_e5014 - ((0.5f * ((_e5021 * _e5028) + (_e5036 * _e5043))) / _e5054))) / _e5065))) * 1f) / dist))))) + ((a_plus * a_minus) * (select(_e5084, select(select(_e5091, _e5098, (_e5105 == 1u)), (_e5115 + (_e5122 * d_own)), (_e5131 == 2u)), is_boundary) - _e5142))) / denom) * area);
    return;
}
"#;
    }
