...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k = 0u; k < 4u; k++) {
        ...
        grad_acc_0 += normal_vec * (state[idx * 22u + 0u] * lambda + select(state[other_idx * 22u + 0u], select(select(state[idx * 22u + 0u], bc_value[face_idx * 4u + 0u], bc_kind[face_idx * 4u + 0u] == 1u), state[idx * 22u + 0u] + bc_value[face_idx * 4u + 0u] * d_own, bc_kind[face_idx * 4u + 0u] == 2u), is_boundary) * lambda_other) * area;
        grad_acc_1 += normal_vec * (state[idx * 22u + 1u] * lambda + select(state[other_idx * 22u + 1u], select(select(state[idx * 22u + 1u], bc_value[face_idx * 4u + 1u], bc_kind[face_idx * 4u + 1u] == 1u), state[idx * 22u + 1u] + bc_value[face_idx * 4u + 1u] * d_own, bc_kind[face_idx * 4u + 1u] == 2u), is_boundary) * lambda_other) * area;
        grad_acc_2 += normal_vec * (state[idx * 22u + 2u] * lambda + select(state[other_idx * 22u + 2u], select(select(state[idx * 22u + 2u], bc_value[face_idx * 4u + 2u], bc_kind[face_idx * 4u + 2u] == 1u), state[idx * 22u + 2u] + bc_value[face_idx * 4u + 2u] * d_own, bc_kind[face_idx * 4u + 2u] == 2u), is_boundary) * lambda_other) * area;
        grad_acc_3 += normal_vec * (state[idx * 22u + 12u] * lambda + select(state[other_idx * 22u + 12u], select(select(state[idx * 22u + 12u], bc_value[face_idx * 4u + 3u], bc_kind[face_idx * 4u + 3u] == 1u), state[idx * 22u + 12u] + bc_value[face_idx * 4u + 3u] * d_own, bc_kind[face_idx * 4u + 3u] == 2u), is_boundary) * lambda_other) * area;
    }
    ...
    grad_state[idx * 22u + 12u].x = grad_out_3.x;
    grad_state[idx * 22u + 12u].y = grad_out_3.y;
}
