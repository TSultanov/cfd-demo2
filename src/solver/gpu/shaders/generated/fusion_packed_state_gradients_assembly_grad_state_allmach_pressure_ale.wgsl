...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    k1_rhs_0 += k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_ale_vol_ratio_n * state_old[idx * 14u + 0u]);
    if (constants.time_scheme == 1u) {
        ...
        k1_rhs_0 = k1_rhs_0 - k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_ale_vol_ratio_n * state_old[idx * 14u + 0u]) + k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_factor_n * (k1_ale_vol_ratio_n * state_old[idx * 14u + 0u]) - k1_factor_nm1 * (k1_ale_vol_ratio_nm1 * state_old_old[idx * 14u + 0u]));
    }
    ...
    k1_rhs_1 += k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_ale_vol_ratio_n * state_old[idx * 14u + 1u]);
    if (constants.time_scheme == 1u) {
        let k1_r = constants.dt / constants.dt_old;
        let k1_diag_bdf2 = k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_r * 2.0 + 1.0) / (k1_r + 1.0);
        let k1_factor_n = k1_r + 1.0;
        ...
        k1_rhs_1 = k1_rhs_1 - k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_ale_vol_ratio_n * state_old[idx * 14u + 1u]) + k1_vol * state[idx * 14u + 11u] / select(constants.dt, state[idx * 14u + 10u], state[idx * 14u + 10u] > 0.0) * (k1_factor_n * (k1_ale_vol_ratio_n * state_old[idx * 14u + 1u]) - k1_factor_nm1 * (k1_ale_vol_ratio_nm1 * state_old_old[idx * 14u + 1u]));
    }
    if (constants.dtau > 0.0) {
    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        var k1_phi_0: f32 = fluxes[k1_face_idx * 3u + 0u] - (state[k1_other_idx * 14u + 11u] + k1_lambda_f * (state[idx * 14u + 11u] - state[k1_other_idx * 14u + 11u])) * mesh_fluxes[k1_face_idx];
        if (k1_owner != idx) {
        ...
        var k1_phi_1: f32 = fluxes[k1_face_idx * 3u + 1u] - (state[k1_other_idx * 14u + 11u] + k1_lambda_f * (state[idx * 14u + 11u] - state[k1_other_idx * 14u + 11u])) * mesh_fluxes[k1_face_idx];
        if (k1_owner != idx) {
        ...
        var k1_phi_2: f32 = fluxes[k1_face_idx * 3u + 2u] - (state[k1_other_idx * 14u + 11u] + k1_lambda_f * (state[idx * 14u + 11u] - state[k1_other_idx * 14u + 11u])) * mesh_fluxes[k1_face_idx];
        if (k1_owner != idx) {
    ...
    k1_bounded_sum_phi_0 += state[idx * 14u + 11u] * k1_ale_dvdt_ddt;
    k1_diag_0 -= k1_bounded_sum_phi_0;
    k1_bounded_sum_phi_1 += state[idx * 14u + 11u] * k1_ale_dvdt_ddt;
    k1_diag_1 -= k1_bounded_sum_phi_1;
    k1_rhs_2 -= state[idx * 14u + 11u] * k1_ale_dvdt_scl;
