...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let s_own_U_x = select(bc_neighbor_scalar(state[owner * 8u + 0u], state[owner * 8u + 0u], bc_kind[idx * 3u + 0u], bc_value[idx * 3u + 0u], d_own, is_boundary), state[owner * 8u + 0u] - (state[owner * 8u + 0u] * normal_vec.x + state[owner * 8u + 1u] * normal_vec.y) * normal_vec.x, is_boundary && (boundary_type == 3u || boundary_type == 4u));
    let s_own_U_y = select(bc_neighbor_scalar(state[owner * 8u + 1u], state[owner * 8u + 1u], bc_kind[idx * 3u + 1u], bc_value[idx * 3u + 1u], d_own, is_boundary), state[owner * 8u + 1u] - (state[owner * 8u + 0u] * normal_vec.x + state[owner * 8u + 1u] * normal_vec.y) * normal_vec.y, is_boundary && (boundary_type == 3u || boundary_type == 4u));
    ...
    let s_neigh_U_x = select(bc_neighbor_scalar(state[neigh_idx * 8u + 0u], state[owner * 8u + 0u], bc_kind[idx * 3u + 0u], bc_value[idx * 3u + 0u], d_own, is_boundary), state[owner * 8u + 0u] - (state[owner * 8u + 0u] * normal_vec.x + state[owner * 8u + 1u] * normal_vec.y) * normal_vec.x, is_boundary && (boundary_type == 3u || boundary_type == 4u));
    let s_neigh_U_y = select(bc_neighbor_scalar(state[neigh_idx * 8u + 1u], state[owner * 8u + 1u], bc_kind[idx * 3u + 1u], bc_value[idx * 3u + 1u], d_own, is_boundary), state[owner * 8u + 1u] - (state[owner * 8u + 0u] * normal_vec.x + state[owner * 8u + 1u] * normal_vec.y) * normal_vec.y, is_boundary && (boundary_type == 3u || boundary_type == 4u));
