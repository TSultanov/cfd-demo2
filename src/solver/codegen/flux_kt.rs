...
use crate::solver::ir::{EosSpec, FluxLayout, StateLayout};
use crate::solver::scheme::Scheme;

pub fn generate_flux_kt_wgsl(
    layout: &StateLayout,
    ...
    module.push(Item::Comment(
        "GENERATED BY CFD2 CODEGEN (flux_kt)".to_string(),
    ));
...
fn main_body(layout: &StateLayout, flux_layout: &FluxLayout, eos: &EosSpec) -> Block {
    ...
    let gamma = eos
        .ideal_gas_gamma()
        .unwrap_or_else(|| panic!("flux_kt requires IdealGas EOS; got {eos:?}"));
