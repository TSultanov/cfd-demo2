...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    k1_diag_4 -= (-(state[idx * 26u + 0u] * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) + -(constants.eos_gauge_rho_ref * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)))) * k1_vol;
    k1_diag_5 -= (-(state[idx * 26u + 0u] * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) + -(constants.eos_gauge_rho_ref * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)))) * k1_vol;
    ...
    k1_rhs_6 += 0.5 * constants.eos_gm1 * constants.eos_gauge_rho_ref * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)) * dot(vec2<f32>(state[idx * 26u + 10u], state[idx * 26u + 11u]), vec2<f32>(state[idx * 26u + 10u], state[idx * 26u + 11u])) * k1_vol;
    ...
    k1_diag_7 -= (state[idx * 26u + 0u] * constants.eos_r * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)) + constants.eos_gauge_rho_ref * constants.eos_r * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) * k1_vol;
