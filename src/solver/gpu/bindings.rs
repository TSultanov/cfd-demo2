...
// SourceHash: 5a91101b639a3c09e695f6da4bf15517606d95ec52d885c60ee71e6297230dd6
        ...
        }
        {
            ...
            if !(_e1388) {
                ...
                if (boundary_type == 1u) {
                    ...
                    let _e1695 = normal.x;
                    let _e1698 = diag_01_;
                    diag_01_ = (_e1698 + ((a_l * _e1695) * area));
                    let _e1701 = normal.y;
                    let _e1704 = diag_02_;
                    diag_02_ = (_e1704 + ((a_l * _e1701) * area));
                    let _e1708 = diag_03_;
                    diag_03_ = (_e1708 + (0f * area));
                    let _e1720 = constants.inlet_velocity;
                    let _e1724 = diag_10_;
                    diag_10_ = (_e1724 + ((((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * _e1720)) * area));
                    let _e1730 = diag_11_;
                    diag_11_ = (_e1730 + ((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) * area));
                    let _e1735 = diag_12_;
                    diag_12_ = (_e1735 + (((a_l * A_l_12_) + 0f) * area));
                    let _e1743 = diag_13_;
                    diag_13_ = (_e1743 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                    let _e1754 = constants.inlet_velocity;
                    let _e1758 = diag_20_;
                    diag_20_ = (_e1758 + ((((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) + (((a_r * A_r_21_) + 0f) * _e1754)) * area));
                    let _e1763 = diag_21_;
                    diag_21_ = (_e1763 + (((a_l * A_l_21_) + 0f) * area));
                    let _e1769 = diag_22_;
                    diag_22_ = (_e1769 + ((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) * area));
                    let _e1777 = diag_23_;
                    diag_23_ = (_e1777 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                    let _e1788 = constants.inlet_velocity;
                    let _e1792 = diag_30_;
                    diag_30_ = (_e1792 + ((((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) + (((a_r * A_r_31_) + d_e_visc_r_ru) * _e1788)) * area));
                    let _e1797 = diag_31_;
                    diag_31_ = (_e1797 + (((a_l * A_l_31_) + d_e_visc_l_ru) * area));
                    let _e1802 = diag_32_;
                    diag_32_ = (_e1802 + (((a_l * A_l_32_) + d_e_visc_l_rv) * area));
                    let _e1812 = diag_33_;
                    diag_33_ = (_e1812 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                } else {
                    if (boundary_type == 3u) {
                        let _e1817 = normal.x;
                        let _e1821 = normal.x;
                        let r11_ = (1f - ((2f * _e1817) * _e1821));
                        let _e1826 = normal.x;
                        let _e1830 = normal.y;
                        let r12_ = ((-2f * _e1826) * _e1830);
                        let _e1833 = normal.y;
                        let _e1837 = normal.x;
                        let r21_ = ((-2f * _e1833) * _e1837);
                        let _e1840 = normal.y;
                        let _e1844 = normal.y;
                        let r22_ = (1f - ((2f * _e1840) * _e1844));
                        let _e1852 = diag_00_;
                        diag_00_ = (_e1852 + (((0f - a_prod_scaled) + a_prod_scaled) * area));
                        let _e1855 = normal.x;
                        let _e1858 = normal.x;
                        let _e1863 = normal.y;
                        let _e1868 = diag_01_;
                        diag_01_ = (_e1868 + ((((a_l * _e1855) + ((a_r * _e1858) * r11_)) + ((a_r * _e1863) * r21_)) * area));
                        let _e1871 = normal.y;
                        let _e1874 = normal.x;
                        let _e1879 = normal.y;
                        let _e1884 = diag_02_;
                        diag_02_ = (_e1884 + ((((a_l * _e1871) + ((a_r * _e1874) * r12_)) + ((a_r * _e1879) * r22_)) * area));
                        let _e1888 = diag_03_;
                        diag_03_ = (_e1888 + (0f * area));
                        let _e1896 = diag_10_;
                        diag_10_ = (_e1896 + (((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) * area));
                        let _e1911 = diag_11_;
                        diag_11_ = (_e1911 + ((((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * r11_)) + (((a_r * A_r_12_) + 0f) * r21_)) * area));
                        let _e1925 = diag_12_;
                        diag_12_ = (_e1925 + (((((a_l * A_l_12_) + 0f) + ((((a_r * A_r_11_) + a_prod_scaled) + d_diff_x_r_ru) * r12_)) + (((a_r * A_r_12_) + 0f) * r22_)) * area));
                        let _e1933 = diag_13_;
                        diag_13_ = (_e1933 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                        let _e1941 = diag_20_;
                        diag_20_ = (_e1941 + (((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) * area));
                        let _e1955 = diag_21_;
                        diag_21_ = (_e1955 + (((((a_l * A_l_21_) + 0f) + (((a_r * A_r_21_) + 0f) * r11_)) + ((((a_r * A_r_22_) + a_prod_scaled) + d_diff_y_r_rv) * r21_)) * area));
                        let _e1970 = diag_22_;
                        diag_22_ = (_e1970 + ((((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) + (((a_r * A_r_21_) + 0f) * r12_)) + ((((a_r * A_r_22_) + a_prod_scaled) + d_diff_y_r_rv) * r22_)) * area));
                        let _e1978 = diag_23_;
                        diag_23_ = (_e1978 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                        let _e1986 = diag_30_;
                        diag_30_ = (_e1986 + (((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) * area));
                        let _e1999 = diag_31_;
                        diag_31_ = (_e1999 + (((((a_l * A_l_31_) + d_e_visc_l_ru) + (((a_r * A_r_31_) + d_e_visc_r_ru) * r11_)) + (((a_r * A_r_32_) + d_e_visc_r_rv) * r21_)) * area));
                        let _e2012 = diag_32_;
                        diag_32_ = (_e2012 + (((((a_l * A_l_32_) + d_e_visc_l_rv) + (((a_r * A_r_31_) + d_e_visc_r_ru) * r12_)) + (((a_r * A_r_32_) + d_e_visc_r_rv) * r22_)) * area));
                        let _e2022 = diag_33_;
                        diag_33_ = (_e2022 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                    } else {
                        let _e2028 = diag_00_;
                        diag_00_ = (_e2028 + (((0f - a_prod_scaled) + a_prod_scaled) * area));
                        let _e2031 = normal.x;
                        let _e2034 = normal.x;
                        let _e2038 = diag_01_;
                        diag_01_ = (_e2038 + (((a_l * _e2031) + (a_r * _e2034)) * area));
                        let _e2041 = normal.y;
                        let _e2044 = normal.y;
                        let _e2048 = diag_02_;
                        diag_02_ = (_e2048 + (((a_l * _e2041) + (a_r * _e2044)) * area));
                        let _e2052 = diag_03_;
                        diag_03_ = (_e2052 + (0f * area));
                        let _e2060 = diag_10_;
                        diag_10_ = (_e2060 + (((((a_l * A_l_10_) + d_diff_x_l_rho) + (a_r * A_r_10_)) + d_diff_x_r_rho) * area));
                        let _e2070 = diag_11_;
                        diag_11_ = (_e2070 + (((((((a_l * A_l_11_) - a_prod_scaled) + d_diff_x_l_ru) + (a_r * A_r_11_)) + a_prod_scaled) + d_diff_x_r_ru) * area));
                        let _e2078 = diag_12_;
                        diag_12_ = (_e2078 + (((((a_l * A_l_12_) + 0f) + (a_r * A_r_12_)) + 0f) * area));
                        let _e2086 = diag_13_;
                        diag_13_ = (_e2086 + (((((a_l * A_l_13_) + 0f) + (a_r * A_r_13_)) + 0f) * area));
                        let _e2094 = diag_20_;
                        diag_20_ = (_e2094 + (((((a_l * A_l_20_) + d_diff_y_l_rho) + (a_r * A_r_20_)) + d_diff_y_r_rho) * area));
                        let _e2102 = diag_21_;
                        diag_21_ = (_e2102 + (((((a_l * A_l_21_) + 0f) + (a_r * A_r_21_)) + 0f) * area));
                        let _e2112 = diag_22_;
                        diag_22_ = (_e2112 + (((((((a_l * A_l_22_) - a_prod_scaled) + d_diff_y_l_rv) + (a_r * A_r_22_)) + a_prod_scaled) + d_diff_y_r_rv) * area));
                        let _e2120 = diag_23_;
                        diag_23_ = (_e2120 + (((((a_l * A_l_23_) + 0f) + (a_r * A_r_23_)) + 0f) * area));
                        let _e2128 = diag_30_;
                        diag_30_ = (_e2128 + (((((a_l * A_l_30_) + d_e_visc_l_rho) + (a_r * A_r_30_)) + d_e_visc_r_rho) * area));
                        let _e2136 = diag_31_;
                        diag_31_ = (_e2136 + (((((a_l * A_l_31_) + d_e_visc_l_ru) + (a_r * A_r_31_)) + d_e_visc_r_ru) * area));
                        let _e2144 = diag_32_;
                        diag_32_ = (_e2144 + (((((a_l * A_l_32_) + d_e_visc_l_rv) + (a_r * A_r_32_)) + d_e_visc_r_rv) * area));
                        let _e2154 = diag_33_;
                        diag_33_ = (_e2154 + (((((((a_l * A_l_33_) - a_prod_scaled) + d_e_visc_l_re) + (a_r * A_r_33_)) + a_prod_scaled) + d_e_visc_r_re) * area));
                    }
                }
            }
        }
        continuing {
            let _e2157 = face_offset;
            face_offset = (_e2157 + 1u);
        }
    }
    let _e2159 = rhs_time_rho;
    let _e2160 = rhs_pseudo_rho;
    let _e2162 = coeff_time;
    let _e2163 = coeff_pseudo;
    let _e2167 = sum_rho;
    rhs_rho = (((_e2159 + _e2160) - ((_e2162 + _e2163) * rho)) - _e2167);
    let _e2170 = rhs_time_rho_u_x;
    let _e2171 = rhs_pseudo_rho_u_x;
    let _e2173 = coeff_time;
    let _e2174 = coeff_pseudo;
    let _e2179 = sum_rho_u_x;
    rhs_rho_u_x = (((_e2170 + _e2171) - ((_e2173 + _e2174) * rho_u.x)) - _e2179);
    let _e2182 = rhs_time_rho_u_y;
    let _e2183 = rhs_pseudo_rho_u_y;
    let _e2185 = coeff_time;
    let _e2186 = coeff_pseudo;
    let _e2191 = sum_rho_u_y;
    rhs_rho_u_y = (((_e2182 + _e2183) - ((_e2185 + _e2186) * rho_u.y)) - _e2191);
    let _e2194 = rhs_time_rho_e;
    let _e2195 = rhs_pseudo_rho_e;
    let _e2197 = coeff_time;
    let _e2198 = coeff_pseudo;
    let _e2202 = sum_rho_e;
    rhs_rho_e = (((_e2194 + _e2195) - ((_e2197 + _e2198) * rho_e)) - _e2202);
    let _e2205 = coeff_time;
    let _e2206 = diag_00_;
    diag_00_ = (_e2206 + _e2205);
    let _e2208 = coeff_time;
    let _e2209 = diag_11_;
    diag_11_ = (_e2209 + _e2208);
    let _e2211 = coeff_time;
    let _e2212 = diag_22_;
    diag_22_ = (_e2212 + _e2211);
    let _e2214 = coeff_time;
    let _e2215 = diag_33_;
    diag_33_ = (_e2215 + _e2214);
    let _e2217 = coeff_pseudo;
    let _e2218 = diag_00_;
    diag_00_ = (_e2218 + _e2217);
    let _e2220 = coeff_pseudo;
    let _e2221 = diag_11_;
    diag_11_ = (_e2221 + _e2220);
    let _e2223 = coeff_pseudo;
    let _e2224 = diag_22_;
    diag_22_ = (_e2224 + _e2223);
    let _e2226 = coeff_pseudo;
    let _e2227 = diag_33_;
    diag_33_ = (_e2227 + _e2226);
    let scalar_diag_idx = diagonal_indices[idx];
    let diag_rank = (scalar_diag_idx - scalar_offset);
    let _e2240 = diag_00_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 0u)] = _e2240;
    let _e2248 = diag_01_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 1u)] = _e2248;
    let _e2256 = diag_02_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 2u)] = _e2256;
    let _e2264 = diag_03_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 3u)] = _e2264;
    let _e2272 = diag_10_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 0u)] = _e2272;
    let _e2280 = diag_11_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 1u)] = _e2280;
    let _e2288 = diag_12_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 2u)] = _e2288;
    let _e2296 = diag_13_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 3u)] = _e2296;
    let _e2304 = diag_20_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 0u)] = _e2304;
    let _e2312 = diag_21_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 1u)] = _e2312;
    let _e2320 = diag_22_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 2u)] = _e2320;
    let _e2328 = diag_23_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 3u)] = _e2328;
    let _e2336 = diag_30_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 0u)] = _e2336;
    let _e2344 = diag_31_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 1u)] = _e2344;
    let _e2352 = diag_32_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 2u)] = _e2352;
    let _e2360 = diag_33_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 3u)] = _e2360;
    let _e2367 = rhs_rho;
    rhs[((idx * 4u) + 0u)] = _e2367;
    let _e2374 = rhs_rho_u_x;
    rhs[((idx * 4u) + 1u)] = _e2374;
    let _e2381 = rhs_rho_u_y;
    rhs[((idx * 4u) + 2u)] = _e2381;
    let _e2388 = rhs_rho_e;
    rhs[((idx * 4u) + 3u)] = _e2388;
    return;
}
"#;
    }
