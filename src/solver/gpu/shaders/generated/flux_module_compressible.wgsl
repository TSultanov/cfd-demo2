...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    var phi_0: f32 = _cse_0 * s_own_rho + _cse_30 * s_neigh_rho;
    ...
    if (constants.scheme == 1u && !is_boundary) {
        ...
        phi_0 = _cse_64 * _cse_76 + _cse_123 * _cse_104;
    ...
    if (constants.scheme == 2u && !is_boundary) {
        ...
        let _cse_131 = _cse_132 * 1.0 / (s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho);
        let _cse_130 = dot(_cse_131, normal_vec * area);
        let _cse_152 = constants.eos_gamma * constants.eos_r * s_own_T;
        let _cse_151 = sqrt(_cse_152);
        let _cse_156 = constants.eos_gamma * constants.eos_r * s_neigh_T;
        let _cse_155 = sqrt(_cse_156);
        let _cse_158 = dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y) * 0.5 * constants.eos_gamma * constants.eos_r / max(_cse_151, 0.000000000001), c_neigh_cell_vec - c_owner_vec);
        let _cse_157 = _cse_158 * 0.125;
        let _cse_154 = _cse_151 * 0.625 + _cse_155 * 0.375 + _cse_157;
        let _cse_153 = _cse_154 - _cse_151;
        let _cse_150 = _cse_151 + _cse_153;
        let _cse_149 = _cse_150 * area;
        let _cse_148 = _cse_130 + _cse_149;
        let _cse_166 = _cse_138 * 0.625 + _cse_134 * 0.375;
        let _cse_165 = _cse_166 + dot(vec2<f32>(select(s_neigh_grad_rho_u_x_x, 0.0, is_boundary), select(s_neigh_grad_rho_u_x_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125;
        let _cse_164 = _cse_165 - _cse_138;
        let _cse_163 = _cse_138 + _cse_164;
        ...
        let _cse_162 = vec2<f32>(_cse_163, _cse_167);
        ...
        let _cse_161 = _cse_162 * _cse_170;
        let _cse_160 = dot(_cse_161, normal_vec * area);
        let _cse_180 = vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)) * 0.5 * constants.eos_gamma * constants.eos_r / max(_cse_155, 0.000000000001);
        let _cse_179 = dot(_cse_180, c_owner_vec - c_neigh_cell_vec);
        let _cse_178 = _cse_179 * 0.125;
        let _cse_177 = _cse_155 * 0.625 + _cse_151 * 0.375 + _cse_178;
        let _cse_176 = _cse_177 - _cse_155;
        let _cse_175 = _cse_155 + _cse_176;
        let _cse_174 = _cse_175 * area;
        let _cse_159 = _cse_160 + _cse_174;
        let _cse_147 = max(_cse_148, _cse_159);
        let _cse_146 = max(_cse_147, 0.0);
        let _cse_185 = _cse_130 - _cse_149;
        let _cse_186 = _cse_160 - _cse_174;
        let _cse_184 = min(_cse_185, _cse_186);
        let _cse_183 = min(_cse_184, 0.0);
        let _cse_182 = _cse_146 - _cse_183;
        let _cse_181 = max(_cse_182, 0.000001);
        let _cse_145 = _cse_146 / _cse_181;
        let _cse_129 = _cse_130 * _cse_145;
        let _cse_187 = _cse_183 * _cse_145;
        let _cse_128 = _cse_129 - _cse_187;
        let _cse_190 = 1.0 - _cse_145;
        let _cse_189 = _cse_160 * _cse_190;
        let _cse_188 = _cse_189 + _cse_187;
        let _cse_191 = _cse_145 * (s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) * constants.eos_r * (s_own_T + s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) + _cse_190 * _cse_171 * constants.eos_r * (s_neigh_T + s_neigh_T * 0.625 + s_own_T * 0.375 + dot(vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_T);
        phi_0 = _cse_128 * (s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) + _cse_188 * _cse_171;
        phi_1 = _cse_128 * _cse_132.x + _cse_188 * _cse_162.x + _cse_191 * area * normal_vec.x - (constants.viscosity * ((2.0 * select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + (select(s_neigh_grad_u_x_y, 0.0, is_boundary) + select(s_neigh_grad_u_y_x, 0.0, is_boundary)) * normal_vec.y) * lambda + constants.viscosity * ((2.0 * s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + (s_own_grad_u_x_y + s_own_grad_u_y_x) * normal_vec.y) * lambda_other) * area;
        phi_2 = _cse_128 * _cse_132.y + _cse_188 * _cse_162.y + _cse_191 * area * normal_vec.y - (constants.viscosity * ((select(s_neigh_grad_u_x_y, 0.0, is_boundary) + select(s_neigh_grad_u_y_x, 0.0, is_boundary)) * normal_vec.x + (2.0 * select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_y + s_own_grad_u_y_x) * normal_vec.x + (2.0 * s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other) * area;
        phi_3 = _cse_128 * ((s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) * constants.eos_r * (s_own_T + s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) / max(constants.eos_gm1, 0.000000000001) + 0.5 * (s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) * dot(_cse_131, _cse_131) + (s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) * constants.eos_r * (s_own_T + s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T)) + _cse_188 * (_cse_171 * constants.eos_r * (s_neigh_T + s_neigh_T * 0.625 + s_own_T * 0.375 + dot(vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_T) / max(constants.eos_gm1, 0.000000000001) + 0.5 * _cse_171 * dot(_cse_161, _cse_161) + _cse_171 * constants.eos_r * (s_neigh_T + s_neigh_T * 0.625 + s_own_T * 0.375 + dot(vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_T)) + _cse_187 * ((s_own_rho + s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho) * constants.eos_r * (s_own_T + s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) - _cse_171 * constants.eos_r * (s_neigh_T + s_neigh_T * 0.625 + s_own_T * 0.375 + dot(vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_T)) - dot(vec2<f32>(dot(vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_x - state[owner * 22u + 10u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other)), normal_vec), dot(vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_y - state[owner * 22u + 11u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other)), normal_vec)) * constants.viscosity + vec2<f32>(constants.viscosity * ((2.0 * select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + (select(s_neigh_grad_u_x_y, 0.0, is_boundary) + select(s_neigh_grad_u_y_x, 0.0, is_boundary)) * normal_vec.y) * lambda + constants.viscosity * ((2.0 * s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + (s_own_grad_u_x_y + s_own_grad_u_y_x) * normal_vec.y) * lambda_other, constants.viscosity * ((select(s_neigh_grad_u_x_y, 0.0, is_boundary) + select(s_neigh_grad_u_y_x, 0.0, is_boundary)) * normal_vec.x + (2.0 * select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_y + s_own_grad_u_y_x) * normal_vec.x + (2.0 * s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other), _cse_131 * _cse_145 + _cse_161 * _cse_190) * area;
        phi_4 = 0.0;
        phi_5 = 0.0;
        phi_6 = 0.0;
        phi_7 = 0.0;
    ...
    if (constants.scheme == 3u && !is_boundary) {
        ...
        phi_0 = _cse_192 * _cse_209 + _cse_252 * _cse_236;
    ...
    if (constants.scheme == 4u && !is_boundary) {
        ...
        phi_0 = _cse_256 * (s_own_rho + (max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y)) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)) + abs(max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y)) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)))) / (1.0 + abs(max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y)) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)))) * lambda_other * (s_neigh_rho - s_own_rho)) + _cse_318 * (s_neigh_rho - (max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary))) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)) + abs(max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary))) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)))) / (1.0 + abs(max(-2001.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary))) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1999.0)))) * lambda * (s_neigh_rho - s_own_rho));
    ...
    if (constants.scheme == 5u && !is_boundary) {
        ...
        phi_0 = _cse_320 * (s_own_rho + min(max(s_own_rho * 0.625 + s_neigh_rho * 0.375 + dot(vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_rho, min(s_neigh_rho - s_own_rho, 0.0)), max(s_neigh_rho - s_own_rho, 0.0))) + _cse_380 * _cse_365;
    ...
    if (constants.scheme == 6u && !is_boundary) {
        ...
        let _cse_411 = max((_cse_410 - _cse_405) * _cse_408, 0.0) / max(abs((_cse_410 - _cse_405) * _cse_408), 0.00000001);
        let _cse_406 = _cse_407 * _cse_411;
        let _cse_404 = _cse_405 + _cse_406;
        let _cse_403 = _cse_404 * area;
        let _cse_402 = _cse_386 + _cse_403;
        let _cse_420 = _cse_393 * 0.625 + _cse_390 * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_u_x_x, 0.0, is_boundary), select(s_neigh_grad_rho_u_x_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125;
        let _cse_419 = _cse_420 - _cse_393;
        let _cse_418 = _cse_419 * abs(_cse_390 - _cse_393) / max(abs(_cse_390 - _cse_393), abs(_cse_419) + 0.00000001);
        let _cse_421 = max((_cse_390 - _cse_393) * _cse_419, 0.0) / max(abs((_cse_390 - _cse_393) * _cse_419), 0.00000001);
        let _cse_417 = _cse_418 * _cse_421;
        let _cse_416 = _cse_393 + _cse_417;
        let _cse_426 = _cse_398 * 0.625 + _cse_395 * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_u_y_x, 0.0, is_boundary), select(s_neigh_grad_rho_u_y_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125;
        let _cse_425 = _cse_426 - _cse_398;
        let _cse_424 = _cse_425 * abs(_cse_395 - _cse_398) / max(abs(_cse_395 - _cse_398), abs(_cse_425) + 0.00000001);
        let _cse_427 = max((_cse_395 - _cse_398) * _cse_425, 0.0) / max(abs((_cse_395 - _cse_398) * _cse_425), 0.00000001);
        let _cse_423 = _cse_424 * _cse_427;
        let _cse_422 = _cse_398 + _cse_423;
        let _cse_415 = vec2<f32>(_cse_416, _cse_422);
        let _cse_428 = s_neigh_rho + (s_neigh_rho * 0.625 + s_own_rho * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_rho) * abs(s_own_rho - s_neigh_rho) / max(abs(s_own_rho - s_neigh_rho), abs(s_neigh_rho * 0.625 + s_own_rho * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_rho) + 0.00000001) * max((s_own_rho - s_neigh_rho) * (s_neigh_rho * 0.625 + s_own_rho * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_rho), 0.0) / max(abs((s_own_rho - s_neigh_rho) * (s_neigh_rho * 0.625 + s_own_rho * 0.375 + dot(vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary)), c_owner_vec - c_neigh_cell_vec) * 0.125 - s_neigh_rho)), 0.00000001);
        let _cse_414 = _cse_415 * 1.0 / _cse_428;
        let _cse_413 = dot(_cse_414, normal_vec * area);
        ...
        let _cse_412 = _cse_413 + _cse_429;
        let _cse_401 = max(_cse_402, _cse_412);
        let _cse_400 = max(_cse_401, 0.0);
        let _cse_441 = _cse_386 - _cse_403;
        let _cse_442 = _cse_413 - _cse_429;
