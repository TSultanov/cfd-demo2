...
pub fn generate_flux_module_wgsl(
    ...
    module.extend(base_items(flux_spec_uses_low_mach(spec), eos_params));
...
fn base_items(include_low_mach_params: bool, eos_params: &[ParamSpec]) -> Vec<Item> {
...
fn main_fn(
    ...
    Function::new(
        ...
        main_body(resolver, flux_layout, flux_stride, primitives, spec),
    )
}
