    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        if (!k1_is_boundary) {
            ...
            if (k1_boundary_type == 4u) {
                matrix_values[k1_start_row_1 + k1_diag_rank * 8u + 4u] += k1_diff_coeff_rho_u;
                k1_rhs_1 += k1_diff_coeff_rho_u * (state[idx * 22u + 10u] - (state[idx * 22u + 10u] * k1_normal.x + state[idx * 22u + 11u] * k1_normal.y) * k1_normal.x);
            } else {
        ...
        if (!k1_is_boundary) {
            ...
            if (k1_boundary_type == 4u) {
                matrix_values[k1_start_row_2 + k1_diag_rank * 8u + 5u] += k1_diff_coeff_rho_u;
                k1_rhs_2 += k1_diff_coeff_rho_u * (state[idx * 22u + 11u] - (state[idx * 22u + 10u] * k1_normal.x + state[idx * 22u + 11u] * k1_normal.y) * k1_normal.y);
            } else {
