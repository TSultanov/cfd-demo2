...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    matrix_values[start_row_0 + diag_rank * 4u + 0u] = 0.0;
    matrix_values[start_row_0 + diag_rank * 4u + 1u] = 0.0;
    matrix_values[start_row_0 + diag_rank * 4u + 2u] = 0.0;
    matrix_values[start_row_0 + diag_rank * 4u + 3u] = 0.0;
    matrix_values[start_row_1 + diag_rank * 4u + 0u] = 0.0;
    matrix_values[start_row_1 + diag_rank * 4u + 1u] = 0.0;
    matrix_values[start_row_1 + diag_rank * 4u + 2u] = 0.0;
    matrix_values[start_row_1 + diag_rank * 4u + 3u] = 0.0;
    matrix_values[start_row_2 + diag_rank * 4u + 0u] = 0.0;
    matrix_values[start_row_2 + diag_rank * 4u + 1u] = 0.0;
    matrix_values[start_row_2 + diag_rank * 4u + 2u] = 0.0;
    matrix_values[start_row_2 + diag_rank * 4u + 3u] = 0.0;
    matrix_values[start_row_3 + diag_rank * 4u + 0u] = 0.0;
    matrix_values[start_row_3 + diag_rank * 4u + 1u] = 0.0;
    matrix_values[start_row_3 + diag_rank * 4u + 2u] = 0.0;
    matrix_values[start_row_3 + diag_rank * 4u + 3u] = 0.0;
    ...
    for (var face_offset = start; face_offset < end; face_offset++) {
        ...
        if (is_boundary) {
            ...
            rho_r = select(rho_l, bc_rho, bc_kind[bc_idx_rho] == 1u);
            let rho_u_r_x = select(rho_u_l.x, bc_rho_u_x, bc_kind[bc_idx_rho_u_x] == 1u);
            let rho_u_r_y = select(rho_u_l.y, bc_rho_u_y, bc_kind[bc_idx_rho_u_y] == 1u);
            rho_u_r = vec2<f32>(rho_u_r_x, rho_u_r_y);
            rho_e_r = select(rho_e_l, bc_rho_e, bc_kind[bc_idx_rho_e] == 1u);
        }
        ...
        if (!is_boundary) {
            ...
            matrix_values[start_row_0 + neighbor_rank * 4u + 0u] = 0.0;
            matrix_values[start_row_0 + neighbor_rank * 4u + 1u] = 0.0;
            matrix_values[start_row_0 + neighbor_rank * 4u + 2u] = 0.0;
            matrix_values[start_row_0 + neighbor_rank * 4u + 3u] = 0.0;
            matrix_values[start_row_1 + neighbor_rank * 4u + 0u] = 0.0;
            matrix_values[start_row_1 + neighbor_rank * 4u + 1u] = 0.0;
            matrix_values[start_row_1 + neighbor_rank * 4u + 2u] = 0.0;
            matrix_values[start_row_1 + neighbor_rank * 4u + 3u] = 0.0;
            matrix_values[start_row_2 + neighbor_rank * 4u + 0u] = 0.0;
            matrix_values[start_row_2 + neighbor_rank * 4u + 1u] = 0.0;
            matrix_values[start_row_2 + neighbor_rank * 4u + 2u] = 0.0;
            matrix_values[start_row_2 + neighbor_rank * 4u + 3u] = 0.0;
            matrix_values[start_row_3 + neighbor_rank * 4u + 0u] = 0.0;
            matrix_values[start_row_3 + neighbor_rank * 4u + 1u] = 0.0;
            matrix_values[start_row_3 + neighbor_rank * 4u + 2u] = 0.0;
            matrix_values[start_row_3 + neighbor_rank * 4u + 3u] = 0.0;
            ...
            matrix_values[start_row_0 + diag_rank * 4u + 0u] += (0.0 - a_prod_scaled) * area;
            matrix_values[start_row_0 + diag_rank * 4u + 1u] += normal.x * a_l * area;
            matrix_values[start_row_0 + diag_rank * 4u + 2u] += normal.y * a_l * area;
            matrix_values[start_row_0 + diag_rank * 4u + 3u] += 0.0 * area;
            matrix_values[start_row_1 + diag_rank * 4u + 0u] += ((dp_drho_l * normal.x - u_l_x * u_n_l) * a_l + -u_l_x * inv_rho_l * mu_over_dist) * area;
            matrix_values[start_row_1 + diag_rank * 4u + 1u] += ((u_n_l + normal.x * (u_l_x + dp_dru_l)) * a_l + inv_rho_l * mu_over_dist - a_prod_scaled) * area;
            matrix_values[start_row_1 + diag_rank * 4u + 2u] += (u_l_x * normal.y + dp_drv_l * normal.x) * a_l * area;
            matrix_values[start_row_1 + diag_rank * 4u + 3u] += dp_dre_l * normal.x * a_l * area;
            matrix_values[start_row_2 + diag_rank * 4u + 0u] += ((dp_drho_l * normal.y - u_l_y * u_n_l) * a_l + -u_l_y * inv_rho_l * mu_over_dist) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 1u] += (u_l_y * normal.x + dp_dru_l * normal.y) * a_l * area;
            matrix_values[start_row_2 + diag_rank * 4u + 2u] += ((u_n_l + normal.y * (u_l_y + dp_drv_l)) * a_l + inv_rho_l * mu_over_dist - a_prod_scaled) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 3u] += dp_dre_l * normal.y * a_l * area;
            matrix_values[start_row_3 + diag_rank * 4u + 0u] += (u_n_l * (dp_drho_l - H_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).x) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 1u] += ((H_l * normal.x + dp_dru_l * u_n_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).y) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 2u] += ((H_l * normal.y + dp_drv_l * u_n_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).z) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 3u] += (1.4 * u_n_l * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).w - a_prod_scaled) * area;
        } else {
            matrix_values[start_row_0 + diag_rank * 4u + 0u] += (0.0 - a_prod_scaled + a_prod_scaled * select(1.0, 0.0, bc_kind[boundary_type * 4u + 0u] == 1u)) * area;
            matrix_values[start_row_0 + diag_rank * 4u + 1u] += (normal.x * a_l + normal.x * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 1u] == 1u)) * area;
            matrix_values[start_row_0 + diag_rank * 4u + 2u] += (normal.y * a_l + normal.y * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 2u] == 1u)) * area;
            matrix_values[start_row_0 + diag_rank * 4u + 3u] += 0.0 * area;
            matrix_values[start_row_1 + diag_rank * 4u + 0u] += ((dp_drho_l * normal.x - u_l_x * u_n_l) * a_l + -u_l_x * inv_rho_l * mu_over_dist + ((dp_drho_r * normal.x - u_r_x * u_n_r) * a_r + -u_r_x * inv_rho_r * -mu_over_dist) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 0u] == 1u)) * area;
            matrix_values[start_row_1 + diag_rank * 4u + 1u] += ((u_n_l + normal.x * (u_l_x + dp_dru_l)) * a_l + inv_rho_l * mu_over_dist - a_prod_scaled + ((u_n_r + normal.x * (u_r_x + dp_dru_r)) * a_r + inv_rho_r * -mu_over_dist + a_prod_scaled) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 1u] == 1u)) * area;
            matrix_values[start_row_1 + diag_rank * 4u + 2u] += ((u_l_x * normal.y + dp_drv_l * normal.x) * a_l + (u_r_x * normal.y + dp_drv_r * normal.x) * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 2u] == 1u)) * area;
            matrix_values[start_row_1 + diag_rank * 4u + 3u] += (dp_dre_l * normal.x * a_l + dp_dre_r * normal.x * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 3u] == 1u)) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 0u] += ((dp_drho_l * normal.y - u_l_y * u_n_l) * a_l + -u_l_y * inv_rho_l * mu_over_dist + ((dp_drho_r * normal.y - u_r_y * u_n_r) * a_r + -u_r_y * inv_rho_r * -mu_over_dist) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 0u] == 1u)) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 1u] += ((u_l_y * normal.x + dp_dru_l * normal.y) * a_l + (u_r_y * normal.x + dp_dru_r * normal.y) * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 1u] == 1u)) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 2u] += ((u_n_l + normal.y * (u_l_y + dp_drv_l)) * a_l + inv_rho_l * mu_over_dist - a_prod_scaled + ((u_n_r + normal.y * (u_r_y + dp_drv_r)) * a_r + inv_rho_r * -mu_over_dist + a_prod_scaled) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 2u] == 1u)) * area;
            matrix_values[start_row_2 + diag_rank * 4u + 3u] += (dp_dre_l * normal.y * a_l + dp_dre_r * normal.y * a_r * select(1.0, 0.0, bc_kind[boundary_type * 4u + 3u] == 1u)) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 0u] += (u_n_l * (dp_drho_l - H_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).x + (u_n_r * (dp_drho_r - H_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).x) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 0u] == 1u)) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 1u] += ((H_l * normal.x + dp_dru_l * u_n_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).y + ((H_r * normal.x + dp_dru_r * u_n_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).y) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 1u] == 1u)) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 2u] += ((H_l * normal.y + dp_drv_l * u_n_l) * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).z + ((H_r * normal.y + dp_drv_r * u_n_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).z) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 2u] == 1u)) * area;
            matrix_values[start_row_3 + diag_rank * 4u + 3u] += (1.4 * u_n_l * a_l + ((vec4<f32>(-u_l_x * inv_rho_l * mu_over_dist * u_face_vec.x + -u_l_y * inv_rho_l * mu_over_dist * u_face_vec.y, inv_rho_l * mu_over_dist * u_face_vec.x, inv_rho_l * mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_l_x * inv_rho_l * 0.5 * diff_u_vec.x + -u_l_y * inv_rho_l * 0.5 * diff_u_vec.y, inv_rho_l * 0.5 * diff_u_vec.x, inv_rho_l * 0.5 * diff_u_vec.y, 0.0))).w - a_prod_scaled + (1.4 * u_n_r * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).w + a_prod_scaled) * select(1.0, 0.0, bc_kind[boundary_type * 4u + 3u] == 1u)) * area;
        }
    }
    ...
    matrix_values[start_row_0 + diag_rank * 4u + 0u] += coeff_time;
    matrix_values[start_row_0 + diag_rank * 4u + 0u] += coeff_pseudo;
    matrix_values[start_row_1 + diag_rank * 4u + 1u] += coeff_time;
    matrix_values[start_row_1 + diag_rank * 4u + 1u] += coeff_pseudo;
    matrix_values[start_row_2 + diag_rank * 4u + 2u] += coeff_time;
    matrix_values[start_row_2 + diag_rank * 4u + 2u] += coeff_pseudo;
    matrix_values[start_row_3 + diag_rank * 4u + 3u] += coeff_time;
    matrix_values[start_row_3 + diag_rank * 4u + 3u] += coeff_pseudo;
