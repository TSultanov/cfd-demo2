...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let s_own_T = bc_neighbor_scalar(state[owner * 31u + 9u], state[owner * 31u + 9u], bc_kind[idx * 8u + 7u], bc_value[idx * 8u + 7u], d_own, is_boundary);
    let s_own_bih_mask = state[owner * 31u + 26u];
    ...
    let s_own_lap_rho = state[owner * 31u + 22u];
    let s_own_lap_rho_e = state[owner * 31u + 25u];
    let s_own_lap_rho_u_x = state[owner * 31u + 23u];
    let s_own_lap_rho_u_y = state[owner * 31u + 24u];
    let s_own_rho = bc_neighbor_scalar(state[owner * 31u + 0u], state[owner * 31u + 0u], bc_kind[idx * 8u + 0u], bc_value[idx * 8u + 0u], d_own, is_boundary);
    let s_own_rho_u_x = select(bc_neighbor_scalar(state[owner * 31u + 1u], state[owner * 31u + 1u], bc_kind[idx * 8u + 1u], bc_value[idx * 8u + 1u], d_own, is_boundary), state[owner * 31u + 1u] - (state[owner * 31u + 1u] * normal_vec.x + state[owner * 31u + 2u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
    let s_own_rho_u_y = select(bc_neighbor_scalar(state[owner * 31u + 2u], state[owner * 31u + 2u], bc_kind[idx * 8u + 2u], bc_value[idx * 8u + 2u], d_own, is_boundary), state[owner * 31u + 2u] - (state[owner * 31u + 1u] * normal_vec.x + state[owner * 31u + 2u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
    let s_own_u_x = select(bc_neighbor_scalar(state[owner * 31u + 10u], state[owner * 31u + 10u], bc_kind[idx * 8u + 4u], bc_value[idx * 8u + 4u], d_own, is_boundary), state[owner * 31u + 10u] - (state[owner * 31u + 10u] * normal_vec.x + state[owner * 31u + 11u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
    let s_own_u_y = select(bc_neighbor_scalar(state[owner * 31u + 11u], state[owner * 31u + 11u], bc_kind[idx * 8u + 5u], bc_value[idx * 8u + 5u], d_own, is_boundary), state[owner * 31u + 11u] - (state[owner * 31u + 10u] * normal_vec.x + state[owner * 31u + 11u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
    let s_neigh_T = bc_neighbor_scalar(state[neigh_idx * 31u + 9u], state[owner * 31u + 9u], bc_kind[idx * 8u + 7u], bc_value[idx * 8u + 7u], d_own, is_boundary);
    let s_neigh_bih_mask = select(state[neigh_idx * 31u + 26u], state[owner * 31u + 26u], is_boundary);
    ...
    let s_neigh_lap_rho = select(state[neigh_idx * 31u + 22u], state[owner * 31u + 22u], is_boundary);
    let s_neigh_lap_rho_e = select(state[neigh_idx * 31u + 25u], state[owner * 31u + 25u], is_boundary);
    let s_neigh_lap_rho_u_x = select(state[neigh_idx * 31u + 23u], state[owner * 31u + 23u], is_boundary);
    let s_neigh_lap_rho_u_y = select(state[neigh_idx * 31u + 24u], state[owner * 31u + 24u], is_boundary);
    let s_neigh_rho = bc_neighbor_scalar(state[neigh_idx * 31u + 0u], state[owner * 31u + 0u], bc_kind[idx * 8u + 0u], bc_value[idx * 8u + 0u], d_own, is_boundary);
    let s_neigh_rho_u_x = select(bc_neighbor_scalar(state[neigh_idx * 31u + 1u], state[owner * 31u + 1u], bc_kind[idx * 8u + 1u], bc_value[idx * 8u + 1u], d_own, is_boundary), state[owner * 31u + 1u] - (state[owner * 31u + 1u] * normal_vec.x + state[owner * 31u + 2u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
    let s_neigh_rho_u_y = select(bc_neighbor_scalar(state[neigh_idx * 31u + 2u], state[owner * 31u + 2u], bc_kind[idx * 8u + 2u], bc_value[idx * 8u + 2u], d_own, is_boundary), state[owner * 31u + 2u] - (state[owner * 31u + 1u] * normal_vec.x + state[owner * 31u + 2u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
    ...
    var phi_0: f32 = _cse_0 * s_own_rho + _cse_60 * s_neigh_rho + low_mach_params.pressure_coupling_alpha * (_cse_23 - _cse_46) * 0.5 * (1.0 / max(_cse_20, 0.000000000001) + 1.0 / max(_cse_43, 0.000000000001)) * _cse_16 * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
    var phi_1: f32 = _cse_0 * _cse_3.x + _cse_60 * _cse_32.x + _cse_63 * area * normal_vec.x - (constants.viscosity * ((select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + select(s_neigh_grad_u_y_x, 0.0, is_boundary) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + s_own_grad_u_y_x * normal_vec.y) * lambda_other) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_u_x - s_own_lap_rho_u_x) * s_own_bih_mask * s_neigh_bih_mask * area;
    var phi_2: f32 = _cse_0 * _cse_3.y + _cse_60 * _cse_32.y + _cse_63 * area * normal_vec.y - (constants.viscosity * (select(s_neigh_grad_u_x_y, 0.0, is_boundary) * normal_vec.x + (select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * (s_own_grad_u_x_y * normal_vec.x + (s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_u_y - s_own_lap_rho_u_y) * s_own_bih_mask * s_neigh_bih_mask * area;
    var phi_3: f32 = _cse_0 * (_cse_23 / max(constants.eos_gm1, 0.000000000001) + 0.5 * s_own_rho * _cse_26 + _cse_23) + _cse_60 * (_cse_46 / max(constants.eos_gm1, 0.000000000001) + 0.5 * s_neigh_rho * _cse_49 + _cse_46) + _cse_59 * (_cse_23 - _cse_46) - dot(vec2<f32>(dot(vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_x - state[owner * 31u + 10u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other)), normal_vec), dot(vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_y - state[owner * 31u + 11u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other)), normal_vec)) * constants.viscosity + vec2<f32>(constants.viscosity * ((select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + select(s_neigh_grad_u_y_x, 0.0, is_boundary) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + s_own_grad_u_y_x * normal_vec.y) * lambda_other, constants.viscosity * (select(s_neigh_grad_u_x_y, 0.0, is_boundary) * normal_vec.x + (select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * (s_own_grad_u_x_y * normal_vec.x + (s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other), _cse_2 * _cse_6 + _cse_31 * _cse_62) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_e - s_own_lap_rho_e) * s_own_bih_mask * s_neigh_bih_mask * area;
    var phi_4: f32 = 0.0;
    var phi_5: f32 = 0.0;
    var phi_6: f32 = 0.0;
    var phi_7: f32 = 0.0;
    if (constants.scheme == 1u && !is_boundary) {
        ...
        phi_0 = _cse_64 * _cse_68 + _cse_125 * _cse_97 + low_mach_params.pressure_coupling_alpha * (_cse_85 - _cse_111) * 0.5 * (1.0 / max(_cse_82, 0.000000000001) + 1.0 / max(_cse_108, 0.000000000001)) * min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
    ...
    if (constants.scheme == 2u && !is_boundary) {
        ...
        phi_0 = _cse_128 * _cse_132 + _cse_189 * _cse_160 + low_mach_params.pressure_coupling_alpha * (_cse_132 * constants.eos_r * (s_own_T + s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) - _cse_175) * 0.5 * (1.0 / max(_cse_147, 0.000000000001) + 1.0 / max(_cse_172, 0.000000000001)) * min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
    ...
    if (constants.scheme == 3u && !is_boundary) {
        let _cse_196 = vec2<f32>(s_neigh_rho_u_x, s_neigh_rho_u_y) - vec2<f32>(s_own_rho_u_x, s_own_rho_u_y);
        let _cse_197 = dot(_cse_196, _cse_196);
        let _cse_195 = _cse_196 * max(0.0, min(2.0 * dot(_cse_196, vec2<f32>(dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_u_x_x, s_own_grad_rho_u_x_y)), dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_u_y_x, s_own_grad_rho_u_y_y)))) * _cse_197 / (_cse_197 * _cse_197 + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other;
        let _cse_194 = vec2<f32>(s_own_rho_u_x, s_own_rho_u_y) + _cse_195;
        let _cse_200 = max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_rho_x, s_own_grad_rho_y)) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other;
        let _cse_199 = _cse_200 * (s_neigh_rho - s_own_rho);
        let _cse_198 = s_own_rho + _cse_199;
        let _cse_193 = _cse_194 * 1.0 / _cse_198;
        let _cse_214 = constants.eos_gamma * _cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) / _cse_198;
        let _cse_213 = _cse_214 + constants.eos_dp_drho;
        let _cse_215 = dot(_cse_193, _cse_193);
        let _cse_212 = max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0)) * _cse_213 + max(0.0, 1.0 - abs(f32(low_mach_params.model))) * min(_cse_215, _cse_213);
        let _cse_217 = min(max(_cse_215, low_mach_params.theta_floor * _cse_213), _cse_213);
        let _cse_216 = max(0.0, 1.0 - abs(f32(low_mach_params.model) - 1.0)) * _cse_217;
        let _cse_211 = _cse_212 + _cse_216;
        let _cse_210 = min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * _cse_211;
        let _cse_209 = _cse_210 + (1.0 - min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001)))) * _cse_213;
        let _cse_208 = _cse_209 / max(_cse_213, 0.000000000001);
        let _cse_207 = sqrt(_cse_208);
        let _cse_206 = (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y) * 0.5 * constants.eos_gamma * constants.eos_r / max(sqrt(constants.eos_gamma * constants.eos_r * s_own_T), 0.000000000001)) * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) / ((sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T))) * _cse_207;
        let _cse_205 = _cse_206 * area;
        let _cse_204 = dot(_cse_193, normal_vec * area) + _cse_205;
        let _cse_225 = 2.0 * dot(_cse_196, vec2<f32>(dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_u_x_x, 0.0, is_boundary), select(s_neigh_grad_rho_u_x_y, 0.0, is_boundary))), dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_u_y_x, 0.0, is_boundary), select(s_neigh_grad_rho_u_y_y, 0.0, is_boundary))))) * _cse_197 / (_cse_197 * _cse_197 + 0.000000000000000000000000000001) - 1.0;
        let _cse_224 = min(_cse_225, 1.0);
        let _cse_223 = max(0.0, _cse_224);
        let _cse_222 = _cse_223 * lambda;
        let _cse_221 = _cse_196 * _cse_222;
        let _cse_220 = vec2<f32>(s_neigh_rho_u_x, s_neigh_rho_u_y) - _cse_221;
        let _cse_231 = 2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_rho_x, 0.0, is_boundary), select(s_neigh_grad_rho_y, 0.0, is_boundary))) * (s_neigh_rho - s_own_rho) / ((s_neigh_rho - s_own_rho) * (s_neigh_rho - s_own_rho) + 0.000000000000000000000000000001) - 1.0;
        let _cse_230 = min(_cse_231, 1.0);
        let _cse_229 = max(0.0, _cse_230);
        let _cse_228 = _cse_229 * lambda;
        let _cse_227 = _cse_228 * (s_neigh_rho - s_own_rho);
        let _cse_226 = s_neigh_rho - _cse_227;
        let _cse_219 = _cse_220 * 1.0 / _cse_226;
        let _cse_243 = _cse_226 * constants.eos_r * (s_neigh_T - max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary))) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda * (s_neigh_T - s_own_T));
        let _cse_242 = constants.eos_gamma * _cse_243;
        let _cse_241 = _cse_242 / _cse_226;
        let _cse_240 = _cse_241 + constants.eos_dp_drho;
        let _cse_244 = dot(_cse_219, _cse_219);
        let _cse_239 = max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0)) * _cse_240 + max(0.0, 1.0 - abs(f32(low_mach_params.model))) * min(_cse_244, _cse_240);
        let _cse_246 = min(max(_cse_244, low_mach_params.theta_floor * _cse_240), _cse_240);
        let _cse_245 = max(0.0, 1.0 - abs(f32(low_mach_params.model) - 1.0)) * _cse_246;
        let _cse_238 = _cse_239 + _cse_245;
        let _cse_237 = min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * _cse_238;
        let _cse_236 = _cse_237 + (1.0 - min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001)))) * _cse_240;
        let _cse_235 = _cse_236 / max(_cse_240, 0.000000000001);
        let _cse_234 = sqrt(_cse_235);
        let _cse_233 = (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(select(s_neigh_grad_T_x, 0.0, is_boundary), select(s_neigh_grad_T_y, 0.0, is_boundary)) * 0.5 * constants.eos_gamma * constants.eos_r / max(sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T), 0.000000000001)) * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) / ((sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T)) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda * (sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T) - sqrt(constants.eos_gamma * constants.eos_r * s_own_T))) * _cse_234;
        let _cse_232 = _cse_233 * area;
        let _cse_218 = dot(_cse_219, normal_vec * area) + _cse_232;
        let _cse_203 = max(_cse_204, _cse_218);
        let _cse_202 = max(_cse_203, 0.0);
        let _cse_251 = dot(_cse_193, normal_vec * area) - _cse_205;
        let _cse_252 = dot(_cse_219, normal_vec * area) - _cse_232;
        let _cse_250 = min(_cse_251, _cse_252);
        let _cse_249 = min(_cse_250, 0.0);
        let _cse_248 = _cse_202 - _cse_249;
        let _cse_247 = max(_cse_248, 0.000001);
        let _cse_201 = _cse_202 / _cse_247;
        let _cse_253 = _cse_249 * _cse_201;
        let _cse_192 = dot(_cse_193, normal_vec * area) * _cse_201 - _cse_253;
        let _cse_255 = 1.0 - _cse_201;
        let _cse_254 = dot(_cse_219, normal_vec * area) * _cse_255 + _cse_253;
        phi_0 = _cse_192 * _cse_198 + _cse_254 * _cse_226 + low_mach_params.pressure_coupling_alpha * (_cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) - _cse_243) * 0.5 * (1.0 / max(_cse_213, 0.000000000001) + 1.0 / max(_cse_240, 0.000000000001)) * min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
        phi_1 = _cse_192 * _cse_194.x + _cse_254 * _cse_220.x + (_cse_201 * _cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) + _cse_255 * _cse_243) * area * normal_vec.x - (constants.viscosity * ((select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + select(s_neigh_grad_u_y_x, 0.0, is_boundary) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + s_own_grad_u_y_x * normal_vec.y) * lambda_other) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_u_x - s_own_lap_rho_u_x) * s_own_bih_mask * s_neigh_bih_mask * area;
        phi_2 = _cse_192 * _cse_194.y + _cse_254 * _cse_220.y + (_cse_201 * _cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) + _cse_255 * _cse_243) * area * normal_vec.y - (constants.viscosity * (select(s_neigh_grad_u_x_y, 0.0, is_boundary) * normal_vec.x + (select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * (s_own_grad_u_x_y * normal_vec.x + (s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_u_y - s_own_lap_rho_u_y) * s_own_bih_mask * s_neigh_bih_mask * area;
        phi_3 = _cse_192 * (_cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) / max(constants.eos_gm1, 0.000000000001) + 0.5 * _cse_198 * _cse_215 + _cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T))) + _cse_254 * (_cse_243 / max(constants.eos_gm1, 0.000000000001) + 0.5 * _cse_226 * _cse_244 + _cse_243) + _cse_253 * (_cse_198 * constants.eos_r * (s_own_T + max(0.0, min(2.0 * dot(c_neigh_cell_vec - c_owner_vec, vec2<f32>(s_own_grad_T_x, s_own_grad_T_y)) * (s_neigh_T - s_own_T) / ((s_neigh_T - s_own_T) * (s_neigh_T - s_own_T) + 0.000000000000000000000000000001) - 1.0, 1.0)) * lambda_other * (s_neigh_T - s_own_T)) - _cse_243) - dot(vec2<f32>(dot(vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_x - state[owner * 31u + 10u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_x_x, 0.0, is_boundary), select(s_neigh_grad_u_x_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_x_x, s_own_grad_u_x_y) * lambda_other)), normal_vec), dot(vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other + normal_vec * select(0.0, 1.0, is_boundary) * ((s_own_u_y - state[owner * 31u + 11u]) / max(dist, 0.000001) - dot(normal_vec, vec2<f32>(select(s_neigh_grad_u_y_x, 0.0, is_boundary), select(s_neigh_grad_u_y_y, 0.0, is_boundary)) * lambda + vec2<f32>(s_own_grad_u_y_x, s_own_grad_u_y_y) * lambda_other)), normal_vec)) * constants.viscosity + vec2<f32>(constants.viscosity * ((select(s_neigh_grad_u_x_x, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.x + select(s_neigh_grad_u_y_x, 0.0, is_boundary) * normal_vec.y) * lambda + constants.viscosity * ((s_own_grad_u_x_x - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.x + s_own_grad_u_y_x * normal_vec.y) * lambda_other, constants.viscosity * (select(s_neigh_grad_u_x_y, 0.0, is_boundary) * normal_vec.x + (select(s_neigh_grad_u_y_y, 0.0, is_boundary) - 0.6666667 * (select(s_neigh_grad_u_x_x, 0.0, is_boundary) + select(s_neigh_grad_u_y_y, 0.0, is_boundary))) * normal_vec.y) * lambda + constants.viscosity * (s_own_grad_u_x_y * normal_vec.x + (s_own_grad_u_y_y - 0.6666667 * (s_own_grad_u_x_x + s_own_grad_u_y_y)) * normal_vec.y) * lambda_other), _cse_193 * _cse_201 + _cse_219 * _cse_255) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho_e - s_own_lap_rho_e) * s_own_bih_mask * s_neigh_bih_mask * area;
        phi_4 = 0.0;
        phi_5 = 0.0;
        phi_6 = 0.0;
        phi_7 = 0.0;
    ...
    if (constants.scheme == 5u && !is_boundary) {
        ...
        phi_0 = _cse_320 * _cse_326 + _cse_381 * _cse_353 + low_mach_params.pressure_coupling_alpha * (_cse_326 * constants.eos_r * (s_own_T + min(max(s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T, min(s_neigh_T - s_own_T, 0.0)), max(s_neigh_T - s_own_T, 0.0))) - _cse_367) * 0.5 * (1.0 / max(_cse_340, 0.000000000001) + 1.0 / max(_cse_364, 0.000000000001)) * min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
    ...
    if (constants.scheme == 6u && !is_boundary) {
        ...
        phi_0 = _cse_384 * _cse_387 + _cse_445 * _cse_416 + low_mach_params.pressure_coupling_alpha * (_cse_387 * constants.eos_r * (s_own_T + (s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) * abs(s_neigh_T - s_own_T) / max(abs(s_neigh_T - s_own_T), abs(s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T) + 0.00000001) * max((s_neigh_T - s_own_T) * (s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T), 0.0) / max(abs((s_neigh_T - s_own_T) * (s_own_T * 0.625 + s_neigh_T * 0.375 + dot(vec2<f32>(s_own_grad_T_x, s_own_grad_T_y), c_neigh_cell_vec - c_owner_vec) * 0.125 - s_own_T)), 0.00000001)) - _cse_431) * 0.5 * (1.0 / max(_cse_401, 0.000000000001) + 1.0 / max(_cse_428, 0.000000000001)) * min(1.0, max(0.0, constants.dtau / (constants.dtau + 0.000000000001))) * (1.0 - max(0.0, 1.0 - abs(f32(low_mach_params.model) - 2.0))) * area + low_mach_params.eps4 * 0.5 * (sqrt(constants.eos_gamma * constants.eos_r * s_own_T) + sqrt(constants.eos_gamma * constants.eos_r * s_neigh_T)) * (s_neigh_lap_rho - s_own_lap_rho) * s_own_bih_mask * s_neigh_bih_mask * area;
