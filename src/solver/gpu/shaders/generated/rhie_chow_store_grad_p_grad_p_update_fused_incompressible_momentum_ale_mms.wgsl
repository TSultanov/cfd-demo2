...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        let k1_ls_normal_constraint = k1_is_boundary && !(bc_kind[k1_face_idx * 3u + 2u] == 1u);
        ...
        let k1_ls_rhs_interior = (state[k1_other_idx * 10u + 2u] - state[base + 2u]) / k1_ls_dist;
        let k1_ls_rhs_dirichlet = (bc_value[k1_face_idx * 3u + 2u] - state[base + 2u]) / k1_ls_dist;
        let k1_ls_rhs_normal = select(0.0, bc_value[k1_face_idx * 3u + 2u], bc_kind[k1_face_idx * 3u + 2u] == 2u);
        let k1_ls_rhs_boundary = select(k1_ls_rhs_normal, k1_ls_rhs_dirichlet, bc_kind[k1_face_idx * 3u + 2u] == 1u);
