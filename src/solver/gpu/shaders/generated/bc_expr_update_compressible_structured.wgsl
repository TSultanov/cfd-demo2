    ...
    for (var k = 0u; k < 4u; k++) {
        ...
        if (sfd_is_boundary) {
            ...
            if (face_boundary_type == 1u) {
                ...
                bc_value[sfd_face_id * 8u + 3u] = select(bcv_rho_e_c0, max(in_p_c0, 0.000001) / max(constants.eos_gm1, 0.000001) + 0.5 * bcv_rho_c0 * (bcv_u_c0 * bcv_u_c0 + bcv_u_c1 * bcv_u_c1), constants.eos_gm1 > 0.0);
