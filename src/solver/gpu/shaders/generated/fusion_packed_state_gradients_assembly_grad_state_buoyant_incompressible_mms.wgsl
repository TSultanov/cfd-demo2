...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    if (constants.scheme != 0u) {
        ...
        for (var k = start; k < end; k++) {
            ...
            grad_acc_3 += normal_vec * (state[idx * 12u + 3u] * lambda + select(state[other_idx * 12u + 3u], select(select(state[idx * 12u + 3u], bc_value[face_idx * 4u + 3u], bc_kind[face_idx * 4u + 3u] == 1u), state[idx * 12u + 3u] + bc_value[face_idx * 4u + 3u] * d_own, bc_kind[face_idx * 4u + 3u] == 2u), is_boundary) * lambda_other) * area;
        }
        ...
        grad_state[idx * 12u + 3u].x = grad_out_3.x;
        grad_state[idx * 12u + 3u].y = grad_out_3.y;
    }
    ...
    k1_rhs_1 += -(-0.1 * constants.density * state[idx * 12u + 8u]) * k1_vol;
    ...
    for (var k1_k = k1_start; k1_k < k1_end; k1_k++) {
        ...
        let k1_diff_coeff_p = select(constants.density * state[idx * 12u + 3u], (constants.density * state[idx * 12u + 3u] + constants.density * state[k1_other_idx * 12u + 3u]) * 0.5, !k1_is_boundary) * k1_area / k1_dist;
        if (!k1_is_boundary) {
            ...
            if (bc_kind[k1_face_idx * 4u + 2u] == 1u) {
                ...
                if (bc_kind[k1_face_idx * 4u + 2u] == 2u) {
                    k1_rhs_2 += select(constants.density * state[idx * 12u + 3u], (constants.density * state[idx * 12u + 3u] + constants.density * state[k1_other_idx * 12u + 3u]) * 0.5, !k1_is_boundary) * k1_area * bc_value[k1_face_idx * 4u + 2u];
                }
            }
        }
