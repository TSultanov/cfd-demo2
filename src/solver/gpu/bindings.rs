...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    loop {
        ...
        }
        {
            ...
            let _e1152 = normal.x;
            jac_l_01_ = (a_l * _e1152);
            let _e1156 = normal.y;
            jac_l_02_ = (a_l * _e1156);
            jac_l_03_ = 0f;
            jac_r_00_ = a_prod_scaled;
            let _e1163 = normal.x;
            jac_r_01_ = (a_r * _e1163);
            let _e1167 = normal.y;
            jac_r_02_ = (a_r * _e1167);
            jac_r_03_ = 0f;
            let _e1175 = normal.x;
            let A_l_10_ = ((-(u_l_x) * u_n_l) + (dp_drho_l * _e1175));
            let _e1179 = normal.x;
            let _e1183 = normal.x;
            let A_l_11_ = ((u_n_l + (u_l_x * _e1179)) + (dp_dru_l * _e1183));
            let _e1187 = normal.y;
            let _e1190 = normal.x;
            let A_l_12_ = ((u_l_x * _e1187) + (dp_drv_l * _e1190));
            let _e1195 = normal.x;
            let A_l_13_ = (0.4f * _e1195);
            let _e1200 = normal.y;
            let A_l_20_ = ((-(u_l_y) * u_n_l) + (dp_drho_l * _e1200));
            let _e1204 = normal.x;
            let _e1207 = normal.y;
            let A_l_21_ = ((u_l_y * _e1204) + (dp_dru_l * _e1207));
            let _e1211 = normal.y;
            let _e1215 = normal.y;
            let A_l_22_ = ((u_n_l + (u_l_y * _e1211)) + (dp_drv_l * _e1215));
            let _e1219 = normal.y;
            let A_l_23_ = (0.4f * _e1219);
            let A_l_30_ = ((-(H_l) * u_n_l) + (dp_drho_l * u_n_l));
            let _e1226 = normal.x;
            let A_l_31_ = ((H_l * _e1226) + (dp_dru_l * u_n_l));
            let _e1231 = normal.y;
            let A_l_32_ = ((H_l * _e1231) + (dp_drv_l * u_n_l));
            let A_l_33_ = (1.4f * u_n_l);
            let _e1240 = normal.x;
            let A_r_10_ = ((-(u_r_x) * u_n_r) + (dp_drho_r * _e1240));
            let _e1244 = normal.x;
            let _e1248 = normal.x;
            let A_r_11_ = ((u_n_r + (u_r_x * _e1244)) + (dp_dru_r * _e1248));
            let _e1252 = normal.y;
            let _e1255 = normal.x;
            let A_r_12_ = ((u_r_x * _e1252) + (dp_drv_r * _e1255));
            let _e1260 = normal.x;
            let A_r_13_ = (0.4f * _e1260);
            let _e1265 = normal.y;
            let A_r_20_ = ((-(u_r_y) * u_n_r) + (dp_drho_r * _e1265));
            let _e1269 = normal.x;
            let _e1272 = normal.y;
            let A_r_21_ = ((u_r_y * _e1269) + (dp_dru_r * _e1272));
            let _e1276 = normal.y;
            let _e1280 = normal.y;
            let A_r_22_ = ((u_n_r + (u_r_y * _e1276)) + (dp_drv_r * _e1280));
            let _e1284 = normal.y;
            let A_r_23_ = (0.4f * _e1284);
            let A_r_30_ = ((-(H_r) * u_n_r) + (dp_drho_r * u_n_r));
            let _e1291 = normal.x;
            let A_r_31_ = ((H_r * _e1291) + (dp_dru_r * u_n_r));
            let _e1296 = normal.y;
            let A_r_32_ = ((H_r * _e1296) + (dp_drv_r * u_n_r));
            ...
            let _e1377 = jac_l_10_;
            jac_l_10_ = (_e1377 + d_diff_x_l_rho);
            let _e1379 = jac_l_11_;
            jac_l_11_ = (_e1379 + d_diff_x_l_ru);
            let _e1382 = jac_l_12_;
            jac_l_12_ = (_e1382 + 0f);
            let _e1385 = jac_l_13_;
            jac_l_13_ = (_e1385 + 0f);
            let _e1387 = jac_l_20_;
            jac_l_20_ = (_e1387 + d_diff_y_l_rho);
            let _e1390 = jac_l_21_;
            jac_l_21_ = (_e1390 + 0f);
            let _e1392 = jac_l_22_;
            jac_l_22_ = (_e1392 + d_diff_y_l_rv);
            let _e1395 = jac_l_23_;
            jac_l_23_ = (_e1395 + 0f);
            let _e1397 = jac_r_10_;
            jac_r_10_ = (_e1397 + d_diff_x_r_rho);
            let _e1399 = jac_r_11_;
            jac_r_11_ = (_e1399 + d_diff_x_r_ru);
            let _e1402 = jac_r_12_;
            jac_r_12_ = (_e1402 + 0f);
            let _e1405 = jac_r_13_;
            jac_r_13_ = (_e1405 + 0f);
            let _e1407 = jac_r_20_;
            jac_r_20_ = (_e1407 + d_diff_y_r_rho);
            let _e1410 = jac_r_21_;
            jac_r_21_ = (_e1410 + 0f);
            let _e1412 = jac_r_22_;
            jac_r_22_ = (_e1412 + d_diff_y_r_rv);
            let _e1415 = jac_r_23_;
            jac_r_23_ = (_e1415 + 0f);
            ...
            let _e1497 = jac_l_30_;
            jac_l_30_ = (_e1497 + d_e_visc_l_rho);
            let _e1499 = jac_l_31_;
            jac_l_31_ = (_e1499 + d_e_visc_l_ru);
            let _e1501 = jac_l_32_;
            jac_l_32_ = (_e1501 + d_e_visc_l_rv);
            let _e1503 = jac_l_33_;
            jac_l_33_ = (_e1503 + d_e_visc_l_re);
            let _e1505 = jac_r_30_;
            jac_r_30_ = (_e1505 + d_e_visc_r_rho);
            let _e1507 = jac_r_31_;
            jac_r_31_ = (_e1507 + d_e_visc_r_ru);
            let _e1509 = jac_r_32_;
            jac_r_32_ = (_e1509 + d_e_visc_r_rv);
            let _e1511 = jac_r_33_;
            jac_r_33_ = (_e1511 + d_e_visc_r_re);
            let _e1513 = is_boundary;
            if !(_e1513) {
                let _e1516 = face_offset;
                let scalar_mat_idx = cell_face_matrix_indices[_e1516];
                neighbor_rank = 0u;
                ...
                let _e1526 = neighbor_rank;
                let _e1533 = jac_r_00_;
                matrix_values[((start_row_0_ + (4u * _e1526)) + 0u)] = (_e1533 * area);
                let _e1536 = neighbor_rank;
                let _e1543 = jac_r_01_;
                matrix_values[((start_row_0_ + (4u * _e1536)) + 1u)] = (_e1543 * area);
                let _e1546 = neighbor_rank;
                let _e1553 = jac_r_02_;
                matrix_values[((start_row_0_ + (4u * _e1546)) + 2u)] = (_e1553 * area);
                let _e1556 = neighbor_rank;
                let _e1563 = jac_r_03_;
                matrix_values[((start_row_0_ + (4u * _e1556)) + 3u)] = (_e1563 * area);
                let _e1566 = neighbor_rank;
                let _e1573 = jac_r_10_;
                matrix_values[((start_row_1_ + (4u * _e1566)) + 0u)] = (_e1573 * area);
                let _e1576 = neighbor_rank;
                let _e1583 = jac_r_11_;
                matrix_values[((start_row_1_ + (4u * _e1576)) + 1u)] = (_e1583 * area);
                let _e1586 = neighbor_rank;
                let _e1593 = jac_r_12_;
                matrix_values[((start_row_1_ + (4u * _e1586)) + 2u)] = (_e1593 * area);
                let _e1596 = neighbor_rank;
                let _e1603 = jac_r_13_;
                matrix_values[((start_row_1_ + (4u * _e1596)) + 3u)] = (_e1603 * area);
                let _e1606 = neighbor_rank;
                let _e1613 = jac_r_20_;
                matrix_values[((start_row_2_ + (4u * _e1606)) + 0u)] = (_e1613 * area);
                let _e1616 = neighbor_rank;
                let _e1623 = jac_r_21_;
                matrix_values[((start_row_2_ + (4u * _e1616)) + 1u)] = (_e1623 * area);
                let _e1626 = neighbor_rank;
                let _e1633 = jac_r_22_;
                matrix_values[((start_row_2_ + (4u * _e1626)) + 2u)] = (_e1633 * area);
                let _e1636 = neighbor_rank;
                let _e1643 = jac_r_23_;
                matrix_values[((start_row_2_ + (4u * _e1636)) + 3u)] = (_e1643 * area);
                let _e1646 = neighbor_rank;
                let _e1653 = jac_r_30_;
                matrix_values[((start_row_3_ + (4u * _e1646)) + 0u)] = (_e1653 * area);
                let _e1656 = neighbor_rank;
                let _e1663 = jac_r_31_;
                matrix_values[((start_row_3_ + (4u * _e1656)) + 1u)] = (_e1663 * area);
                let _e1666 = neighbor_rank;
                let _e1673 = jac_r_32_;
                matrix_values[((start_row_3_ + (4u * _e1666)) + 2u)] = (_e1673 * area);
                let _e1676 = neighbor_rank;
                let _e1683 = jac_r_33_;
                matrix_values[((start_row_3_ + (4u * _e1676)) + 3u)] = (_e1683 * area);
                let _e1686 = jac_l_00_;
                let _e1688 = diag_00_;
                diag_00_ = (_e1688 + (_e1686 * area));
                let _e1691 = jac_l_01_;
                let _e1693 = diag_01_;
                diag_01_ = (_e1693 + (_e1691 * area));
                let _e1696 = jac_l_02_;
                let _e1698 = diag_02_;
                diag_02_ = (_e1698 + (_e1696 * area));
                let _e1701 = jac_l_03_;
                let _e1703 = diag_03_;
                diag_03_ = (_e1703 + (_e1701 * area));
                let _e1706 = jac_l_10_;
                let _e1708 = diag_10_;
                diag_10_ = (_e1708 + (_e1706 * area));
                let _e1711 = jac_l_11_;
                let _e1713 = diag_11_;
                diag_11_ = (_e1713 + (_e1711 * area));
                let _e1716 = jac_l_12_;
                let _e1718 = diag_12_;
                diag_12_ = (_e1718 + (_e1716 * area));
                let _e1721 = jac_l_13_;
                let _e1723 = diag_13_;
                diag_13_ = (_e1723 + (_e1721 * area));
                let _e1726 = jac_l_20_;
                let _e1728 = diag_20_;
                diag_20_ = (_e1728 + (_e1726 * area));
                let _e1731 = jac_l_21_;
                let _e1733 = diag_21_;
                diag_21_ = (_e1733 + (_e1731 * area));
                let _e1736 = jac_l_22_;
                let _e1738 = diag_22_;
                diag_22_ = (_e1738 + (_e1736 * area));
                let _e1741 = jac_l_23_;
                let _e1743 = diag_23_;
                diag_23_ = (_e1743 + (_e1741 * area));
                let _e1746 = jac_l_30_;
                let _e1748 = diag_30_;
                diag_30_ = (_e1748 + (_e1746 * area));
                let _e1751 = jac_l_31_;
                let _e1753 = diag_31_;
                diag_31_ = (_e1753 + (_e1751 * area));
                let _e1756 = jac_l_32_;
                let _e1758 = diag_32_;
                diag_32_ = (_e1758 + (_e1756 * area));
                let _e1761 = jac_l_33_;
                let _e1763 = diag_33_;
                diag_33_ = (_e1763 + (_e1761 * area));
            } else {
                if (boundary_type == 1u) {
                    let _e1767 = jac_l_00_;
                    let _e1768 = jac_r_00_;
                    let _e1770 = jac_r_01_;
                    let _e1773 = constants.inlet_velocity;
                    let _e1777 = diag_00_;
                    diag_00_ = (_e1777 + (((_e1767 + _e1768) + (_e1770 * _e1773)) * area));
                    let _e1779 = jac_l_01_;
                    let _e1781 = diag_01_;
                    diag_01_ = (_e1781 + (_e1779 * area));
                    let _e1783 = jac_l_02_;
                    let _e1785 = diag_02_;
                    diag_02_ = (_e1785 + (_e1783 * area));
                    let _e1787 = jac_l_03_;
                    let _e1788 = jac_r_03_;
                    let _e1791 = diag_03_;
                    diag_03_ = (_e1791 + ((_e1787 + _e1788) * area));
                    let _e1793 = jac_l_10_;
                    let _e1794 = jac_r_10_;
                    let _e1796 = jac_r_11_;
                    let _e1799 = constants.inlet_velocity;
                    let _e1803 = diag_10_;
                    diag_10_ = (_e1803 + (((_e1793 + _e1794) + (_e1796 * _e1799)) * area));
                    let _e1805 = jac_l_11_;
                    let _e1807 = diag_11_;
                    diag_11_ = (_e1807 + (_e1805 * area));
                    let _e1809 = jac_l_12_;
                    let _e1811 = diag_12_;
                    diag_12_ = (_e1811 + (_e1809 * area));
                    let _e1813 = jac_l_13_;
                    let _e1814 = jac_r_13_;
                    let _e1817 = diag_13_;
                    diag_13_ = (_e1817 + ((_e1813 + _e1814) * area));
                    let _e1819 = jac_l_20_;
                    let _e1820 = jac_r_20_;
                    let _e1822 = jac_r_21_;
                    let _e1825 = constants.inlet_velocity;
                    let _e1829 = diag_20_;
                    diag_20_ = (_e1829 + (((_e1819 + _e1820) + (_e1822 * _e1825)) * area));
                    let _e1831 = jac_l_21_;
                    let _e1833 = diag_21_;
                    diag_21_ = (_e1833 + (_e1831 * area));
                    let _e1835 = jac_l_22_;
                    let _e1837 = diag_22_;
                    diag_22_ = (_e1837 + (_e1835 * area));
                    let _e1839 = jac_l_23_;
                    let _e1840 = jac_r_23_;
                    let _e1843 = diag_23_;
                    diag_23_ = (_e1843 + ((_e1839 + _e1840) * area));
                    let _e1845 = jac_l_30_;
                    let _e1846 = jac_r_30_;
                    let _e1848 = jac_r_31_;
                    let _e1851 = constants.inlet_velocity;
                    let _e1855 = diag_30_;
                    diag_30_ = (_e1855 + (((_e1845 + _e1846) + (_e1848 * _e1851)) * area));
                    let _e1857 = jac_l_31_;
                    let _e1859 = diag_31_;
                    diag_31_ = (_e1859 + (_e1857 * area));
                    let _e1861 = jac_l_32_;
                    let _e1863 = diag_32_;
                    diag_32_ = (_e1863 + (_e1861 * area));
                    let _e1865 = jac_l_33_;
                    let _e1866 = jac_r_33_;
                    let _e1869 = diag_33_;
                    diag_33_ = (_e1869 + ((_e1865 + _e1866) * area));
                } else {
                    if (boundary_type == 3u) {
                        let _e1874 = normal.x;
                        let _e1878 = normal.x;
                        let r11_ = (1f - ((2f * _e1874) * _e1878));
                        let _e1883 = normal.x;
                        let _e1887 = normal.y;
                        let r12_ = ((-2f * _e1883) * _e1887);
                        let _e1890 = normal.y;
                        let _e1894 = normal.x;
                        let r21_ = ((-2f * _e1890) * _e1894);
                        let _e1897 = normal.y;
                        let _e1901 = normal.y;
                        let r22_ = (1f - ((2f * _e1897) * _e1901));
                        let _e1905 = jac_l_00_;
                        let _e1906 = jac_r_00_;
                        let _e1909 = diag_00_;
                        diag_00_ = (_e1909 + ((_e1905 + _e1906) * area));
                        let _e1911 = jac_l_01_;
                        let _e1912 = jac_r_01_;
                        let _e1915 = jac_r_02_;
                        let _e1919 = diag_01_;
                        diag_01_ = (_e1919 + (((_e1911 + (_e1912 * r11_)) + (_e1915 * r21_)) * area));
                        let _e1921 = jac_l_02_;
                        let _e1922 = jac_r_01_;
                        let _e1925 = jac_r_02_;
                        let _e1929 = diag_02_;
                        diag_02_ = (_e1929 + (((_e1921 + (_e1922 * r12_)) + (_e1925 * r22_)) * area));
                        let _e1931 = jac_l_03_;
                        let _e1932 = jac_r_03_;
                        let _e1935 = diag_03_;
                        diag_03_ = (_e1935 + ((_e1931 + _e1932) * area));
                        let _e1937 = jac_l_10_;
                        let _e1938 = jac_r_10_;
                        let _e1941 = diag_10_;
                        diag_10_ = (_e1941 + ((_e1937 + _e1938) * area));
                        let _e1943 = jac_l_11_;
                        let _e1944 = jac_r_11_;
                        let _e1947 = jac_r_12_;
                        let _e1951 = diag_11_;
                        diag_11_ = (_e1951 + (((_e1943 + (_e1944 * r11_)) + (_e1947 * r21_)) * area));
                        let _e1953 = jac_l_12_;
                        let _e1954 = jac_r_11_;
                        let _e1957 = jac_r_12_;
                        let _e1961 = diag_12_;
                        diag_12_ = (_e1961 + (((_e1953 + (_e1954 * r12_)) + (_e1957 * r22_)) * area));
                        let _e1963 = jac_l_13_;
                        let _e1964 = jac_r_13_;
                        let _e1967 = diag_13_;
                        diag_13_ = (_e1967 + ((_e1963 + _e1964) * area));
                        let _e1969 = jac_l_20_;
                        let _e1970 = jac_r_20_;
                        let _e1973 = diag_20_;
                        diag_20_ = (_e1973 + ((_e1969 + _e1970) * area));
                        let _e1975 = jac_l_21_;
                        let _e1976 = jac_r_21_;
                        let _e1979 = jac_r_22_;
                        let _e1983 = diag_21_;
                        diag_21_ = (_e1983 + (((_e1975 + (_e1976 * r11_)) + (_e1979 * r21_)) * area));
                        let _e1985 = jac_l_22_;
                        let _e1986 = jac_r_21_;
                        let _e1989 = jac_r_22_;
                        let _e1993 = diag_22_;
                        diag_22_ = (_e1993 + (((_e1985 + (_e1986 * r12_)) + (_e1989 * r22_)) * area));
                        let _e1995 = jac_l_23_;
                        let _e1996 = jac_r_23_;
                        let _e1999 = diag_23_;
                        diag_23_ = (_e1999 + ((_e1995 + _e1996) * area));
                        let _e2001 = jac_l_30_;
                        let _e2002 = jac_r_30_;
                        let _e2005 = diag_30_;
                        diag_30_ = (_e2005 + ((_e2001 + _e2002) * area));
                        let _e2007 = jac_l_31_;
                        let _e2008 = jac_r_31_;
                        let _e2011 = jac_r_32_;
                        let _e2015 = diag_31_;
                        diag_31_ = (_e2015 + (((_e2007 + (_e2008 * r11_)) + (_e2011 * r21_)) * area));
                        let _e2017 = jac_l_32_;
                        let _e2018 = jac_r_31_;
                        let _e2021 = jac_r_32_;
                        let _e2025 = diag_32_;
                        diag_32_ = (_e2025 + (((_e2017 + (_e2018 * r12_)) + (_e2021 * r22_)) * area));
                        let _e2027 = jac_l_33_;
                        let _e2028 = jac_r_33_;
                        let _e2031 = diag_33_;
                        diag_33_ = (_e2031 + ((_e2027 + _e2028) * area));
                    } else {
                        let _e2033 = jac_l_00_;
                        let _e2034 = jac_r_00_;
                        let _e2037 = diag_00_;
                        diag_00_ = (_e2037 + ((_e2033 + _e2034) * area));
                        let _e2039 = jac_l_01_;
                        let _e2040 = jac_r_01_;
                        let _e2043 = diag_01_;
                        diag_01_ = (_e2043 + ((_e2039 + _e2040) * area));
                        let _e2045 = jac_l_02_;
                        let _e2046 = jac_r_02_;
                        let _e2049 = diag_02_;
                        diag_02_ = (_e2049 + ((_e2045 + _e2046) * area));
                        let _e2051 = jac_l_03_;
                        let _e2052 = jac_r_03_;
                        let _e2055 = diag_03_;
                        diag_03_ = (_e2055 + ((_e2051 + _e2052) * area));
                        let _e2057 = jac_l_10_;
                        let _e2058 = jac_r_10_;
                        let _e2061 = diag_10_;
                        diag_10_ = (_e2061 + ((_e2057 + _e2058) * area));
                        let _e2063 = jac_l_11_;
                        let _e2064 = jac_r_11_;
                        let _e2067 = diag_11_;
                        diag_11_ = (_e2067 + ((_e2063 + _e2064) * area));
                        let _e2069 = jac_l_12_;
                        let _e2070 = jac_r_12_;
                        let _e2073 = diag_12_;
                        diag_12_ = (_e2073 + ((_e2069 + _e2070) * area));
                        let _e2075 = jac_l_13_;
                        let _e2076 = jac_r_13_;
                        let _e2079 = diag_13_;
                        diag_13_ = (_e2079 + ((_e2075 + _e2076) * area));
                        let _e2081 = jac_l_20_;
                        let _e2082 = jac_r_20_;
                        let _e2085 = diag_20_;
                        diag_20_ = (_e2085 + ((_e2081 + _e2082) * area));
                        let _e2087 = jac_l_21_;
                        let _e2088 = jac_r_21_;
                        let _e2091 = diag_21_;
                        diag_21_ = (_e2091 + ((_e2087 + _e2088) * area));
                        let _e2093 = jac_l_22_;
                        let _e2094 = jac_r_22_;
                        let _e2097 = diag_22_;
                        diag_22_ = (_e2097 + ((_e2093 + _e2094) * area));
                        let _e2099 = jac_l_23_;
                        let _e2100 = jac_r_23_;
                        let _e2103 = diag_23_;
                        diag_23_ = (_e2103 + ((_e2099 + _e2100) * area));
                        let _e2105 = jac_l_30_;
                        let _e2106 = jac_r_30_;
                        let _e2109 = diag_30_;
                        diag_30_ = (_e2109 + ((_e2105 + _e2106) * area));
                        let _e2111 = jac_l_31_;
                        let _e2112 = jac_r_31_;
                        let _e2115 = diag_31_;
                        diag_31_ = (_e2115 + ((_e2111 + _e2112) * area));
                        let _e2117 = jac_l_32_;
                        let _e2118 = jac_r_32_;
                        let _e2121 = diag_32_;
                        diag_32_ = (_e2121 + ((_e2117 + _e2118) * area));
                        let _e2123 = jac_l_33_;
                        let _e2124 = jac_r_33_;
                        let _e2127 = diag_33_;
                        diag_33_ = (_e2127 + ((_e2123 + _e2124) * area));
                    }
                }
            }
        }
        continuing {
            let _e2130 = face_offset;
            face_offset = (_e2130 + 1u);
        }
    }
    let _e2132 = rhs_time_rho;
    let _e2133 = rhs_pseudo_rho;
    let _e2135 = coeff_time;
    let _e2136 = coeff_pseudo;
    let _e2140 = sum_rho;
    rhs_rho = (((_e2132 + _e2133) - ((_e2135 + _e2136) * rho)) - _e2140);
    let _e2143 = rhs_time_rho_u_x;
    let _e2144 = rhs_pseudo_rho_u_x;
    let _e2146 = coeff_time;
    let _e2147 = coeff_pseudo;
    let _e2152 = sum_rho_u_x;
    rhs_rho_u_x = (((_e2143 + _e2144) - ((_e2146 + _e2147) * rho_u.x)) - _e2152);
    let _e2155 = rhs_time_rho_u_y;
    let _e2156 = rhs_pseudo_rho_u_y;
    let _e2158 = coeff_time;
    let _e2159 = coeff_pseudo;
    let _e2164 = sum_rho_u_y;
    rhs_rho_u_y = (((_e2155 + _e2156) - ((_e2158 + _e2159) * rho_u.y)) - _e2164);
    let _e2167 = rhs_time_rho_e;
    let _e2168 = rhs_pseudo_rho_e;
    let _e2170 = coeff_time;
    let _e2171 = coeff_pseudo;
    let _e2175 = sum_rho_e;
    rhs_rho_e = (((_e2167 + _e2168) - ((_e2170 + _e2171) * rho_e)) - _e2175);
    let _e2178 = coeff_time;
    let _e2179 = diag_00_;
    diag_00_ = (_e2179 + _e2178);
    let _e2181 = coeff_time;
    let _e2182 = diag_11_;
    diag_11_ = (_e2182 + _e2181);
    let _e2184 = coeff_time;
    let _e2185 = diag_22_;
    diag_22_ = (_e2185 + _e2184);
    let _e2187 = coeff_time;
    let _e2188 = diag_33_;
    diag_33_ = (_e2188 + _e2187);
    let _e2190 = coeff_pseudo;
    let _e2191 = diag_00_;
    diag_00_ = (_e2191 + _e2190);
    let _e2193 = coeff_pseudo;
    let _e2194 = diag_11_;
    diag_11_ = (_e2194 + _e2193);
    let _e2196 = coeff_pseudo;
    let _e2197 = diag_22_;
    diag_22_ = (_e2197 + _e2196);
    let _e2199 = coeff_pseudo;
    let _e2200 = diag_33_;
    diag_33_ = (_e2200 + _e2199);
    let scalar_diag_idx = diagonal_indices[idx];
    let diag_rank = (scalar_diag_idx - scalar_offset);
    let _e2213 = diag_00_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 0u)] = _e2213;
    let _e2221 = diag_01_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 1u)] = _e2221;
    let _e2229 = diag_02_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 2u)] = _e2229;
    let _e2237 = diag_03_;
    matrix_values[((start_row_0_ + (4u * diag_rank)) + 3u)] = _e2237;
    let _e2245 = diag_10_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 0u)] = _e2245;
    let _e2253 = diag_11_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 1u)] = _e2253;
    let _e2261 = diag_12_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 2u)] = _e2261;
    let _e2269 = diag_13_;
    matrix_values[((start_row_1_ + (4u * diag_rank)) + 3u)] = _e2269;
    let _e2277 = diag_20_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 0u)] = _e2277;
    let _e2285 = diag_21_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 1u)] = _e2285;
    let _e2293 = diag_22_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 2u)] = _e2293;
    let _e2301 = diag_23_;
    matrix_values[((start_row_2_ + (4u * diag_rank)) + 3u)] = _e2301;
    let _e2309 = diag_30_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 0u)] = _e2309;
    let _e2317 = diag_31_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 1u)] = _e2317;
    let _e2325 = diag_32_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 2u)] = _e2325;
    let _e2333 = diag_33_;
    matrix_values[((start_row_3_ + (4u * diag_rank)) + 3u)] = _e2333;
    let _e2340 = rhs_rho;
    rhs[((idx * 4u) + 0u)] = _e2340;
    let _e2347 = rhs_rho_u_x;
    rhs[((idx * 4u) + 1u)] = _e2347;
    let _e2354 = rhs_rho_u_y;
    rhs[((idx * 4u) + 2u)] = _e2354;
    let _e2361 = rhs_rho_e;
    rhs[((idx * 4u) + 3u)] = _e2361;
    return;
}
"#;
    }
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    loop {
        ...
        }
        {
            ...
            let _e253 = is_boundary;
            if !(_e253) {
                let coeff_2 = (conv_coeff_off_1 - _e239);
                let _e257 = diag_u;
                diag_u = (_e257 + (_e239 + conv_coeff_diag_1));
                let _e260 = diag_v;
                diag_v = (_e260 + (_e239 + conv_coeff_diag_1));
                if (0u != 0u) {
                    let _e271 = state[((idx * 8u) + 0u)];
                    let _e278 = state[((idx * 8u) + 1u)];
                    let u_own = vec2<f32>(_e271, _e278);
                    let _e280 = other_idx;
                    let _e287 = state[((_e280 * 8u) + 0u)];
                    let _e288 = other_idx;
                    let _e295 = state[((_e288 * 8u) + 1u)];
                    let u_neigh = vec2<f32>(_e287, _e295);
                    phi_upwind_u = u_own.x;
                    if (flux_2 < 0f) {
                        phi_upwind_u = u_neigh.x;
                    }
                    let _e302 = phi_upwind_u;
                    phi_ho_u = _e302;
                    if (0u == 1u) {
                        if (flux_2 > 0f) {
                            let _e312 = grad_u[idx].x;
                            let _e316 = grad_u[idx].y;
                            phi_ho_u = (u_own.x + dot(vec2<f32>(_e312, _e316), (vec2<f32>(f_center.x, f_center.y) - vec2<f32>(center.x, center.y))));
                        } else {
                            let _e329 = other_idx;
                            let _e332 = grad_u[_e329].x;
                            let _e334 = other_idx;
                            let _e337 = grad_u[_e334].y;
                            let _e343 = other_center.x;
                            let _e345 = other_center.y;
                            phi_ho_u = (u_neigh.x + dot(vec2<f32>(_e332, _e337), (vec2<f32>(f_center.x, f_center.y) - vec2<f32>(_e343, _e345))));
                        }
                    } else {
                        if (0u == 2u) {
                            if (flux_2 > 0f) {
                                let _e364 = grad_u[idx].x;
                                let _e368 = grad_u[idx].y;
                                let _e371 = other_center.x;
                                let _e373 = other_center.y;
                                phi_ho_u = (((0.625f * u_own.x) + (0.375f * u_neigh.x)) + (0.125f * dot(vec2<f32>(_e364, _e368), (vec2<f32>(_e371, _e373) - vec2<f32>(center.x, center.y)))));
                            } else {
                                let _e391 = other_idx;
                                let _e394 = grad_u[_e391].x;
                                let _e396 = other_idx;
                                let _e399 = grad_u[_e396].y;
                                let _e405 = other_center.x;
                                let _e407 = other_center.y;
                                phi_ho_u = (((0.625f * u_neigh.x) + (0.375f * u_own.x)) + (0.125f * dot(vec2<f32>(_e394, _e399), (vec2<f32>(center.x, center.y) - vec2<f32>(_e405, _e407)))));
                            }
                        }
                    }
                    ...
                    let _e419 = phi_upwind_v;
                    phi_ho_v = _e419;
                    if (0u == 1u) {
                        if (flux_2 > 0f) {
                            let _e429 = grad_v[idx].x;
                            let _e433 = grad_v[idx].y;
                            phi_ho_v = (u_own.y + dot(vec2<f32>(_e429, _e433), (vec2<f32>(f_center.x, f_center.y) - vec2<f32>(center.x, center.y))));
                        } else {
                            let _e446 = other_idx;
                            let _e449 = grad_v[_e446].x;
                            let _e451 = other_idx;
                            let _e454 = grad_v[_e451].y;
                            let _e460 = other_center.x;
                            let _e462 = other_center.y;
                            phi_ho_v = (u_neigh.y + dot(vec2<f32>(_e449, _e454), (vec2<f32>(f_center.x, f_center.y) - vec2<f32>(_e460, _e462))));
                        }
                    } else {
                        if (0u == 2u) {
                            if (flux_2 > 0f) {
                                let _e481 = grad_v[idx].x;
                                let _e485 = grad_v[idx].y;
                                let _e488 = other_center.x;
                                let _e490 = other_center.y;
                                phi_ho_v = (((0.625f * u_own.y) + (0.375f * u_neigh.y)) + (0.125f * dot(vec2<f32>(_e481, _e485), (vec2<f32>(_e488, _e490) - vec2<f32>(center.x, center.y)))));
                            } else {
                                let _e508 = other_idx;
                                let _e511 = grad_v[_e508].x;
                                let _e513 = other_idx;
                                let _e516 = grad_v[_e513].y;
                                let _e522 = other_center.x;
                                let _e524 = other_center.y;
                                phi_ho_v = (((0.625f * u_neigh.y) + (0.375f * u_own.y)) + (0.125f * dot(vec2<f32>(_e511, _e516), (vec2<f32>(center.x, center.y) - vec2<f32>(_e522, _e524)))));
                            }
                        }
                    }
                    let _e531 = phi_ho_u;
                    let _e532 = phi_upwind_u;
                    let correction_u = (flux_2 * (_e531 - _e532));
                    let _e535 = phi_ho_v;
                    let _e536 = phi_upwind_v;
                    let correction_v = (flux_2 * (_e535 - _e536));
                    let _e539 = rhs_u;
                    rhs_u = (_e539 - correction_u);
                    let _e541 = rhs_v;
                    rhs_v = (_e541 - correction_v);
                }
                let d_own = distance(vec2<f32>(center.x, center.y), vec2<f32>(f_center.x, f_center.y));
                let _e551 = other_center.x;
                let _e553 = other_center.y;
                let d_neigh = distance(vec2<f32>(_e551, _e553), vec2<f32>(f_center.x, f_center.y));
                ...
                let _e566 = normal.x;
                let pg_force_x = (area_4 * _e566);
                let _e569 = normal.y;
                let pg_force_y = (area_4 * _e569);
                let _e572 = lambda;
                let _e574 = sum_diag_up;
                sum_diag_up = (_e574 + (_e572 * pg_force_x));
                let _e577 = lambda;
                let _e579 = sum_diag_vp;
                sum_diag_vp = (_e579 + (_e577 * pg_force_y));
                let _e582 = normal.x;
                let div_coeff_x = (_e582 * area_4);
                let _e585 = normal.y;
                let div_coeff_y = (_e585 * area_4);
                let _e588 = lambda;
                let _e590 = sum_diag_pu;
                sum_diag_pu = (_e590 + (_e588 * div_coeff_x));
                let _e593 = lambda;
                let _e595 = sum_diag_pv;
                sum_diag_pv = (_e595 + (_e593 * div_coeff_y));
                let d_p_own = state[((idx * 8u) + 3u)];
                let _e604 = lambda;
                let _e606 = lambda;
                let _e609 = d_p_neigh;
                let d_p_face = ((_e604 * d_p_own) + ((1f - _e606) * _e609));
                let _e614 = constants.density;
                let _e615 = lambda;
                let _e622 = state[((idx * 8u) + 3u)];
                let _e624 = lambda;
                let _e627 = other_idx;
                let _e634 = state[((_e627 * 8u) + 3u)];
                let pressure_coeff_face = (_e614 * ((_e615 * _e622) + ((1f - _e624) * _e634)));
                let lapl_coeff = ((pressure_coeff_face * area_4) / dist_3);
                let _e641 = sum_diag_pp;
                sum_diag_pp = (_e641 + lapl_coeff);
                let scalar_coeff = ((pressure_coeff_face * area_4) / dist_3);
                if (scalar_mat_idx != 4294967295u) {
                    scalar_matrix_values[scalar_mat_idx] = -(scalar_coeff);
                }
                let _e651 = scalar_diag_p;
                scalar_diag_p = (_e651 + scalar_coeff);
                let _e654 = neighbor_rank;
                matrix_values[((start_row_0_ + (3u * _e654)) + 0u)] = coeff_2;
                let _e662 = neighbor_rank;
                matrix_values[((start_row_0_ + (3u * _e662)) + 1u)] = 0f;
                let _e671 = neighbor_rank;
                let _e678 = lambda;
                matrix_values[((start_row_0_ + (3u * _e671)) + 2u)] = ((1f - _e678) * pg_force_x);
                let _e683 = neighbor_rank;
                matrix_values[((start_row_1_ + (3u * _e683)) + 0u)] = 0f;
                let _e692 = neighbor_rank;
                matrix_values[((start_row_1_ + (3u * _e692)) + 1u)] = coeff_2;
                let _e700 = neighbor_rank;
                let _e707 = lambda;
                matrix_values[((start_row_1_ + (3u * _e700)) + 2u)] = ((1f - _e707) * pg_force_y);
                let _e712 = neighbor_rank;
                let _e719 = lambda;
                matrix_values[((start_row_2_ + (3u * _e712)) + 0u)] = ((1f - _e719) * div_coeff_x);
                let _e724 = neighbor_rank;
                let _e731 = lambda;
                matrix_values[((start_row_2_ + (3u * _e724)) + 1u)] = ((1f - _e731) * div_coeff_y);
                let _e736 = neighbor_rank;
                matrix_values[((start_row_2_ + (3u * _e736)) + 2u)] = -(lapl_coeff);
            } else {
                if (boundary_type == 1u) {
                    let _e748 = constants.ramp_time;
                    let _e751 = constants.time;
                    let ramp = smoothstep(0f, _e748, _e751);
                    let _e756 = constants.inlet_velocity;
                    let u_bc_x = (_e756 * ramp);
                    let _e758 = diag_u;
                    diag_u = (_e758 + _e239);
                    let _e760 = diag_v;
                    diag_v = (_e760 + _e239);
                    let _e763 = rhs_u;
                    rhs_u = (_e763 + (_e239 * u_bc_x));
                    let _e767 = rhs_v;
                    rhs_v = (_e767 + (_e239 * 0f));
                    if (flux_2 > 0f) {
                        let _e771 = diag_u;
                        diag_u = (_e771 + flux_2);
                        let _e773 = diag_v;
                        ...
                        let _e776 = rhs_u;
                        rhs_u = (_e776 - (flux_2 * u_bc_x));
                        let _e779 = rhs_v;
                        rhs_v = (_e779 - (flux_2 * 0f));
                    }
                    let _e782 = normal.x;
                    let pg_force_x_1 = (area_4 * _e782);
                    let _e785 = normal.y;
                    let pg_force_y_1 = (area_4 * _e785);
                    let _e787 = sum_diag_up;
                    sum_diag_up = (_e787 + pg_force_x_1);
                    let _e789 = sum_diag_vp;
                    sum_diag_vp = (_e789 + pg_force_y_1);
                    let _e792 = normal.x;
                    let _e795 = normal.y;
                    let flux_bc = (((u_bc_x * _e792) + (0f * _e795)) * area_4);
                    let _e800 = rhs_p;
                    rhs_p = (_e800 - flux_bc);
                } else {
                    if (boundary_type == 3u) {
                        ...
                        diag_v = (_e806 + _e239);
                        let _e809 = normal.x;
                        let pg_force_x_2 = (area_4 * _e809);
                        let _e812 = normal.y;
                        let pg_force_y_2 = (area_4 * _e812);
                        let _e814 = sum_diag_up;
                        sum_diag_up = (_e814 + pg_force_x_2);
                        let _e816 = sum_diag_vp;
                        sum_diag_vp = (_e816 + pg_force_y_2);
                    } else {
                        if (boundary_type == 2u) {
                            if (flux_2 > 0f) {
                                let _e822 = diag_u;
                            ...
                            let _e827 = normal.x;
                            let div_coeff_x_1 = (_e827 * area_4);
                            let _e830 = normal.y;
                            let div_coeff_y_1 = (_e830 * area_4);
                            let _e832 = sum_diag_pu;
                            sum_diag_pu = (_e832 + div_coeff_x_1);
                            let _e834 = sum_diag_pv;
                            sum_diag_pv = (_e834 + div_coeff_y_1);
                            let d_p_own_1 = state[((idx * 8u) + 3u)];
                            let _e845 = constants.density;
                            let _e852 = state[((idx * 8u) + 3u)];
                            let pressure_coeff_cell = (_e845 * _e852);
                            let lapl_coeff_1 = ((pressure_coeff_cell * area_4) / dist_3);
                            let _e856 = sum_diag_pp;
                            sum_diag_pp = (_e856 + lapl_coeff_1);
                            let scalar_coeff_1 = ((pressure_coeff_cell * area_4) / dist_3);
                            let _e860 = scalar_diag_p;
                            scalar_diag_p = (_e860 + scalar_coeff_1);
                        }
                    }
                }
            }
    ...
    let diag_rank = (scalar_diag_idx - scalar_offset);
    let _e876 = diag_u;
    matrix_values[((start_row_0_ + (3u * diag_rank)) + 0u)] = _e876;
    matrix_values[((start_row_0_ + (3u * diag_rank)) + 1u)] = 0f;
    let _e892 = sum_diag_up;
    matrix_values[((start_row_0_ + (3u * diag_rank)) + 2u)] = _e892;
    matrix_values[((start_row_1_ + (3u * diag_rank)) + 0u)] = 0f;
    let _e908 = diag_v;
    matrix_values[((start_row_1_ + (3u * diag_rank)) + 1u)] = _e908;
    let _e916 = sum_diag_vp;
    matrix_values[((start_row_1_ + (3u * diag_rank)) + 2u)] = _e916;
    let _e924 = sum_diag_pu;
    matrix_values[((start_row_2_ + (3u * diag_rank)) + 0u)] = _e924;
    let _e932 = sum_diag_pv;
    matrix_values[((start_row_2_ + (3u * diag_rank)) + 1u)] = _e932;
    let _e941 = diag_p;
    let _e942 = sum_diag_pp;
    matrix_values[((start_row_2_ + (3u * diag_rank)) + 2u)] = (_e941 + _e942);
    let _e950 = rhs_u;
    rhs[((idx * 3u) + 0u)] = _e950;
    let _e957 = rhs_v;
    rhs[((idx * 3u) + 1u)] = _e957;
    let _e964 = rhs_p;
    rhs[((idx * 3u) + 2u)] = _e964;
    let _e967 = scalar_diag_p;
    scalar_matrix_values[scalar_diag_idx] = _e967;
    let _e970 = diag_u;
    let _e971 = safe_inverse(_e970);
    diag_u_inv[idx] = _e971;
    let _e974 = diag_v;
    let _e975 = safe_inverse(_e974);
    diag_v_inv[idx] = _e975;
    let _e978 = scalar_diag_p;
    let _e979 = safe_inverse(_e978);
    diag_p_inv[idx] = _e979;
    return;
}
"#;
    }
