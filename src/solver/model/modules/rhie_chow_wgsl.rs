...
pub fn generate_rhie_chow_correct_velocity_delta_wgsl(
    ...
    module.push(Item::Comment("DO NOT EDIT MANUALLY".to_string()));
    module.extend(rhie_chow_base_items());
    module.push(Item::Function(rhie_chow_correct_velocity_delta_main_fn(params)));
    KernelWgsl::from(module)
}
...
fn rhie_chow_correct_velocity_delta_main_fn(params: RhieChowCorrectVelocityDeltaParams) -> Function {
    Function::new(
        "main",
        main_params(),
        None,
...
fn rhie_chow_correct_velocity_delta_main_body(params: RhieChowCorrectVelocityDeltaParams) -> Block {
    ...
    stmts.push(dsl::let_expr(
        "d_p",
        dsl::array_access("state", Expr::ident("base") + Expr::lit_u32(params.d_p_offset)),
    ));
    stmts.push(dsl::let_expr(
        "grad_px",
        dsl::array_access(
    ...
    stmts.push(dsl::assign_expr(
        dsl::array_access("state", Expr::ident("base") + Expr::lit_u32(params.u_x_offset)),
        dsl::array_access("state", Expr::ident("base") + Expr::lit_u32(params.u_x_offset))
            - Expr::ident("corr_x"),
    ));
    stmts.push(dsl::assign_expr(
        dsl::array_access("state", Expr::ident("base") + Expr::lit_u32(params.u_y_offset)),
        dsl::array_access("state", Expr::ident("base") + Expr::lit_u32(params.u_y_offset))
            - Expr::ident("corr_y"),
    ));
