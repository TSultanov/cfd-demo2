...
- Gap 0 cleanup: removed solver-side binding aliasing for low-Mach params (`low_mach`), so buffer resolution is driven by reflected WGSL binding names; OpenFOAM reference tests pass.
