...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    diag_1 -= state[idx * 23u + 22u] * vol;
    diag_2 -= state[idx * 23u + 22u] * vol;
    diag_4 -= (-(state[idx * 23u + 0u] * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) + -(constants.eos_gauge_rho_ref * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)))) * vol;
    diag_5 -= (-(state[idx * 23u + 0u] * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) + -(constants.eos_gauge_rho_ref * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)))) * vol;
    ...
    matrix_values[start_row_6 + diag_rank * 8u + 0u] -= 0.5 * constants.eos_gm1 * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)) * dot(vec2<f32>(state[idx * 23u + 10u], state[idx * 23u + 11u]), vec2<f32>(state[idx * 23u + 10u], state[idx * 23u + 11u])) * vol;
    ...
    diag_7 -= (state[idx * 23u + 0u] * constants.eos_r * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0)) + constants.eos_gauge_rho_ref * constants.eos_r * (1.0 / select(constants.dt, constants.dtau, constants.dtau > 0.0))) * vol;
