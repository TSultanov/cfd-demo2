...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k = 0u; k < 4u; k++) {
        ...
        let s_own_p = bc_neighbor_scalar(state[owner * 9u + 2u], state[owner * 9u + 2u], bc_kind[sfd_face_id * 3u + 2u], bc_value[sfd_face_id * 3u + 2u], d_own, is_boundary);
