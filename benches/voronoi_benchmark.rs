use cfd2::solver::mesh::{generate_voronoi_mesh, BackwardsStep};
use criterion::{black_box, criterion_group, criterion_main, Criterion};
use nalgebra::Vector2;

fn voronoi_benchmark_005(c: &mut Criterion) {
    ...
    c.bench_function("generate_voronoi_mesh_0.005", |b| {
        b.iter(|| {
...
criterion_group!(benches, voronoi_benchmark_005);
