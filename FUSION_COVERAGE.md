...
| `incompressible_momentum` | 8 | 4 | 6 | 0 | 2 | 3 | 0 |
...
|---|---|---|---|---|---|---|---|
| `generic_coupled_assembly -> generic_coupled_assembly_grad_state` | Assembly | Cells | DSL + DSL | - | yes | yes | - |
| `generic_coupled_update -> dp_init` | Update | Cells | DSL + DSL | - | no (fusion rejected: launch semantics mismatch between 'generic_coupled_update' and 'dp_init') | no (fusion rejected: launch semantics mismatch between 'generic_coupled_update' and 'dp_init') | - |
