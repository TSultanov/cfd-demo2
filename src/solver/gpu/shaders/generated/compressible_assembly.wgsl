...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var face_offset = start; face_offset < end; face_offset++) {
        ...
        if (!is_boundary) {
            ...
            matrix_values[start_row_1 + 4u * neighbor_rank + 0u] = ((dp_drho_r * normal.x - u_r_x * u_n_r) * a_r + -u_r_x * inv_rho_r * -mu_over_dist) * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 1u] = ((u_n_r + normal.x * (u_r_x + dp_dru_r)) * a_r + inv_rho_r * -mu_over_dist + a_prod_scaled) * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 2u] = (u_r_x * normal.y + dp_drv_r * normal.x) * a_r * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 3u] = dp_dre_r * normal.x * a_r * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 0u] = ((dp_drho_r * normal.y - u_r_y * u_n_r) * a_r + -u_r_y * inv_rho_r * -mu_over_dist) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 1u] = (u_r_y * normal.x + dp_dru_r * normal.y) * a_r * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 2u] = ((u_n_r + normal.y * (u_r_y + dp_drv_r)) * a_r + inv_rho_r * -mu_over_dist + a_prod_scaled) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 3u] = dp_dre_r * normal.y * a_r * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 0u] = (u_n_r * (dp_drho_r - H_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).x) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 1u] = ((H_r * normal.x + dp_dru_r * u_n_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).y) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 2u] = ((H_r * normal.y + dp_drv_r * u_n_r) * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).z) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 3u] = (1.4 * u_n_r * a_r + ((vec4<f32>(-u_r_x * inv_rho_r * -mu_over_dist * u_face_vec.x + -u_r_y * inv_rho_r * -mu_over_dist * u_face_vec.y, inv_rho_r * -mu_over_dist * u_face_vec.x, inv_rho_r * -mu_over_dist * u_face_vec.y, 0.0) + vec4<f32>(-u_r_x * inv_rho_r * 0.5 * diff_u_vec.x + -u_r_y * inv_rho_r * 0.5 * diff_u_vec.y, inv_rho_r * 0.5 * diff_u_vec.x, inv_rho_r * 0.5 * diff_u_vec.y, 0.0))).w + a_prod_scaled) * area;
