...
| `incompressible_momentum` | 4 | 8 | 3 | 3 | 1 | 2 | 1 |
...
| `rhie_chow/store_grad_p -> rhie_chow/grad_p_update` | Update | Cells | DSL + DSL | - | no (fusion rejected: WAR hazard at kernel 'rhie_chow/grad_p_update') | yes | aggressive-only opportunity |
| `rhie_chow/grad_p_update -> rhie_chow/correct_velocity_delta` | Update | Cells | DSL + DSL | - | no (fusion rejected: RAW hazard at kernel 'rhie_chow/correct_velocity_delta') | yes | aggressive-only opportunity |
