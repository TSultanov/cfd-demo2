// GENERATED BY CFD2 DSL FUSION (rhie_chow/grad_p_update_correct_velocity_delta_fused)
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    state[base + 0u] = state[base + 0u] - k1_corr_x;
    state[base + 1u] = state[base + 1u] - k1_corr_y;
