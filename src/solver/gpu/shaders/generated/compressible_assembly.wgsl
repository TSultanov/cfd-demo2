...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var face_offset = start; face_offset < end; face_offset++) {
        ...
        if (!is_boundary) {
            ...
            matrix_values[start_row_0 + 4u * neighbor_rank + 1u] = a_r * normal.x * area;
            matrix_values[start_row_0 + 4u * neighbor_rank + 2u] = a_r * normal.y * area;
            matrix_values[start_row_0 + 4u * neighbor_rank + 3u] = 0.0 * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 0u] = (a_r * A_r_10 + d_diff_x_r_rho) * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 1u] = (a_r * A_r_11 + a_prod_scaled + d_diff_x_r_ru) * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 2u] = (a_r * A_r_12 + d_diff_x_r_rv) * area;
            matrix_values[start_row_1 + 4u * neighbor_rank + 3u] = (a_r * A_r_13 + d_diff_x_r_re) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 0u] = (a_r * A_r_20 + d_diff_y_r_rho) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 1u] = (a_r * A_r_21 + d_diff_y_r_ru) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 2u] = (a_r * A_r_22 + a_prod_scaled + d_diff_y_r_rv) * area;
            matrix_values[start_row_2 + 4u * neighbor_rank + 3u] = (a_r * A_r_23 + d_diff_y_r_re) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 0u] = (a_r * A_r_30 + d_e_visc_r_rho) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 1u] = (a_r * A_r_31 + d_e_visc_r_ru) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 2u] = (a_r * A_r_32 + d_e_visc_r_rv) * area;
            matrix_values[start_row_3 + 4u * neighbor_rank + 3u] = (a_r * A_r_33 + a_prod_scaled + d_e_visc_r_re) * area;
            diag_00 += (0.0 - a_prod_scaled) * area;
            diag_01 += a_l * normal.x * area;
            diag_02 += a_l * normal.y * area;
            diag_03 += 0.0 * area;
            diag_10 += (a_l * A_l_10 + d_diff_x_l_rho) * area;
            diag_11 += (a_l * A_l_11 - a_prod_scaled + d_diff_x_l_ru) * area;
            diag_12 += (a_l * A_l_12 + d_diff_x_l_rv) * area;
            diag_13 += (a_l * A_l_13 + d_diff_x_l_re) * area;
            diag_20 += (a_l * A_l_20 + d_diff_y_l_rho) * area;
            diag_21 += (a_l * A_l_21 + d_diff_y_l_ru) * area;
            diag_22 += (a_l * A_l_22 - a_prod_scaled + d_diff_y_l_rv) * area;
            diag_23 += (a_l * A_l_23 + d_diff_y_l_re) * area;
            diag_30 += (a_l * A_l_30 + d_e_visc_l_rho) * area;
            diag_31 += (a_l * A_l_31 + d_e_visc_l_ru) * area;
            diag_32 += (a_l * A_l_32 + d_e_visc_l_rv) * area;
            diag_33 += (a_l * A_l_33 - a_prod_scaled + d_e_visc_l_re) * area;
        } else {
            if (boundary_type == 1u) {
                ...
                if (boundary_type == 3u) {
                    ...
                    diag_01 += (a_l * normal.x + a_r * normal.x * r11 + a_r * normal.y * r21) * area;
                    diag_02 += (a_l * normal.y + a_r * normal.x * r12 + a_r * normal.y * r22) * area;
                    diag_03 += (0.0 + 0.0) * area;
                    diag_10 += (a_l * A_l_10 + d_diff_x_l_rho + a_r * A_r_10 + d_diff_x_r_rho) * area;
                    diag_11 += (a_l * A_l_11 - a_prod_scaled + d_diff_x_l_ru + (a_r * A_r_11 + a_prod_scaled + d_diff_x_r_ru) * r11 + (a_r * A_r_12 + d_diff_x_r_rv) * r21) * area;
                    diag_12 += (a_l * A_l_12 + d_diff_x_l_rv + (a_r * A_r_11 + a_prod_scaled + d_diff_x_r_ru) * r12 + (a_r * A_r_12 + d_diff_x_r_rv) * r22) * area;
                    diag_13 += (a_l * A_l_13 + d_diff_x_l_re + a_r * A_r_13 + d_diff_x_r_re) * area;
                    diag_20 += (a_l * A_l_20 + d_diff_y_l_rho + a_r * A_r_20 + d_diff_y_r_rho) * area;
                    diag_21 += (a_l * A_l_21 + d_diff_y_l_ru + (a_r * A_r_21 + d_diff_y_r_ru) * r11 + (a_r * A_r_22 + a_prod_scaled + d_diff_y_r_rv) * r21) * area;
                    diag_22 += (a_l * A_l_22 - a_prod_scaled + d_diff_y_l_rv + (a_r * A_r_21 + d_diff_y_r_ru) * r12 + (a_r * A_r_22 + a_prod_scaled + d_diff_y_r_rv) * r22) * area;
                    diag_23 += (a_l * A_l_23 + d_diff_y_l_re + a_r * A_r_23 + d_diff_y_r_re) * area;
                    diag_30 += (a_l * A_l_30 + d_e_visc_l_rho + a_r * A_r_30 + d_e_visc_r_rho) * area;
                    diag_31 += (a_l * A_l_31 + d_e_visc_l_ru + (a_r * A_r_31 + d_e_visc_r_ru) * r11 + (a_r * A_r_32 + d_e_visc_r_rv) * r21) * area;
                    diag_32 += (a_l * A_l_32 + d_e_visc_l_rv + (a_r * A_r_31 + d_e_visc_r_ru) * r12 + (a_r * A_r_32 + d_e_visc_r_rv) * r22) * area;
                    diag_33 += (a_l * A_l_33 - a_prod_scaled + d_e_visc_l_re + a_r * A_r_33 + a_prod_scaled + d_e_visc_r_re) * area;
                } else {
                    diag_00 += (0.0 - a_prod_scaled + a_prod_scaled) * area;
                    diag_01 += (a_l * normal.x + a_r * normal.x) * area;
                    diag_02 += (a_l * normal.y + a_r * normal.y) * area;
                    diag_03 += (0.0 + 0.0) * area;
                    diag_10 += (a_l * A_l_10 + d_diff_x_l_rho + a_r * A_r_10 + d_diff_x_r_rho) * area;
                    diag_11 += (a_l * A_l_11 - a_prod_scaled + d_diff_x_l_ru + a_r * A_r_11 + a_prod_scaled + d_diff_x_r_ru) * area;
                    diag_12 += (a_l * A_l_12 + d_diff_x_l_rv + a_r * A_r_12 + d_diff_x_r_rv) * area;
                    diag_13 += (a_l * A_l_13 + d_diff_x_l_re + a_r * A_r_13 + d_diff_x_r_re) * area;
                    diag_20 += (a_l * A_l_20 + d_diff_y_l_rho + a_r * A_r_20 + d_diff_y_r_rho) * area;
                    diag_21 += (a_l * A_l_21 + d_diff_y_l_ru + a_r * A_r_21 + d_diff_y_r_ru) * area;
                    diag_22 += (a_l * A_l_22 - a_prod_scaled + d_diff_y_l_rv + a_r * A_r_22 + a_prod_scaled + d_diff_y_r_rv) * area;
                    diag_23 += (a_l * A_l_23 + d_diff_y_l_re + a_r * A_r_23 + d_diff_y_r_re) * area;
                    diag_30 += (a_l * A_l_30 + d_e_visc_l_rho + a_r * A_r_30 + d_e_visc_r_rho) * area;
                    diag_31 += (a_l * A_l_31 + d_e_visc_l_ru + a_r * A_r_31 + d_e_visc_r_ru) * area;
                    diag_32 += (a_l * A_l_32 + d_e_visc_l_rv + a_r * A_r_32 + d_e_visc_r_rv) * area;
                    diag_33 += (a_l * A_l_33 - a_prod_scaled + d_e_visc_l_re + a_r * A_r_33 + a_prod_scaled + d_e_visc_r_re) * area;
                }
            }
        }
