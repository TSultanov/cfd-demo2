...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k = 0u; k < 4u; k++) {
        ...
        grad_acc_0 += normal_vec * ((state[idx * 9u + 0u] * lambda + select(state[other_idx * 9u + 0u], select(select(state[idx * 9u + 0u], bc_value[face_idx * 3u + 0u], bc_kind[face_idx * 3u + 0u] == 1u), state[idx * 9u + 0u] + bc_value[face_idx * 3u + 0u] * d_own, bc_kind[face_idx * 3u + 0u] == 2u), is_boundary) * lambda_other) * area);
        grad_acc_1 += normal_vec * ((state[idx * 9u + 1u] * lambda + select(state[other_idx * 9u + 1u], select(select(state[idx * 9u + 1u], bc_value[face_idx * 3u + 1u], bc_kind[face_idx * 3u + 1u] == 1u), state[idx * 9u + 1u] + bc_value[face_idx * 3u + 1u] * d_own, bc_kind[face_idx * 3u + 1u] == 2u), is_boundary) * lambda_other) * area);
        grad_acc_2 += normal_vec * ((state[idx * 9u + 2u] * lambda + select(state[other_idx * 9u + 2u], select(select(state[idx * 9u + 2u], bc_value[face_idx * 3u + 2u], bc_kind[face_idx * 3u + 2u] == 1u), state[idx * 9u + 2u] + bc_value[face_idx * 3u + 2u] * d_own, bc_kind[face_idx * 3u + 2u] == 2u), is_boundary) * lambda_other) * area);
    }
