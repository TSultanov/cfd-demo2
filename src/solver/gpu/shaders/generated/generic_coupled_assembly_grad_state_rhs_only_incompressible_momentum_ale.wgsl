...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k = start; k < end; k++) {
        ...
        let dev2_U_U_gx = (vec2<f32>(grad_state[idx * 8u + 0u].x, grad_state[idx * 8u + 0u].y) + vec2<f32>(grad_state[other_idx * 8u + 0u].x, grad_state[other_idx * 8u + 0u].y)) * 0.5;
        let dev2_U_U_gy = (vec2<f32>(grad_state[idx * 8u + 1u].x, grad_state[idx * 8u + 1u].y) + vec2<f32>(grad_state[other_idx * 8u + 1u].x, grad_state[other_idx * 8u + 1u].y)) * 0.5;
