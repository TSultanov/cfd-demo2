...
// SourceHash: 448bc5975858240cfa0f3cbe9fcff457a674a5cdf765cb6775374bfce74e6740
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let base = (idx * 4u);
    let _e737 = flux_rho;
    fluxes[(base + 0u)] = (_e737 * area);
    let _e744 = flux_rho_u.x;
    fluxes[(base + 1u)] = (_e744 * area);
    let _e751 = flux_rho_u.y;
    fluxes[(base + 2u)] = (_e751 * area);
    let _e757 = flux_rho_e;
    fluxes[(base + 3u)] = (_e757 * area);
    return;
}
"#;
    }
