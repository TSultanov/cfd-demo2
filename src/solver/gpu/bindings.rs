...
// SourceHash: 21e35f8165e69d5b3fa620f6f60202243564ceaab7f9d07703b43135d70f56d5
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    loop {
        ...
        }
        {
            ...
            let _e459 = rho_r;
            let f_rho_r = (_e459 * u_n_r);
            let _e464 = rho_r;
            let flux_rho = ((((a_plus * f_rho_l) - (a_minus * f_rho_r)) + (a_prod * (_e464 - rho_l))) / denom);
            let _e472 = normal.x;
            let f_rho_u_l_x = ((rho_u_l.x * u_n_l) + (p_l * _e472));
            let _e478 = normal.y;
            let f_rho_u_l_y = ((rho_u_l.y * u_n_l) + (p_l * _e478));
            let _e482 = rho_u_r.x;
            let _e485 = normal.x;
            let f_rho_u_r_x = ((_e482 * u_n_r) + (p_r * _e485));
            let _e489 = rho_u_r.y;
            let _e492 = normal.y;
            let f_rho_u_r_y = ((_e489 * u_n_r) + (p_r * _e492));
            let _e499 = rho_u_r.x;
            flux_rho_u_x = ((((a_plus * f_rho_u_l_x) - (a_minus * f_rho_u_r_x)) + (a_prod * (_e499 - rho_u_l.x))) / denom);
            let _e510 = rho_u_r.y;
            flux_rho_u_y = ((((a_plus * f_rho_u_l_y) - (a_minus * f_rho_u_r_y)) + (a_prod * (_e510 - rho_u_l.y))) / denom);
            let diff_u_x = ((-(mu) * (u_r_x - u_l_x)) / dist);
            let diff_u_y = ((-(mu) * (u_r_y - u_l_y)) / dist);
            let _e525 = flux_rho_u_x;
            flux_rho_u_x = (_e525 + diff_u_x);
            let _e527 = flux_rho_u_y;
            flux_rho_u_y = (_e527 + diff_u_y);
            let f_rho_e_l = ((rho_e_l + p_l) * u_n_l);
            let _e531 = rho_e_r;
            let f_rho_e_r = ((_e531 + p_r) * u_n_r);
            let _e537 = rho_e_r;
            flux_rho_e = ((((a_plus * f_rho_e_l) - (a_minus * f_rho_e_r)) + (a_prod * (_e537 - rho_e_l))) / denom);
            let _e543 = flux_rho_e;
            flux_rho_e = ((_e543 + (diff_u_x * u_face_x)) + (diff_u_y * u_face_y));
            let _e550 = sum_rho;
            sum_rho = (_e550 + (flux_rho * area));
            let _e553 = flux_rho_u_x;
            let _e555 = sum_rho_u_x;
            sum_rho_u_x = (_e555 + (_e553 * area));
            let _e558 = flux_rho_u_y;
            let _e560 = sum_rho_u_y;
            sum_rho_u_y = (_e560 + (_e558 * area));
            let _e563 = flux_rho_e;
            let _e565 = sum_rho_e;
            sum_rho_e = (_e565 + (_e563 * area));
            ...
            jac_r_03_ = 0f;
            let _e620 = normal.x;
            let A_l_10_ = ((-(u_l_x) * u_n_l) + (dp_drho_l * _e620));
            let _e624 = normal.x;
            let _e628 = normal.x;
            let A_l_11_ = ((u_n_l + (u_l_x * _e624)) + (dp_dru_l * _e628));
            let _e632 = normal.y;
            let _e635 = normal.x;
            let A_l_12_ = ((u_l_x * _e632) + (dp_drv_l * _e635));
            let _e640 = normal.x;
            let A_l_13_ = (0.4f * _e640);
            let _e645 = normal.y;
            let A_l_20_ = ((-(u_l_y) * u_n_l) + (dp_drho_l * _e645));
            let _e649 = normal.x;
            let _e652 = normal.y;
            let A_l_21_ = ((u_l_y * _e649) + (dp_dru_l * _e652));
            let _e656 = normal.y;
            let _e660 = normal.y;
            let A_l_22_ = ((u_n_l + (u_l_y * _e656)) + (dp_drv_l * _e660));
            let _e664 = normal.y;
            let A_l_23_ = (0.4f * _e664);
            let A_l_30_ = ((-(H_l) * u_n_l) + (dp_drho_l * u_n_l));
            let _e671 = normal.x;
            let A_l_31_ = ((H_l * _e671) + (dp_dru_l * u_n_l));
            let _e676 = normal.y;
            let A_l_32_ = ((H_l * _e676) + (dp_drv_l * u_n_l));
            let A_l_33_ = (1.4f * u_n_l);
            let _e685 = normal.x;
            let A_r_10_ = ((-(u_r_x) * u_n_r) + (dp_drho_r * _e685));
            let _e689 = normal.x;
            let _e693 = normal.x;
            let A_r_11_ = ((u_n_r + (u_r_x * _e689)) + (dp_dru_r * _e693));
            let _e697 = normal.y;
            let _e700 = normal.x;
            let A_r_12_ = ((u_r_x * _e697) + (dp_drv_r * _e700));
            let _e705 = normal.x;
            let A_r_13_ = (0.4f * _e705);
            let _e710 = normal.y;
            let A_r_20_ = ((-(u_r_y) * u_n_r) + (dp_drho_r * _e710));
            let _e714 = normal.x;
            let _e717 = normal.y;
            let A_r_21_ = ((u_r_y * _e714) + (dp_dru_r * _e717));
            let _e721 = normal.y;
            let _e725 = normal.y;
            let A_r_22_ = ((u_n_r + (u_r_y * _e721)) + (dp_drv_r * _e725));
            let _e729 = normal.y;
            let A_r_23_ = (0.4f * _e729);
            let A_r_30_ = ((-(H_r) * u_n_r) + (dp_drho_r * u_n_r));
            let _e736 = normal.x;
            let A_r_31_ = ((H_r * _e736) + (dp_dru_r * u_n_r));
            let _e741 = normal.y;
            let A_r_32_ = ((H_r * _e741) + (dp_drv_r * u_n_r));
            ...
            let _e822 = jac_l_10_;
            jac_l_10_ = (_e822 + d_diff_x_l_rho);
            let _e824 = jac_l_11_;
            jac_l_11_ = (_e824 + d_diff_x_l_ru);
            let _e827 = jac_l_12_;
            jac_l_12_ = (_e827 + 0f);
            let _e830 = jac_l_13_;
            jac_l_13_ = (_e830 + 0f);
            let _e832 = jac_l_20_;
            jac_l_20_ = (_e832 + d_diff_y_l_rho);
            let _e835 = jac_l_21_;
            jac_l_21_ = (_e835 + 0f);
            let _e837 = jac_l_22_;
            jac_l_22_ = (_e837 + d_diff_y_l_rv);
            let _e840 = jac_l_23_;
            jac_l_23_ = (_e840 + 0f);
            let _e842 = jac_r_10_;
            jac_r_10_ = (_e842 + d_diff_x_r_rho);
            let _e844 = jac_r_11_;
            jac_r_11_ = (_e844 + d_diff_x_r_ru);
            let _e847 = jac_r_12_;
            jac_r_12_ = (_e847 + 0f);
            let _e850 = jac_r_13_;
            jac_r_13_ = (_e850 + 0f);
            let _e852 = jac_r_20_;
            jac_r_20_ = (_e852 + d_diff_y_r_rho);
            let _e855 = jac_r_21_;
            jac_r_21_ = (_e855 + 0f);
            let _e857 = jac_r_22_;
            jac_r_22_ = (_e857 + d_diff_y_r_rv);
            let _e860 = jac_r_23_;
            jac_r_23_ = (_e860 + 0f);
            ...
            let _e942 = jac_l_30_;
            jac_l_30_ = (_e942 + d_e_visc_l_rho);
            let _e944 = jac_l_31_;
            jac_l_31_ = (_e944 + d_e_visc_l_ru);
            let _e946 = jac_l_32_;
            jac_l_32_ = (_e946 + d_e_visc_l_rv);
            let _e948 = jac_l_33_;
            jac_l_33_ = (_e948 + d_e_visc_l_re);
            let _e950 = jac_r_30_;
            jac_r_30_ = (_e950 + d_e_visc_r_rho);
            let _e952 = jac_r_31_;
            jac_r_31_ = (_e952 + d_e_visc_r_ru);
            let _e954 = jac_r_32_;
            jac_r_32_ = (_e954 + d_e_visc_r_rv);
            let _e956 = jac_r_33_;
            jac_r_33_ = (_e956 + d_e_visc_r_re);
            let _e958 = is_boundary;
            if !(_e958) {
                let _e961 = face_offset;
                let scalar_mat_idx = cell_face_matrix_indices[_e961];
                neighbor_rank = 0u;
                ...
                let _e971 = neighbor_rank;
                let base_0_ = (start_row_0_ + (4u * _e971));
                let _e975 = neighbor_rank;
                let base_1_ = (start_row_1_ + (4u * _e975));
                let _e979 = neighbor_rank;
                let base_2_ = (start_row_2_ + (4u * _e979));
                let _e983 = neighbor_rank;
                let base_3_ = (start_row_3_ + (4u * _e983));
                if (scheme_id != 0u) {
                    phi_upwind_rho = rho_l;
                    if (flux_adv < 0f) {
                        let _e991 = rho_r;
                        phi_upwind_rho = _e991;
                    }
                    let _e992 = phi_upwind_rho;
                    phi_ho_rho = _e992;
                    if (scheme_id == 1u) {
                        if (flux_adv > 0f) {
                            let r_rho_x = (f_center.x - center.x);
                            let r_rho_y = (f_center.y - center.y);
                            let _e1007 = grad_rho[idx].x;
                            let _e1013 = grad_rho[idx].y;
                            phi_ho_rho = ((rho_l + (_e1007 * r_rho_x)) + (_e1013 * r_rho_y));
                        } else {
                            let _e1018 = center_r.x;
                            let r_rho_x_1 = (f_center.x - _e1018);
                            let _e1022 = center_r.y;
                            let r_rho_y_1 = (f_center.y - _e1022);
                            let _e1024 = rho_r;
                            let _e1026 = other_idx;
                            let _e1029 = grad_rho[_e1026].x;
                            let _e1033 = other_idx;
                            let _e1036 = grad_rho[_e1033].y;
                            phi_ho_rho = ((_e1024 + (_e1029 * r_rho_x_1)) + (_e1036 * r_rho_y_1));
                        }
                    } else {
                        if (scheme_id == 2u) {
                            if (flux_adv > 0f) {
                                let _e1044 = center_r.x;
                                let d_cd_rho_x = (_e1044 - center.x);
                                let _e1048 = center_r.y;
                                let d_cd_rho_y = (_e1048 - center.y);
                                let _e1054 = grad_rho[idx].x;
                                let _e1059 = grad_rho[idx].y;
                                let grad_term_rho = ((_e1054 * d_cd_rho_x) + (_e1059 * d_cd_rho_y));
                                let _e1064 = rho_r;
                                phi_ho_rho = (((0.625f * rho_l) + (0.375f * _e1064)) + (0.125f * grad_term_rho));
                            } else {
                                let _e1073 = center_r.x;
                                let d_cd_rho_x_1 = (center.x - _e1073);
                                let _e1077 = center_r.y;
                                let d_cd_rho_y_1 = (center.y - _e1077);
                                let _e1080 = other_idx;
                                let _e1083 = grad_rho[_e1080].x;
                                let _e1086 = other_idx;
                                let _e1089 = grad_rho[_e1086].y;
                                let grad_term_rho_1 = ((_e1083 * d_cd_rho_x_1) + (_e1089 * d_cd_rho_y_1));
                                let _e1092 = rho_r;
                                phi_ho_rho = (((0.625f * _e1092) + (0.375f * rho_l)) + (0.125f * grad_term_rho_1));
                            }
                        }
                    }
                    phi_upwind_ru = rho_u_l.x;
                    if (flux_adv < 0f) {
                        let _e1106 = rho_u_r.x;
                        phi_upwind_ru = _e1106;
                    }
                    let _e1107 = phi_upwind_ru;
                    phi_ho_ru = _e1107;
                    if (scheme_id == 1u) {
                        if (flux_adv > 0f) {
                            let r_ru_x = (f_center.x - center.x);
                            let r_ru_y = (f_center.y - center.y);
                            let _e1123 = grad_rho_u_x[idx].x;
                            let _e1129 = grad_rho_u_x[idx].y;
                            phi_ho_ru = ((rho_u_l.x + (_e1123 * r_ru_x)) + (_e1129 * r_ru_y));
                        } else {
                            let _e1134 = center_r.x;
                            let r_ru_x_1 = (f_center.x - _e1134);
                            let _e1138 = center_r.y;
                            let r_ru_y_1 = (f_center.y - _e1138);
                            let _e1141 = rho_u_r.x;
                            let _e1143 = other_idx;
                            let _e1146 = grad_rho_u_x[_e1143].x;
                            let _e1150 = other_idx;
                            let _e1153 = grad_rho_u_x[_e1150].y;
                            phi_ho_ru = ((_e1141 + (_e1146 * r_ru_x_1)) + (_e1153 * r_ru_y_1));
                        }
                    } else {
                        if (scheme_id == 2u) {
                            if (flux_adv > 0f) {
                                let _e1161 = center_r.x;
                                let d_cd_ru_x = (_e1161 - center.x);
                                let _e1165 = center_r.y;
                                let d_cd_ru_y = (_e1165 - center.y);
                                let _e1171 = grad_rho_u_x[idx].x;
                                let _e1176 = grad_rho_u_x[idx].y;
                                let grad_term_ru = ((_e1171 * d_cd_ru_x) + (_e1176 * d_cd_ru_y));
                                let _e1183 = rho_u_r.x;
                                phi_ho_ru = (((0.625f * rho_u_l.x) + (0.375f * _e1183)) + (0.125f * grad_term_ru));
                            } else {
                                let _e1192 = center_r.x;
                                let d_cd_ru_x_1 = (center.x - _e1192);
                                let _e1196 = center_r.y;
                                let d_cd_ru_y_1 = (center.y - _e1196);
                                let _e1199 = other_idx;
                                let _e1202 = grad_rho_u_x[_e1199].x;
                                let _e1205 = other_idx;
                                let _e1208 = grad_rho_u_x[_e1205].y;
                                let grad_term_ru_1 = ((_e1202 * d_cd_ru_x_1) + (_e1208 * d_cd_ru_y_1));
                                let _e1212 = rho_u_r.x;
                                phi_ho_ru = (((0.625f * _e1212) + (0.375f * rho_u_l.x)) + (0.125f * grad_term_ru_1));
                            }
                        }
                    }
                    phi_upwind_rv = rho_u_l.y;
                    if (flux_adv < 0f) {
                        let _e1227 = rho_u_r.y;
                        phi_upwind_rv = _e1227;
                    }
                    let _e1228 = phi_upwind_rv;
                    phi_ho_rv = _e1228;
                    if (scheme_id == 1u) {
                        if (flux_adv > 0f) {
                            let r_rv_x = (f_center.x - center.x);
                            let r_rv_y = (f_center.y - center.y);
                            let _e1244 = grad_rho_u_y[idx].x;
                            let _e1250 = grad_rho_u_y[idx].y;
                            phi_ho_rv = ((rho_u_l.y + (_e1244 * r_rv_x)) + (_e1250 * r_rv_y));
                        } else {
                            let _e1255 = center_r.x;
                            let r_rv_x_1 = (f_center.x - _e1255);
                            let _e1259 = center_r.y;
                            let r_rv_y_1 = (f_center.y - _e1259);
                            let _e1262 = rho_u_r.y;
                            let _e1264 = other_idx;
                            let _e1267 = grad_rho_u_y[_e1264].x;
                            let _e1271 = other_idx;
                            let _e1274 = grad_rho_u_y[_e1271].y;
                            phi_ho_rv = ((_e1262 + (_e1267 * r_rv_x_1)) + (_e1274 * r_rv_y_1));
                        }
                    } else {
                        if (scheme_id == 2u) {
                            if (flux_adv > 0f) {
                                let _e1282 = center_r.x;
                                let d_cd_rv_x = (_e1282 - center.x);
                                let _e1286 = center_r.y;
                                let d_cd_rv_y = (_e1286 - center.y);
                                let _e1292 = grad_rho_u_y[idx].x;
                                let _e1297 = grad_rho_u_y[idx].y;
                                let grad_term_rv = ((_e1292 * d_cd_rv_x) + (_e1297 * d_cd_rv_y));
                                let _e1304 = rho_u_r.y;
                                phi_ho_rv = (((0.625f * rho_u_l.y) + (0.375f * _e1304)) + (0.125f * grad_term_rv));
                            } else {
                                let _e1313 = center_r.x;
                                let d_cd_rv_x_1 = (center.x - _e1313);
                                let _e1317 = center_r.y;
                                let d_cd_rv_y_1 = (center.y - _e1317);
                                let _e1320 = other_idx;
                                let _e1323 = grad_rho_u_y[_e1320].x;
                                let _e1326 = other_idx;
                                let _e1329 = grad_rho_u_y[_e1326].y;
                                let grad_term_rv_1 = ((_e1323 * d_cd_rv_x_1) + (_e1329 * d_cd_rv_y_1));
                                let _e1333 = rho_u_r.y;
                                phi_ho_rv = (((0.625f * _e1333) + (0.375f * rho_u_l.y)) + (0.125f * grad_term_rv_1));
                            }
                        }
                    }
                    ...
                    if (flux_adv < 0f) {
                        let _e1346 = rho_e_r;
                        phi_upwind_re = _e1346;
                    }
                    let _e1347 = phi_upwind_re;
                    phi_ho_re = _e1347;
                    if (scheme_id == 1u) {
                        if (flux_adv > 0f) {
                            let r_re_x = (f_center.x - center.x);
                            let r_re_y = (f_center.y - center.y);
                            let _e1362 = grad_rho_e[idx].x;
                            let _e1368 = grad_rho_e[idx].y;
                            phi_ho_re = ((rho_e_l + (_e1362 * r_re_x)) + (_e1368 * r_re_y));
                        } else {
                            let _e1373 = center_r.x;
                            let r_re_x_1 = (f_center.x - _e1373);
                            let _e1377 = center_r.y;
                            let r_re_y_1 = (f_center.y - _e1377);
                            let _e1379 = rho_e_r;
                            let _e1381 = other_idx;
                            let _e1384 = grad_rho_e[_e1381].x;
                            let _e1388 = other_idx;
                            let _e1391 = grad_rho_e[_e1388].y;
                            phi_ho_re = ((_e1379 + (_e1384 * r_re_x_1)) + (_e1391 * r_re_y_1));
                        }
                    } else {
                        if (scheme_id == 2u) {
                            if (flux_adv > 0f) {
                                let _e1399 = center_r.x;
                                let d_cd_re_x = (_e1399 - center.x);
                                let _e1403 = center_r.y;
                                let d_cd_re_y = (_e1403 - center.y);
                                let _e1409 = grad_rho_e[idx].x;
                                let _e1414 = grad_rho_e[idx].y;
                                let grad_term_re = ((_e1409 * d_cd_re_x) + (_e1414 * d_cd_re_y));
                                let _e1419 = rho_e_r;
                                phi_ho_re = (((0.625f * rho_e_l) + (0.375f * _e1419)) + (0.125f * grad_term_re));
                            } else {
                                let _e1428 = center_r.x;
                                let d_cd_re_x_1 = (center.x - _e1428);
                                let _e1432 = center_r.y;
                                let d_cd_re_y_1 = (center.y - _e1432);
                                let _e1435 = other_idx;
                                let _e1438 = grad_rho_e[_e1435].x;
                                let _e1441 = other_idx;
                                let _e1444 = grad_rho_e[_e1441].y;
                                let grad_term_re_1 = ((_e1438 * d_cd_re_x_1) + (_e1444 * d_cd_re_y_1));
                                let _e1447 = rho_e_r;
                                phi_ho_re = (((0.625f * _e1447) + (0.375f * rho_e_l)) + (0.125f * grad_term_re_1));
                            }
                        }
                    }
                    let _e1456 = phi_ho_rho;
                    let _e1457 = phi_upwind_rho;
                    let correction_rho = (flux_adv * (_e1456 - _e1457));
                    let _e1460 = phi_ho_ru;
                    let _e1461 = phi_upwind_ru;
                    let correction_rho_u_x = (flux_adv * (_e1460 - _e1461));
                    let _e1464 = phi_ho_rv;
                    let _e1465 = phi_upwind_rv;
                    let correction_rho_u_y = (flux_adv * (_e1464 - _e1465));
                    let _e1468 = phi_ho_re;
                    let _e1469 = phi_upwind_re;
                    let correction_rho_e = (flux_adv * (_e1468 - _e1469));
                    let _e1472 = sum_rho;
                    sum_rho = (_e1472 + correction_rho);
                    let _e1474 = sum_rho_u_x;
                    sum_rho_u_x = (_e1474 + correction_rho_u_x);
                    let _e1476 = sum_rho_u_y;
                    sum_rho_u_y = (_e1476 + correction_rho_u_y);
                    let _e1478 = sum_rho_e;
                    sum_rho_e = (_e1478 + correction_rho_e);
                }
                let _e1484 = jac_r_00_;
                matrix_values[(base_0_ + 0u)] = (_e1484 * area);
                let _e1490 = jac_r_01_;
                matrix_values[(base_0_ + 1u)] = (_e1490 * area);
                let _e1496 = jac_r_02_;
                matrix_values[(base_0_ + 2u)] = (_e1496 * area);
                let _e1502 = jac_r_03_;
                matrix_values[(base_0_ + 3u)] = (_e1502 * area);
                let _e1508 = jac_r_10_;
                matrix_values[(base_1_ + 0u)] = (_e1508 * area);
                let _e1514 = jac_r_11_;
                matrix_values[(base_1_ + 1u)] = (_e1514 * area);
                let _e1520 = jac_r_12_;
                matrix_values[(base_1_ + 2u)] = (_e1520 * area);
                let _e1526 = jac_r_13_;
                matrix_values[(base_1_ + 3u)] = (_e1526 * area);
                let _e1532 = jac_r_20_;
                matrix_values[(base_2_ + 0u)] = (_e1532 * area);
                let _e1538 = jac_r_21_;
                matrix_values[(base_2_ + 1u)] = (_e1538 * area);
                let _e1544 = jac_r_22_;
                matrix_values[(base_2_ + 2u)] = (_e1544 * area);
                let _e1550 = jac_r_23_;
                matrix_values[(base_2_ + 3u)] = (_e1550 * area);
                let _e1556 = jac_r_30_;
                matrix_values[(base_3_ + 0u)] = (_e1556 * area);
                let _e1562 = jac_r_31_;
                matrix_values[(base_3_ + 1u)] = (_e1562 * area);
                let _e1568 = jac_r_32_;
                matrix_values[(base_3_ + 2u)] = (_e1568 * area);
                let _e1574 = jac_r_33_;
                matrix_values[(base_3_ + 3u)] = (_e1574 * area);
                let _e1577 = jac_l_00_;
                let _e1579 = diag_00_;
                diag_00_ = (_e1579 + (_e1577 * area));
                let _e1582 = jac_l_01_;
                let _e1584 = diag_01_;
                diag_01_ = (_e1584 + (_e1582 * area));
                let _e1587 = jac_l_02_;
                let _e1589 = diag_02_;
                diag_02_ = (_e1589 + (_e1587 * area));
                let _e1592 = jac_l_03_;
                let _e1594 = diag_03_;
                diag_03_ = (_e1594 + (_e1592 * area));
                let _e1597 = jac_l_10_;
                let _e1599 = diag_10_;
                diag_10_ = (_e1599 + (_e1597 * area));
                let _e1602 = jac_l_11_;
                let _e1604 = diag_11_;
                diag_11_ = (_e1604 + (_e1602 * area));
                let _e1607 = jac_l_12_;
                let _e1609 = diag_12_;
                diag_12_ = (_e1609 + (_e1607 * area));
                let _e1612 = jac_l_13_;
                let _e1614 = diag_13_;
                diag_13_ = (_e1614 + (_e1612 * area));
                let _e1617 = jac_l_20_;
                let _e1619 = diag_20_;
                diag_20_ = (_e1619 + (_e1617 * area));
                let _e1622 = jac_l_21_;
                let _e1624 = diag_21_;
                diag_21_ = (_e1624 + (_e1622 * area));
                let _e1627 = jac_l_22_;
                let _e1629 = diag_22_;
                diag_22_ = (_e1629 + (_e1627 * area));
                let _e1632 = jac_l_23_;
                let _e1634 = diag_23_;
                diag_23_ = (_e1634 + (_e1632 * area));
                let _e1637 = jac_l_30_;
                let _e1639 = diag_30_;
                diag_30_ = (_e1639 + (_e1637 * area));
                let _e1642 = jac_l_31_;
                let _e1644 = diag_31_;
                diag_31_ = (_e1644 + (_e1642 * area));
                let _e1647 = jac_l_32_;
                let _e1649 = diag_32_;
                diag_32_ = (_e1649 + (_e1647 * area));
                let _e1652 = jac_l_33_;
                let _e1654 = diag_33_;
                diag_33_ = (_e1654 + (_e1652 * area));
            } else {
                let _e1656 = jac_l_00_;
                let _e1657 = jac_r_00_;
                eff_00_ = (_e1656 + _e1657);
                let _e1660 = jac_l_01_;
                let _e1661 = jac_r_01_;
                eff_01_ = (_e1660 + _e1661);
                let _e1664 = jac_l_02_;
                let _e1665 = jac_r_02_;
                eff_02_ = (_e1664 + _e1665);
                let _e1668 = jac_l_03_;
                let _e1669 = jac_r_03_;
                eff_03_ = (_e1668 + _e1669);
                let _e1672 = jac_l_10_;
                let _e1673 = jac_r_10_;
                eff_10_ = (_e1672 + _e1673);
                let _e1676 = jac_l_11_;
                let _e1677 = jac_r_11_;
                eff_11_ = (_e1676 + _e1677);
                let _e1680 = jac_l_12_;
                let _e1681 = jac_r_12_;
                eff_12_ = (_e1680 + _e1681);
                let _e1684 = jac_l_13_;
                let _e1685 = jac_r_13_;
                eff_13_ = (_e1684 + _e1685);
                let _e1688 = jac_l_20_;
                let _e1689 = jac_r_20_;
                eff_20_ = (_e1688 + _e1689);
                let _e1692 = jac_l_21_;
                let _e1693 = jac_r_21_;
                eff_21_ = (_e1692 + _e1693);
                let _e1696 = jac_l_22_;
                let _e1697 = jac_r_22_;
                eff_22_ = (_e1696 + _e1697);
                let _e1700 = jac_l_23_;
                let _e1701 = jac_r_23_;
                eff_23_ = (_e1700 + _e1701);
                let _e1704 = jac_l_30_;
                let _e1705 = jac_r_30_;
                eff_30_ = (_e1704 + _e1705);
                let _e1708 = jac_l_31_;
                let _e1709 = jac_r_31_;
                eff_31_ = (_e1708 + _e1709);
                let _e1712 = jac_l_32_;
                let _e1713 = jac_r_32_;
                eff_32_ = (_e1712 + _e1713);
                let _e1716 = jac_l_33_;
                let _e1717 = jac_r_33_;
                eff_33_ = (_e1716 + _e1717);
                if (boundary_type == 1u) {
                    let _e1722 = jac_l_00_;
                    let _e1723 = jac_r_00_;
                    let _e1725 = jac_r_01_;
                    let _e1728 = constants.inlet_velocity;
                    eff_00_ = ((_e1722 + _e1723) + (_e1725 * _e1728));
                    let _e1731 = jac_l_01_;
                    eff_01_ = _e1731;
                    let _e1732 = jac_l_02_;
                    eff_02_ = _e1732;
                    let _e1733 = jac_l_03_;
                    let _e1734 = jac_r_03_;
                    eff_03_ = (_e1733 + _e1734);
                    let _e1736 = jac_l_10_;
                    let _e1737 = jac_r_10_;
                    let _e1739 = jac_r_11_;
                    let _e1742 = constants.inlet_velocity;
                    eff_10_ = ((_e1736 + _e1737) + (_e1739 * _e1742));
                    let _e1745 = jac_l_11_;
                    eff_11_ = _e1745;
                    let _e1746 = jac_l_12_;
                    eff_12_ = _e1746;
                    let _e1747 = jac_l_13_;
                    let _e1748 = jac_r_13_;
                    eff_13_ = (_e1747 + _e1748);
                    let _e1750 = jac_l_20_;
                    let _e1751 = jac_r_20_;
                    let _e1753 = jac_r_21_;
                    let _e1756 = constants.inlet_velocity;
                    eff_20_ = ((_e1750 + _e1751) + (_e1753 * _e1756));
                    let _e1759 = jac_l_21_;
                    eff_21_ = _e1759;
                    let _e1760 = jac_l_22_;
                    eff_22_ = _e1760;
                    let _e1761 = jac_l_23_;
                    let _e1762 = jac_r_23_;
                    eff_23_ = (_e1761 + _e1762);
                    let _e1764 = jac_l_30_;
                    let _e1765 = jac_r_30_;
                    let _e1767 = jac_r_31_;
                    let _e1770 = constants.inlet_velocity;
                    eff_30_ = ((_e1764 + _e1765) + (_e1767 * _e1770));
                    let _e1773 = jac_l_31_;
                    eff_31_ = _e1773;
                    let _e1774 = jac_l_32_;
                    eff_32_ = _e1774;
                    let _e1775 = jac_l_33_;
                    let _e1776 = jac_r_33_;
                    eff_33_ = (_e1775 + _e1776);
                } else {
                    if (boundary_type == 3u) {
                        let _e1780 = jac_l_00_;
                        let _e1781 = jac_r_00_;
                        eff_00_ = (_e1780 + _e1781);
                        let _e1783 = jac_l_01_;
                        let _e1784 = jac_r_01_;
                        eff_01_ = (_e1783 - _e1784);
                        let _e1786 = jac_l_02_;
                        let _e1787 = jac_r_02_;
                        eff_02_ = (_e1786 - _e1787);
                        let _e1789 = jac_l_03_;
                        let _e1790 = jac_r_03_;
                        eff_03_ = (_e1789 + _e1790);
                        let _e1792 = jac_l_10_;
                        let _e1793 = jac_r_10_;
                        eff_10_ = (_e1792 + _e1793);
                        let _e1795 = jac_l_11_;
                        let _e1796 = jac_r_11_;
                        eff_11_ = (_e1795 - _e1796);
                        let _e1798 = jac_l_12_;
                        let _e1799 = jac_r_12_;
                        eff_12_ = (_e1798 - _e1799);
                        let _e1801 = jac_l_13_;
                        let _e1802 = jac_r_13_;
                        eff_13_ = (_e1801 + _e1802);
                        let _e1804 = jac_l_20_;
                        let _e1805 = jac_r_20_;
                        eff_20_ = (_e1804 + _e1805);
                        let _e1807 = jac_l_21_;
                        let _e1808 = jac_r_21_;
                        eff_21_ = (_e1807 - _e1808);
                        let _e1810 = jac_l_22_;
                        let _e1811 = jac_r_22_;
                        eff_22_ = (_e1810 - _e1811);
                        let _e1813 = jac_l_23_;
                        let _e1814 = jac_r_23_;
                        eff_23_ = (_e1813 + _e1814);
                        let _e1816 = jac_l_30_;
                        let _e1817 = jac_r_30_;
                        eff_30_ = (_e1816 + _e1817);
                        let _e1819 = jac_l_31_;
                        let _e1820 = jac_r_31_;
                        eff_31_ = (_e1819 - _e1820);
                        let _e1822 = jac_l_32_;
                        let _e1823 = jac_r_32_;
                        eff_32_ = (_e1822 - _e1823);
                        let _e1825 = jac_l_33_;
                        let _e1826 = jac_r_33_;
                        eff_33_ = (_e1825 + _e1826);
                    }
                }
                let _e1828 = eff_00_;
                let _e1830 = diag_00_;
                diag_00_ = (_e1830 + (_e1828 * area));
                let _e1832 = eff_01_;
                let _e1834 = diag_01_;
                diag_01_ = (_e1834 + (_e1832 * area));
                let _e1836 = eff_02_;
                let _e1838 = diag_02_;
                diag_02_ = (_e1838 + (_e1836 * area));
                let _e1840 = eff_03_;
                let _e1842 = diag_03_;
                diag_03_ = (_e1842 + (_e1840 * area));
                let _e1844 = eff_10_;
                let _e1846 = diag_10_;
                diag_10_ = (_e1846 + (_e1844 * area));
                let _e1848 = eff_11_;
                let _e1850 = diag_11_;
                diag_11_ = (_e1850 + (_e1848 * area));
                let _e1852 = eff_12_;
                let _e1854 = diag_12_;
                diag_12_ = (_e1854 + (_e1852 * area));
                let _e1856 = eff_13_;
                let _e1858 = diag_13_;
                diag_13_ = (_e1858 + (_e1856 * area));
                let _e1860 = eff_20_;
                let _e1862 = diag_20_;
                diag_20_ = (_e1862 + (_e1860 * area));
                let _e1864 = eff_21_;
                let _e1866 = diag_21_;
                diag_21_ = (_e1866 + (_e1864 * area));
                let _e1868 = eff_22_;
                let _e1870 = diag_22_;
                diag_22_ = (_e1870 + (_e1868 * area));
                let _e1872 = eff_23_;
                let _e1874 = diag_23_;
                diag_23_ = (_e1874 + (_e1872 * area));
                let _e1876 = eff_30_;
                let _e1878 = diag_30_;
                diag_30_ = (_e1878 + (_e1876 * area));
                let _e1880 = eff_31_;
                let _e1882 = diag_31_;
                diag_31_ = (_e1882 + (_e1880 * area));
                let _e1884 = eff_32_;
                let _e1886 = diag_32_;
                diag_32_ = (_e1886 + (_e1884 * area));
                let _e1888 = eff_33_;
                let _e1890 = diag_33_;
                diag_33_ = (_e1890 + (_e1888 * area));
            }
        }
        continuing {
            let _e1893 = face_offset;
            face_offset = (_e1893 + 1u);
        }
    }
    let _e1895 = rhs_time_rho;
    let _e1896 = coeff_time;
    let _e1899 = sum_rho;
    rhs_rho = ((_e1895 - (_e1896 * rho)) - _e1899);
    let _e1902 = rhs_time_rho_u_x;
    let _e1903 = coeff_time;
    let _e1907 = sum_rho_u_x;
    rhs_rho_u_x = ((_e1902 - (_e1903 * rho_u.x)) - _e1907);
    let _e1910 = rhs_time_rho_u_y;
    let _e1911 = coeff_time;
    let _e1915 = sum_rho_u_y;
    rhs_rho_u_y = ((_e1910 - (_e1911 * rho_u.y)) - _e1915);
    let _e1918 = rhs_time_rho_e;
    let _e1919 = coeff_time;
    let _e1922 = sum_rho_e;
    rhs_rho_e = ((_e1918 - (_e1919 * rho_e)) - _e1922);
    let _e1925 = coeff_time;
    let _e1926 = diag_00_;
    diag_00_ = (_e1926 + _e1925);
    let _e1928 = coeff_time;
    let _e1929 = diag_11_;
    diag_11_ = (_e1929 + _e1928);
    let _e1931 = coeff_time;
    let _e1932 = diag_22_;
    diag_22_ = (_e1932 + _e1931);
    let _e1934 = coeff_time;
    let _e1935 = diag_33_;
    diag_33_ = (_e1935 + _e1934);
    ...
    let _e1957 = diag_00_;
    matrix_values[(diag_base_0_ + 0u)] = _e1957;
    let _e1962 = diag_01_;
    matrix_values[(diag_base_0_ + 1u)] = _e1962;
    let _e1967 = diag_02_;
    matrix_values[(diag_base_0_ + 2u)] = _e1967;
    let _e1972 = diag_03_;
    matrix_values[(diag_base_0_ + 3u)] = _e1972;
    let _e1977 = diag_10_;
    matrix_values[(diag_base_1_ + 0u)] = _e1977;
    let _e1982 = diag_11_;
    matrix_values[(diag_base_1_ + 1u)] = _e1982;
    let _e1987 = diag_12_;
    matrix_values[(diag_base_1_ + 2u)] = _e1987;
    let _e1992 = diag_13_;
    matrix_values[(diag_base_1_ + 3u)] = _e1992;
    let _e1997 = diag_20_;
    matrix_values[(diag_base_2_ + 0u)] = _e1997;
    let _e2002 = diag_21_;
    matrix_values[(diag_base_2_ + 1u)] = _e2002;
    let _e2007 = diag_22_;
    matrix_values[(diag_base_2_ + 2u)] = _e2007;
    let _e2012 = diag_23_;
    matrix_values[(diag_base_2_ + 3u)] = _e2012;
    let _e2017 = diag_30_;
    matrix_values[(diag_base_3_ + 0u)] = _e2017;
    let _e2022 = diag_31_;
    matrix_values[(diag_base_3_ + 1u)] = _e2022;
    let _e2027 = diag_32_;
    matrix_values[(diag_base_3_ + 2u)] = _e2027;
    let _e2032 = diag_33_;
    matrix_values[(diag_base_3_ + 3u)] = _e2032;
    let _e2039 = rhs_rho;
    rhs[((4u * idx) + 0u)] = _e2039;
    let _e2046 = rhs_rho_u_x;
    rhs[((4u * idx) + 1u)] = _e2046;
    let _e2053 = rhs_rho_u_y;
    rhs[((4u * idx) + 2u)] = _e2053;
    let _e2060 = rhs_rho_e;
    rhs[((4u * idx) + 3u)] = _e2060;
    return;
}
"#;
    }
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    let f_rho_l = (rho_l * u_n_l);
    let _e244 = rho_r;
    let f_rho_r = (_e244 * u_n_r);
    let _e249 = rho_r;
    let flux_rho = ((((a_plus * f_rho_l) - (a_minus * f_rho_r)) + (a_prod * (_e249 - rho_l))) / denom);
    let _e257 = normal.x;
    let f_rho_u_l_x = ((rho_u_l.x * u_n_l) + (p_l * _e257));
    let _e263 = normal.y;
    let f_rho_u_l_y = ((rho_u_l.y * u_n_l) + (p_l * _e263));
    let _e267 = rho_u_r.x;
    let _e270 = normal.x;
    let f_rho_u_r_x = ((_e267 * u_n_r) + (p_r * _e270));
    let _e274 = rho_u_r.y;
    let _e277 = normal.y;
    let f_rho_u_r_y = ((_e274 * u_n_r) + (p_r * _e277));
    let _e284 = rho_u_r.x;
    flux_rho_u_x = ((((a_plus * f_rho_u_l_x) - (a_minus * f_rho_u_r_x)) + (a_prod * (_e284 - rho_u_l.x))) / denom);
    let _e295 = rho_u_r.y;
    flux_rho_u_y = ((((a_plus * f_rho_u_l_y) - (a_minus * f_rho_u_r_y)) + (a_prod * (_e295 - rho_u_l.y))) / denom);
    let diff_u_x = ((-(mu) * (u_r_x - u_l_x)) / dist);
    let diff_u_y = ((-(mu) * (u_r_y - u_l_y)) / dist);
    let _e310 = flux_rho_u_x;
    flux_rho_u_x = (_e310 + diff_u_x);
    let _e312 = flux_rho_u_y;
    flux_rho_u_y = (_e312 + diff_u_y);
    let f_rho_e_l = ((rho_e_l + p_l) * u_n_l);
    let _e316 = rho_e_r;
    let f_rho_e_r = ((_e316 + p_r) * u_n_r);
    let _e322 = rho_e_r;
    flux_rho_e = ((((a_plus * f_rho_e_l) - (a_minus * f_rho_e_r)) + (a_prod * (_e322 - rho_e_l))) / denom);
    let _e328 = flux_rho_e;
    flux_rho_e = ((_e328 + (diff_u_x * u_face_x)) + (diff_u_y * u_face_y));
    let base = (idx * 4u);
    fluxes[(base + 0u)] = (flux_rho * area);
    let _e344 = flux_rho_u_x;
    fluxes[(base + 1u)] = (_e344 * area);
    let _e350 = flux_rho_u_y;
    fluxes[(base + 2u)] = (_e350 * area);
    let _e356 = flux_rho_e;
    fluxes[(base + 3u)] = (_e356 * area);
    return;
}
"#;
    }
