...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>) {
    ...
    for (var k = 0u; k < 4u; k++) {
        ...
        let s_own_T = bc_neighbor_scalar(state[owner * 23u + 9u], state[owner * 23u + 9u], bc_kind[idx * 8u + 7u], bc_value[idx * 8u + 7u], d_own, is_boundary);
        ...
        let s_own_rho = bc_neighbor_scalar(state[owner * 23u + 0u], state[owner * 23u + 0u], bc_kind[idx * 8u + 0u], bc_value[idx * 8u + 0u], d_own, is_boundary);
        let s_own_rho_u_x = select(bc_neighbor_scalar(state[owner * 23u + 1u], state[owner * 23u + 1u], bc_kind[idx * 8u + 1u], bc_value[idx * 8u + 1u], d_own, is_boundary), state[owner * 23u + 1u] - (state[owner * 23u + 1u] * normal_vec.x + state[owner * 23u + 2u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
        let s_own_rho_u_y = select(bc_neighbor_scalar(state[owner * 23u + 2u], state[owner * 23u + 2u], bc_kind[idx * 8u + 2u], bc_value[idx * 8u + 2u], d_own, is_boundary), state[owner * 23u + 2u] - (state[owner * 23u + 1u] * normal_vec.x + state[owner * 23u + 2u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
        let s_own_u_x = select(bc_neighbor_scalar(state[owner * 23u + 10u], state[owner * 23u + 10u], bc_kind[idx * 8u + 4u], bc_value[idx * 8u + 4u], d_own, is_boundary), state[owner * 23u + 10u] - (state[owner * 23u + 10u] * normal_vec.x + state[owner * 23u + 11u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
        let s_own_u_y = select(bc_neighbor_scalar(state[owner * 23u + 11u], state[owner * 23u + 11u], bc_kind[idx * 8u + 5u], bc_value[idx * 8u + 5u], d_own, is_boundary), state[owner * 23u + 11u] - (state[owner * 23u + 10u] * normal_vec.x + state[owner * 23u + 11u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
        let s_neigh_T = bc_neighbor_scalar(state[neigh_idx * 23u + 9u], state[owner * 23u + 9u], bc_kind[idx * 8u + 7u], bc_value[idx * 8u + 7u], d_own, is_boundary);
        ...
        let s_neigh_rho = bc_neighbor_scalar(state[neigh_idx * 23u + 0u], state[owner * 23u + 0u], bc_kind[idx * 8u + 0u], bc_value[idx * 8u + 0u], d_own, is_boundary);
        let s_neigh_rho_u_x = select(bc_neighbor_scalar(state[neigh_idx * 23u + 1u], state[owner * 23u + 1u], bc_kind[idx * 8u + 1u], bc_value[idx * 8u + 1u], d_own, is_boundary), state[owner * 23u + 1u] - (state[owner * 23u + 1u] * normal_vec.x + state[owner * 23u + 2u] * normal_vec.y) * normal_vec.x, is_boundary && boundary_type == 4u);
        let s_neigh_rho_u_y = select(bc_neighbor_scalar(state[neigh_idx * 23u + 2u], state[owner * 23u + 2u], bc_kind[idx * 8u + 2u], bc_value[idx * 8u + 2u], d_own, is_boundary), state[owner * 23u + 2u] - (state[owner * 23u + 1u] * normal_vec.x + state[owner * 23u + 2u] * normal_vec.y) * normal_vec.y, is_boundary && boundary_type == 4u);
